	...
	public StatusEnum identifyStatus(Long testItemId) {
		return dsl.fetchExists(dsl.selectOne()
				...
				.where(TEST_ITEM_STRUCTURE.PARENT_ID.eq(testItemId)
						.and(TEST_ITEM_RESULTS.STATUS.eq(com.epam.ta.reportportal.jooq.enums.StatusEnum.FAILED)
								.or(TEST_ITEM_RESULTS.STATUS.eq(com.epam.ta.reportportal.jooq.enums.StatusEnum.SKIPPED))))) ?
				StatusEnum.FAILED :
				StatusEnum.PASSED;
	}
