...
public interface LaunchRepositoryCustom extends StatisticsUpdatePolicy<TestItem, Project.Configuration> {
	 ...
	 * @return
	 */
	Page<Launch> findModifiedInRange(String project, Date from, Date to, Pageable p);

	/**
	 * Get launch ids of launches that were last modified in range.
	 *
	 * @param project Project
	 * @param from    Before than date
	 * @return
	 */
	Page<Launch> findModifiedBefore(String project, Date from, Pageable p);
}