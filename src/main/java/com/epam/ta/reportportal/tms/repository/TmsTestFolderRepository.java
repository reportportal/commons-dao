...
import com.epam.ta.reportportal.tms.entity.TmsTestFolder;
import com.epam.ta.reportportal.tms.entity.TmsTestFolderIdWithCountOfTestCases;
import com.epam.ta.reportportal.tms.entity.TmsTestFolderWithCountOfTestCases;
...
public interface TmsTestFolderRepository extends ReportPortalRepository<TmsTestFolder, Long> {
   ...
   */
  @Query(
      "SELECT new com.epam.ta.reportportal.entity.tms."
   ...
   */
  @Query("SELECT new com.epam.ta.reportportal.entity.tms."
