...
public class Filter implements Serializable, Queryable {
  ...
  /**
   * Transforms {@link FilterCondition} into {@link org.jooq.Condition} and adds it to existed
   * {@link Condition} according the {@link ConditionType} with
   * {@link FilterCondition#getOperator()} {@link org.jooq.Operator}
   *
