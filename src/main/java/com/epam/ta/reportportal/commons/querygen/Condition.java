...
import static com.epam.ta.reportportal.commons.querygen.FilterRules.filterForDates;
import static com.epam.ta.reportportal.commons.querygen.FilterRules.filterForLogLevel;
import static com.epam.ta.reportportal.commons.querygen.FilterRules.filterForLtree;
import static com.epam.ta.reportportal.commons.querygen.FilterRules.filterForNumbers;
      ...
      if (String.class.equals(criteriaHolder.getDataType())) {
        return DSL.condition(Operator.AND,
            PostgresDSL.arrayOverlap(
                DSL.field(criteriaHolder.getAggregateCriteria(), String[][].class),
                DSL.array(DSL.val(
                        this.castValue(criteriaHolder, filter.getValue(), INCORRECT_FILTER_PARAMETERS))
                    .cast(String[].class))
            )
