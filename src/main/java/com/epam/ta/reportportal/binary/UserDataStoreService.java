...
public class UserDataStoreService {
	...
	@Autowired
	public UserDataStoreService(DataStoreService dataStoreService) {
	...
	public void saveUserPhoto(User user, InputStream inputStream, String contentType) {
		user.setAttachment(dataStoreService.save(Paths.get(ROOT_USER_PHOTO_DIR, user.getLogin()).toString(), inputStream));
