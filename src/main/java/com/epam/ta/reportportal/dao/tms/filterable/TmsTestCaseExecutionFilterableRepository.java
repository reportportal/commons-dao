...
import static com.epam.ta.reportportal.dao.util.ResultFetchers.TMS_TEST_CASE_EXECUTION_FETCHER;
...
import static com.epam.ta.reportportal.jooq.Tables.TMS_TEST_CASE_EXECUTION;
...
public class TmsTestCaseExecutionFilterableRepository implements FilterableRepository<TmsTestCaseExecution> {
