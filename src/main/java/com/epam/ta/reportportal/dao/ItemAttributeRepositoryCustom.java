...
public interface ItemAttributeRepositoryCustom {
  ...
  /**
   * Retrieves launch attribute keys by project and part of value. Used for autocompletion
   * functionality
   *
  ...
  /**
   * Retrieves launch attribute values by project, specified key and part of value. Used for
   ...
   * functionality
   *
   * @param projectId  Id of {@link com.epam.ta.reportportal.entity.project.Project} which items'
   *                   attribute keys should be found
   ...
   *
   * @param projectId  Id of {@link com.epam.ta.reportportal.entity.project.Project} which items'
   *                   attribute values should be found
   * @param launchName {@link Launch#getName()} which items' attributes should be found
   * @param key        Specified key
