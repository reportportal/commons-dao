...
public interface LogRepositoryCustom extends FilterableRepository<Log> {
   ...
   * 'launchId' has {@link Log}'s with {@link Log#lastModified} up to the current point of time
  ...
  /**
   * @param period      {@link Duration}
   * @param testItemIds Collection of the
   *                    {@link com.epam.ta.reportportal.entity.item.TestItem#itemId} referenced from
   *                    {@link Log#testItem}
  ...
  /**
   * @param period    {@link Duration}
   * @param launchIds Collection of the {@link Launch#getId()} referenced from
   *                  {@link Log#getLaunch()}
   * @return Count of removed logs
   */
   ...
   * <p>
   * {@link Log} and {@link com.epam.ta.reportportal.entity.item.TestItem} entities filtered and
   * sorted on the DB level and returned as UNION parsed into the {@link NestedItem} entity
   *
   ...
   * <p>
   * {@link Log} and {@link com.epam.ta.reportportal.entity.item.TestItem} entities filtered and
   * sorted on the DB level and returned as UNION parsed into the {@link NestedItemPage} entity with
