...
/**
 * A service for resolving log levels and log names based on predefined enums or custom
 * repository-backed mappings.
 *
 */
@Component
...
public class LogTypeResolver {
  ...
  /**
   * Resolves log level (integer) from level name (string). Searches first in the predefined enum
   * and falls back to the repository for custom log levels.
   *
  ...
  /**
   * Resolves level name (string) from log level (integer). Searches first in the predefined enum
   * and falls back to the repository for custom log levels.
   *
   * @param projectId the project ID used for repository lookup
