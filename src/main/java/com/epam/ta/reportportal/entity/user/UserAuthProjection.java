...
/**
 * Projection for User entity containing only authentication-related fields.
 * This reduces query size and improves performance for authentication operations.
 *
 * @param id         User ID
