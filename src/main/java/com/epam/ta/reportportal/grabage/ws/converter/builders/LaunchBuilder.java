...
package com.epam.ta.reportportal.grabage.ws.converter.builders;
...
public class LaunchBuilder implements Supplier<Launch> {
	...
	public LaunchBuilder addStartRQ(StartLaunchRQ request) {
		if (request != null) {
			...
			addTags(newHashSet(trimStrings(com.epam.ta.reportportal.commons.EntityUtils.update(request.getTags()))));
