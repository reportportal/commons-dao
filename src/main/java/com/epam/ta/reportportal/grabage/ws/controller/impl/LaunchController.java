...
import com.epam.ta.reportportal.grabage.launch.*;
import com.epam.ta.reportportal.grabage.ws.controller.ILaunchController;
...
//	private IMergeLaunchHandler mergeLaunchesHandler;
	...
	@Override
	@RequestMapping(value = "/{launchId}/report", method = GET)
	@ResponseBody
	@ResponseStatus(OK)
