...
public class IssueRecord extends UpdatableRecordImpl<IssueRecord> implements Record5<Long, Integer, String, Boolean, Boolean> {

    private static final long serialVersionUID = 557192992;
     ...
     */
    @Override
    public IssueRecord values(Long value1, Integer value2, String value3, Boolean value4, Boolean value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public IssueRecord(Long issueId, Integer issueType, String issueDescription, Boolean autoAnalyzed, Boolean ignoreAnalyzer) {
        super(Issue.ISSUE);
