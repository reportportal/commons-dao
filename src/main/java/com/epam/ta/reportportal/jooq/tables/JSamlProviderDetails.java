...
public class JSamlProviderDetails extends TableImpl<JSamlProviderDetailsRecord> {
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('saml_provider_details_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> IDP_NAME = createField("idp_name",
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> IDP_METADATA_URL = createField("idp_metadata_url",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> IDP_NAME_ID = createField("idp_name_id",
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> IDP_ALIAS = createField("idp_alias",
			org.jooq.impl.SQLDataType.VARCHAR,
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> IDP_URL = createField("idp_url",
			org.jooq.impl.SQLDataType.VARCHAR,
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> FULL_NAME_ATTRIBUTE_ID = createField("full_name_attribute_id",
			org.jooq.impl.SQLDataType.VARCHAR,
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> FIRST_NAME_ATTRIBUTE_ID = createField("first_name_attribute_id",
			org.jooq.impl.SQLDataType.VARCHAR,
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> LAST_NAME_ATTRIBUTE_ID = createField("last_name_attribute_id",
			org.jooq.impl.SQLDataType.VARCHAR,
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, String> EMAIL_ATTRIBUTE_ID = createField("email_attribute_id",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JSamlProviderDetailsRecord, Boolean> ENABLED = createField("enabled",
