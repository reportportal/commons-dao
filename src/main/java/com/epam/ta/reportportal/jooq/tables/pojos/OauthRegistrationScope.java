...
public class OauthRegistrationScope implements Serializable {
    ...
    private static final long serialVersionUID = -967360851;
    ...
    public OauthRegistrationScope(OauthRegistrationScope value) {
        this.id = value.id;
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder("OauthRegistrationScope (");
