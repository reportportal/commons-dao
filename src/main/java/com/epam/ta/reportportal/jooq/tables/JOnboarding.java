...
public class JOnboarding extends TableImpl<JOnboardingRecord> {
   ...
   */
  public final TableField<JOnboardingRecord, Short> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('onboarding_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.SMALLINT)), this, "");
  /**
   * The column <code>public.onboarding.data</code>.
   */
  public final TableField<JOnboardingRecord, String> DATA = createField(DSL.name("data"),
      org.jooq.impl.SQLDataType.CLOB, this, "");
  /**
   * The column <code>public.onboarding.page</code>.
   */
  public final TableField<JOnboardingRecord, String> PAGE = createField(DSL.name("page"),
      org.jooq.impl.SQLDataType.VARCHAR(50).nullable(false), this, "");
  /**
   * The column <code>public.onboarding.available_from</code>.
   */
  public final TableField<JOnboardingRecord, Timestamp> AVAILABLE_FROM = createField(
      DSL.name("available_from"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
  /**
   * The column <code>public.onboarding.available_to</code>.
   */
  public final TableField<JOnboardingRecord, Timestamp> AVAILABLE_TO = createField(
      DSL.name("available_to"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
