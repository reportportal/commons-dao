...
public class JClusters extends TableImpl<JClustersRecord> {
  ...
  public final TableField<JClustersRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('clusters_id_seq'::regclass)",
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.CLUSTER_INDEX_ID_IDX, Indexes.CLUSTER_LAUNCH_IDX,
        Indexes.CLUSTER_PROJECT_IDX, Indexes.CLUSTERS_PK, Indexes.INDEX_ID_LAUNCH_ID_UNQ);
  }
