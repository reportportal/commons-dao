...
public class JAclEntryRecord extends UpdatableRecordImpl<JAclEntryRecord> implements
    Record8<Long, Long, Integer, Long, Integer, Boolean, Boolean, Boolean> {
   ...
   */
  public JAclEntryRecord(Long id, Long aclObjectIdentity, Integer aceOrder, Long sid, Integer mask,
  ...
  @Override
  public JAclEntryRecord values(Long value1, Long value2, Integer value3, Long value4,
      Integer value5, Boolean value6, Boolean value7, Boolean value8) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
