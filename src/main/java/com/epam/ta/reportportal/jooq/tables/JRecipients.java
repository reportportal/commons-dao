...
public class JRecipients extends TableImpl<JRecipientsRecord> {
    ...
    private static final long serialVersionUID = 127308796;
    ...
    /**
     * The column <code>public.recipients.email_sender_case_id</code>.
     */
    public final TableField<JRecipientsRecord, Long> EMAIL_SENDER_CASE_ID = createField("email_sender_case_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<JRecipientsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<JRecipientsRecord, ?>>asList(Keys.RECIPIENTS__RECIPIENTS_EMAIL_SENDER_CASE_ID_FKEY);
    }

    public JEmailSenderCase emailSenderCase() {
        return new JEmailSenderCase(this, Keys.RECIPIENTS__RECIPIENTS_EMAIL_SENDER_CASE_ID_FKEY);
    }
