...
public class JAttachmentDeletion extends TableImpl<JAttachmentDeletionRecord> {
     ...
     */
    public final TableField<JAttachmentDeletionRecord, LocalDateTime> CREATION_ATTACHMENT_DATE = createField(DSL.name("creation_attachment_date"), SQLDataType.LOCALDATETIME(6), this, "");

    /**
     * The column <code>public.attachment_deletion.deletion_date</code>.
     */
    public final TableField<JAttachmentDeletionRecord, LocalDateTime> DELETION_DATE = createField(DSL.name("deletion_date"), SQLDataType.LOCALDATETIME(6), this, "");
