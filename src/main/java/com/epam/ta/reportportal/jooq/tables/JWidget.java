...
public class JWidget extends TableImpl<JWidgetRecord> {
   ...
   */
  public final TableField<JWidgetRecord, Long> ID = createField(DSL.name("id"),
   ...
   */
  public final TableField<JWidgetRecord, String> DESCRIPTION = createField(DSL.name("description"),
   ...
   */
  public final TableField<JWidgetRecord, Short> ITEMS_COUNT = createField(DSL.name("items_count"),
      org.jooq.impl.SQLDataType.SMALLINT, this, "");
  /**
   * The column <code>public.widget.widget_options</code>.
   */
  public final TableField<JWidgetRecord, JSONB> WIDGET_OPTIONS = createField(
      DSL.name("widget_options"), org.jooq.impl.SQLDataType.JSONB, this, "");
