...
public class JAttachmentDeletionRecord extends
    UpdatableRecordImpl<JAttachmentDeletionRecord> implements
    Record5<Long, String, String, Timestamp, Timestamp> {
   ...
   */
  public JAttachmentDeletionRecord(Long id, String fileId, String thumbnailId,
      Timestamp creationAttachmentDate, Timestamp deletionDate) {
    super(JAttachmentDeletion.ATTACHMENT_DELETION);
  ...
  @Override
  public JAttachmentDeletionRecord values(Long value1, String value2, String value3,
      Timestamp value4, Timestamp value5) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
