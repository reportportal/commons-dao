...
public class JServerEmailDetails extends TableImpl<JServerEmailDetailsRecord> {
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('server_email_details_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, Boolean> ENABLED = createField("enabled",
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, String> HOST = createField("host",
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, Integer> PORT = createField("port",
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, String> PROTOCOL = createField("protocol",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, Boolean> AUTH_ENABLED = createField("auth_enabled",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, Boolean> STAR_TLS_ENABLED = createField("star_tls_enabled",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, Boolean> SSL_ENABLED = createField("ssl_enabled",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, String> USERNAME = createField("username",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, String> PASSWORD = createField("password",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JServerEmailDetailsRecord, String> RECIEVED_FROM = createField("recieved_from",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
