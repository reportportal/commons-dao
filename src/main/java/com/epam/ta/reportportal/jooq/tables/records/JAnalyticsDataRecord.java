...
public class JAnalyticsDataRecord extends UpdatableRecordImpl<JAnalyticsDataRecord> implements Record4<Long, String, Timestamp, JSONB> {

    private static final long serialVersionUID = 962206372;
    ...
    @Override
    public Row4<Long, String, Timestamp, JSONB> valuesRow() {
    ...
    @Override
    public JAnalyticsDataRecord value3(Timestamp value) {
        setCreatedAt(value);
        return this;
    }
    ...
    @Override
    public JAnalyticsDataRecord values(Long value1, String value2, Timestamp value3, JSONB value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JAnalyticsDataRecord(Long id, String type, Timestamp createdAt, JSONB metadata) {
        super(JAnalyticsData.ANALYTICS_DATA);
