...
public class JRestorePasswordBidRecord extends UpdatableRecordImpl<JRestorePasswordBidRecord> implements Record3<String, LocalDateTime, String> {
    ...
    @Override
    public JRestorePasswordBidRecord value2(LocalDateTime value) {
    ...
    @Override
    public JRestorePasswordBidRecord values(String value1, LocalDateTime value2, String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public JRestorePasswordBidRecord(String uuid, LocalDateTime lastModified, String email) {
        super(JRestorePasswordBid.RESTORE_PASSWORD_BID);
