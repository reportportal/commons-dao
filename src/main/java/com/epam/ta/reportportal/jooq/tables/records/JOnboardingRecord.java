...
public class JOnboardingRecord extends UpdatableRecordImpl<JOnboardingRecord> implements
    Record5<Short, String, String, Timestamp, Timestamp> {
   ...
   */
  public JOnboardingRecord(Short id, String data, String page, Timestamp availableFrom,
  ...
  @Override
  public JOnboardingRecord values(Short value1, String value2, String value3, Timestamp value4,
      Timestamp value5) {
    value1(value1);
    value2(value2);
    value3(value3);
