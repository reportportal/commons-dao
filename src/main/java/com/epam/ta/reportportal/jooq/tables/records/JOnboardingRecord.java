...
public class JOnboardingRecord extends UpdatableRecordImpl<JOnboardingRecord> implements Record5<Short, String, String, LocalDateTime, LocalDateTime> {
    ...
    @Override
    public Row5<Short, String, String, LocalDateTime, LocalDateTime> valuesRow() {
    ...
    @Override
    public JOnboardingRecord value4(LocalDateTime value) {
        setAvailableFrom(value);
        return this;
    }

    @Override
    public JOnboardingRecord value5(LocalDateTime value) {
        setAvailableTo(value);
        return this;
    }

    @Override
    public JOnboardingRecord values(Short value1, String value2, String value3, LocalDateTime value4, LocalDateTime value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JOnboardingRecord(Short id, String data, String page, LocalDateTime availableFrom, LocalDateTime availableTo) {
        super(JOnboarding.ONBOARDING);
