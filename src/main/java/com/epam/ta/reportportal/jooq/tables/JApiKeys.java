...
public class JApiKeys extends TableImpl<JApiKeysRecord> {
  ...
  public final TableField<JApiKeysRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('api_keys_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");

  /**
   * The column <code>public.api_keys.name</code>.
   */
  public final TableField<JApiKeysRecord, String> NAME = createField(DSL.name("name"),
      org.jooq.impl.SQLDataType.VARCHAR(255), this, "");

  /**
   * The column <code>public.api_keys.hash</code>.
   */
  public final TableField<JApiKeysRecord, String> HASH = createField(DSL.name("hash"),
      org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.API_KEYS_PKEY, Indexes.HASH_API_KEYS_IDX,
        Indexes.USERS_API_KEYS_UNIQUE);
  }
