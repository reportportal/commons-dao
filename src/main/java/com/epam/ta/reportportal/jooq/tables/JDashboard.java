...
public class JDashboard extends TableImpl<JDashboardRecord> {
   ...
   */
  public final TableField<JDashboardRecord, Long> ID = createField(DSL.name("id"),
   ...
   */
  public final TableField<JDashboardRecord, String> DESCRIPTION = createField(
      DSL.name("description"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
  /**
