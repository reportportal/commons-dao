...
public class JDashboard extends TableImpl<JDashboardRecord> {
	 ...
	 */
	public final TableField<JDashboardRecord, String> NAME = createField("name",
	 ...
	 */
	public final TableField<JDashboardRecord, Timestamp> CREATION_DATE = createField("creation_date",
