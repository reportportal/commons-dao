...
public class JClustersTestItem extends TableImpl<JClustersTestItemRecord> {
   ...
   */
  public final TableField<JClustersTestItemRecord, Long> CLUSTER_ID = createField(
      DSL.name("cluster_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
  ...
  public <O extends Record> JClustersTestItem(Table<O> child,
      ForeignKey<O, JClustersTestItemRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.CLUSTER_ITEM_CLUSTER_IDX, Indexes.CLUSTER_ITEM_ITEM_IDX,
        Indexes.CLUSTER_ITEM_UNQ);
  }
