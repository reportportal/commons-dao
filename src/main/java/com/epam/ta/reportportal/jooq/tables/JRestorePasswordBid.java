...
public class JRestorePasswordBid extends TableImpl<JRestorePasswordBidRecord> {
   ...
   */
  public final TableField<JRestorePasswordBidRecord, Timestamp> LAST_MODIFIED = createField(
      DSL.name("last_modified"), org.jooq.impl.SQLDataType.TIMESTAMP.defaultValue(
          org.jooq.impl.DSL.field("now()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "");
  /**
  ...
  public <O extends Record> JRestorePasswordBid(Table<O> child,
      ForeignKey<O, JRestorePasswordBidRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.RESTORE_PASSWORD_BID_EMAIL_KEY,
        Indexes.RESTORE_PASSWORD_BID_PK);
  }
  ...
  public List<UniqueKey<JRestorePasswordBidRecord>> getKeys() {
    return Arrays.<UniqueKey<JRestorePasswordBidRecord>>asList(Keys.RESTORE_PASSWORD_BID_PK,
        Keys.RESTORE_PASSWORD_BID_EMAIL_KEY);
  }
