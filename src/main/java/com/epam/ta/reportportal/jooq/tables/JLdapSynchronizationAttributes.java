...
public class JLdapSynchronizationAttributes extends TableImpl<JLdapSynchronizationAttributesRecord> {
	 ...
	 */
	public final TableField<JLdapSynchronizationAttributesRecord, Long> ID = createField(
			"id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field(
							"nextval('ldap_synchronization_attributes_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JLdapSynchronizationAttributesRecord, String> EMAIL = createField(
			"email",
	 ...
	 */
	public final TableField<JLdapSynchronizationAttributesRecord, String> FULL_NAME = createField(
			"full_name",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	 ...
	 */
	public final TableField<JLdapSynchronizationAttributesRecord, String> PHOTO = createField(
			"photo",
