...
public class JUserCreationBid extends TableImpl<JUserCreationBidRecord> {
  ...
  public final TableField<JUserCreationBidRecord, Long> DEFAULT_PROJECT_ID = createField(
      DSL.name("default_project_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.user_creation_bid.role</code>.
   */
  public final TableField<JUserCreationBidRecord, String> ROLE = createField(DSL.name("role"),
      org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
  ...
  public <O extends Record> JUserCreationBid(Table<O> child,
      ForeignKey<O, JUserCreationBidRecord> key) {
