...
public class JTestItemResultsRecord extends UpdatableRecordImpl<JTestItemResultsRecord> implements Record4<Long, JStatusEnum, Instant, Double> {

    private static final long serialVersionUID = 1623310881;
    ...
    @Override
    public Row4<Long, JStatusEnum, Instant, Double> valuesRow() {
    ...
    @Override
    public JTestItemResultsRecord value3(Instant value) {
        setEndTime(value);
        return this;
    }
    ...
    @Override
    public JTestItemResultsRecord values(Long value1, JStatusEnum value2, Instant value3, Double value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
