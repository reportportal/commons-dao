...
public class JTestItemResultsRecord extends UpdatableRecordImpl<JTestItemResultsRecord> implements
    Record4<Long, JStatusEnum, Timestamp, Double> {
   ...
   */
  public JTestItemResultsRecord(Long resultId, JStatusEnum status, Timestamp endTime,
      Double duration) {
    super(JTestItemResults.TEST_ITEM_RESULTS);
  ...
  @Override
  public JTestItemResultsRecord values(Long value1, JStatusEnum value2, Timestamp value3,
      Double value4) {
    value1(value1);
    value2(value2);
    value3(value3);
