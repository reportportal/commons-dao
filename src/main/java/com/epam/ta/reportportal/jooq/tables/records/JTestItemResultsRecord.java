...
public class JTestItemResultsRecord extends UpdatableRecordImpl<JTestItemResultsRecord> implements Record4<Long, JStatusEnum, LocalDateTime, Double> {
    ...
    @Override
    public Row4<Long, JStatusEnum, LocalDateTime, Double> valuesRow() {
    ...
    @Override
    public JTestItemResultsRecord value3(LocalDateTime value) {
        setEndTime(value);
        return this;
    }
    ...
    @Override
    public JTestItemResultsRecord values(Long value1, JStatusEnum value2, LocalDateTime value3, Double value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JTestItemResultsRecord(Long resultId, JStatusEnum status, LocalDateTime endTime, Double duration) {
        super(JTestItemResults.TEST_ITEM_RESULTS);
