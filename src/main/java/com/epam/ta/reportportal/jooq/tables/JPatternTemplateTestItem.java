...
public class JPatternTemplateTestItem extends TableImpl<JPatternTemplateTestItemRecord> {
   ...
   */
  public final TableField<JPatternTemplateTestItemRecord, Long> PATTERN_ID = createField(
      DSL.name("pattern_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
   * The column <code>public.pattern_template_test_item.item_id</code>.
   */
  public final TableField<JPatternTemplateTestItemRecord, Long> ITEM_ID = createField(
      DSL.name("item_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  ...
  public <O extends Record> JPatternTemplateTestItem(Table<O> child,
      ForeignKey<O, JPatternTemplateTestItemRecord> key) {
  ...
  public List<ForeignKey<JPatternTemplateTestItemRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JPatternTemplateTestItemRecord, ?>>asList(
  ...
  public JPatternTemplate patternTemplate() {
    return new JPatternTemplate(this,
        Keys.PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_PATTERN_ID_FKEY);
  }

  public JTestItem testItem() {
    return new JTestItem(this,
        Keys.PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_ITEM_ID_FKEY);
  }
