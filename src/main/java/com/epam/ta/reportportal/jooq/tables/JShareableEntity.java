...
public class JShareableEntity extends TableImpl<JShareableEntityRecord> {
   ...
   */
  public final TableField<JShareableEntityRecord, Long> ID = createField(DSL.name("id"),
   ...
   */
  public final TableField<JShareableEntityRecord, Boolean> SHARED = createField(DSL.name("shared"),
   ...
   */
  public final TableField<JShareableEntityRecord, String> OWNER = createField(DSL.name("owner"),
  ...
  public final TableField<JShareableEntityRecord, Long> PROJECT_ID = createField(
      DSL.name("project_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  ...
  public <O extends Record> JShareableEntity(Table<O> child,
      ForeignKey<O, JShareableEntityRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.SHAREABLE_PK, Indexes.SHARED_ENTITY_OWNERX,
        Indexes.SHARED_ENTITY_PROJECT_IDX);
  }
