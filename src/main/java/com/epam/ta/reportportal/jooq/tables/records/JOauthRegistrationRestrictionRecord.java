...
public class JOauthRegistrationRestrictionRecord extends
    UpdatableRecordImpl<JOauthRegistrationRestrictionRecord> implements
   ...
   */
  public JOauthRegistrationRestrictionRecord(Integer id, String oauthRegistrationFk, String type,
      String value) {
    super(JOauthRegistrationRestriction.OAUTH_REGISTRATION_RESTRICTION);
  ...
  @Override
  public JOauthRegistrationRestrictionRecord values(Integer value1, String value2, String value3,
      String value4) {
    value1(value1);
    value2(value2);
    value3(value3);
