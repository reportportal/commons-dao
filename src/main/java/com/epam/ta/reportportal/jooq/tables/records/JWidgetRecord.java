...
public class JWidgetRecord extends UpdatableRecordImpl<JWidgetRecord> implements
    Record6<Long, String, String, String, Short, JSONB> {
   ...
   */
  public JWidgetRecord(Long id, String name, String description, String widgetType,
      Short itemsCount, JSONB widgetOptions) {
    super(JWidget.WIDGET);
  ...
  @Override
  public JWidgetRecord values(Long value1, String value2, String value3, String value4,
      Short value5, JSONB value6) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
