...
public class JItemAttributeRecord extends UpdatableRecordImpl<JItemAttributeRecord> implements
    Record6<Long, String, String, Long, Long, Boolean> {
   ...
   */
  public JItemAttributeRecord(Long id, String key, String value, Long itemId, Long launchId,
      Boolean system) {
    super(JItemAttribute.ITEM_ATTRIBUTE);
  ...
  @Override
  public JItemAttributeRecord values(Long value1, String value2, String value3, Long value4,
      Long value5, Boolean value6) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
