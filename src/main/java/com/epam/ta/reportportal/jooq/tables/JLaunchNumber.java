...
public class JLaunchNumber extends TableImpl<JLaunchNumberRecord> {
  ...
  public final TableField<JLaunchNumberRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('launch_number_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.launch_number.project_id</code>.
   */
  public final TableField<JLaunchNumberRecord, Long> PROJECT_ID = createField(
   ...
   */
  public final TableField<JLaunchNumberRecord, String> LAUNCH_NAME = createField(
      DSL.name("launch_name"), org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");
  /**
  ...
  public List<UniqueKey<JLaunchNumberRecord>> getKeys() {
    return Arrays.<UniqueKey<JLaunchNumberRecord>>asList(Keys.LAUNCH_NUMBER_PK,
        Keys.UNQ_PROJECT_NAME);
  }

  @Override
  public List<ForeignKey<JLaunchNumberRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JLaunchNumberRecord, ?>>asList(
