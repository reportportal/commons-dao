...
public class JProjectUserRecord extends UpdatableRecordImpl<JProjectUserRecord> implements
    Record3<Long, Long, JProjectRoleEnum> {

  private static final long serialVersionUID = -388211168;
