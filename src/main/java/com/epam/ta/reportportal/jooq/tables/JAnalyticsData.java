...
public class JAnalyticsData extends TableImpl<JAnalyticsDataRecord> {
     ...
     */
    public final TableField<JAnalyticsDataRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.LOCALDATETIME)), this, "");
