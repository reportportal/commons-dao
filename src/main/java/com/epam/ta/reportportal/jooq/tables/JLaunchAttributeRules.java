...
public class JLaunchAttributeRules extends TableImpl<JLaunchAttributeRulesRecord> {
	 ...
	 */
	public final TableField<JLaunchAttributeRulesRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('launch_attribute_rules_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JLaunchAttributeRulesRecord, Long> SENDER_CASE_ID = createField("sender_case_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLaunchAttributeRulesRecord, String> VALUE = createField("value",
