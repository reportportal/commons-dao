...
public class JTestItemResults extends TableImpl<JTestItemResultsRecord> {
  ...
  public final TableField<JTestItemResultsRecord, Long> RESULT_ID = createField(
      DSL.name("result_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
  ...
  public final TableField<JTestItemResultsRecord, JStatusEnum> STATUS = createField(
      DSL.name("status"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false)
   ...
   */
  public final TableField<JTestItemResultsRecord, Timestamp> END_TIME = createField(
      DSL.name("end_time"), org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
  /**
   * The column <code>public.test_item_results.duration</code>.
   */
  public final TableField<JTestItemResultsRecord, Double> DURATION = createField(
      DSL.name("duration"), org.jooq.impl.SQLDataType.DOUBLE, this, "");
  ...
  public <O extends Record> JTestItemResults(Table<O> child,
      ForeignKey<O, JTestItemResultsRecord> key) {
