...
public class JTestItemResults extends TableImpl<JTestItemResultsRecord> {
	...
	private static final long serialVersionUID = -1343011361;
     ...
     */
    public final TableField<JTestItemResultsRecord, JStatusEnum> STATUS = createField("status", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JStatusEnum.class), this, "");
