...
public class JProjectUser extends TableImpl<JProjectUserRecord> {
    ...
    private static final long serialVersionUID = 1781908458;
     ...
     */
    public final TableField<JProjectUserRecord, JProjectRoleEnum> PROJECT_ROLE = createField("project_role", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.epam.ta.reportportal.jooq.enums.JProjectRoleEnum.class), this, "");
