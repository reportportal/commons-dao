...
public class JProjectUser extends TableImpl<JProjectUserRecord> {
	...
	private static final long serialVersionUID = 36248552;
	 ...
	 */
	public final TableField<JProjectUserRecord, Long> USER_ID = createField("user_id",
	 ...
	 */
	public final TableField<JProjectUserRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JProjectUserRecord, JProjectRoleEnum> PROJECT_ROLE = createField("project_role",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.epam.ta.reportportal.jooq.enums.JProjectRoleEnum.class),
			this,
			""
	);
	...
	public List<ForeignKey<JProjectUserRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JProjectUserRecord, ?>>asList(Keys.PROJECT_USER__PROJECT_USER_USER_ID_FKEY,
