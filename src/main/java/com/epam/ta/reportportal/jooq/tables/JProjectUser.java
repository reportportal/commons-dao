...
public class JProjectUser extends TableImpl<JProjectUserRecord> {
     ...
     */
    public final TableField<JProjectUserRecord, JProjectRoleEnum> PROJECT_ROLE = createField(DSL.name("project_role"), SQLDataType.VARCHAR.nullable(false).asEnumDataType(
        JProjectRoleEnum.class), this, "");
    ...
    public JUsers users() {
        if (_users == null)
            _users = new JUsers(this, Keys.PROJECT_USER__PROJECT_USER_USER_ID_FKEY);
    ...
    public JProject project() {
        if (_project == null)
            _project = new JProject(this, Keys.PROJECT_USER__PROJECT_USER_PROJECT_ID_FKEY);
