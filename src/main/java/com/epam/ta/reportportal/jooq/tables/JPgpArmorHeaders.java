...
public class JPgpArmorHeaders extends TableImpl<JPgpArmorHeadersRecord> {
   ...
   */
  public final TableField<JPgpArmorHeadersRecord, String> KEY = createField(DSL.name("key"),
      org.jooq.impl.SQLDataType.CLOB, this, "");
  /**
   * The column <code>public.pgp_armor_headers.value</code>.
   */
  public final TableField<JPgpArmorHeadersRecord, String> VALUE = createField(DSL.name("value"),
      org.jooq.impl.SQLDataType.CLOB, this, "");
  ...
  public <O extends Record> JPgpArmorHeaders(Table<O> child,
      ForeignKey<O, JPgpArmorHeadersRecord> key) {
