...
public class JStatistics extends TableImpl<JStatisticsRecord> {
  ...
  public final TableField<JStatisticsRecord, Long> S_ID = createField(DSL.name("s_id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('statistics_s_id_seq'::regclass)",
  ...
  public final TableField<JStatisticsRecord, Integer> S_COUNTER = createField(DSL.name("s_counter"),
      org.jooq.impl.SQLDataType.INTEGER.defaultValue(
          org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
  /**
   * The column <code>public.statistics.launch_id</code>.
   */
  public final TableField<JStatisticsRecord, Long> LAUNCH_ID = createField(DSL.name("launch_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   ...
   */
  public final TableField<JStatisticsRecord, Long> STATISTICS_FIELD_ID = createField(
      DSL.name("statistics_field_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.STATISTICS_LAUNCH_IDX, Indexes.STATISTICS_PK,
        Indexes.STATISTICS_TI_IDX, Indexes.UNIQUE_STATS_ITEM, Indexes.UNIQUE_STATS_LAUNCH);
  }
  ...
  public List<UniqueKey<JStatisticsRecord>> getKeys() {
    return Arrays.<UniqueKey<JStatisticsRecord>>asList(Keys.STATISTICS_PK, Keys.UNIQUE_STATS_LAUNCH,
        Keys.UNIQUE_STATS_ITEM);
  }

  @Override
  public List<ForeignKey<JStatisticsRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JStatisticsRecord, ?>>asList(
        Keys.STATISTICS__STATISTICS_LAUNCH_ID_FKEY, Keys.STATISTICS__STATISTICS_ITEM_ID_FKEY,
