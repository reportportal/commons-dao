...
public class JStatistics extends TableImpl<JStatisticsRecord> {
	...
	private static final long serialVersionUID = -293628349;
	 ...
	 */
	public final TableField<JStatisticsRecord, Long> S_ID = createField("s_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('statistics_s_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)),
			this,
			""
	);
	 ...
	 */
	public final TableField<JStatisticsRecord, Integer> S_COUNTER = createField("s_counter",
	 ...
	 */
	public final TableField<JStatisticsRecord, Long> STATISTICS_FIELD_ID = createField("statistics_field_id",
	...
	public List<Index> getIndexes() {
		return Arrays.<Index>asList(Indexes.STATISTICS_LAUNCH_IDX,
				Indexes.STATISTICS_PK,
				Indexes.STATISTICS_TI_IDX,
				Indexes.UNIQUE_STATS_ITEM,
				Indexes.UNIQUE_STATS_LAUNCH
		);
	}
	...
	public List<ForeignKey<JStatisticsRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JStatisticsRecord, ?>>asList(Keys.STATISTICS__STATISTICS_LAUNCH_ID_FKEY,
				Keys.STATISTICS__STATISTICS_ITEM_ID_FKEY,
