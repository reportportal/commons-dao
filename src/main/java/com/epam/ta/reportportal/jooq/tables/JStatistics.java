...
public class JStatistics extends TableImpl<JStatisticsRecord> {
	 ...
	 */
	public final TableField<JStatisticsRecord, Long> S_ID = createField(
			"s_id",
	 ...
	 */
	public final TableField<JStatisticsRecord, Integer> S_COUNTER = createField(
			"s_counter",
	...
	public List<ForeignKey<JStatisticsRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JStatisticsRecord, ?>>asList(
				Keys.STATISTICS__STATISTICS_LAUNCH_ID_FKEY,
