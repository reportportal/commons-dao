...
public class JOauthAccessToken extends TableImpl<JOauthAccessTokenRecord> {
   ...
   */
  public final TableField<JOauthAccessTokenRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('oauth_access_token_id_seq'::regclass)",
  ...
  public final TableField<JOauthAccessTokenRecord, String> TOKEN_ID = createField(
      DSL.name("token_id"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>public.oauth_access_token.token</code>.
   */
  public final TableField<JOauthAccessTokenRecord, byte[]> TOKEN = createField(DSL.name("token"),
  ...
  public final TableField<JOauthAccessTokenRecord, String> AUTHENTICATION_ID = createField(
      DSL.name("authentication_id"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
  /**
  ...
  public final TableField<JOauthAccessTokenRecord, String> USERNAME = createField(
      DSL.name("username"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
  /**
   * The column <code>public.oauth_access_token.user_id</code>.
   */
  public final TableField<JOauthAccessTokenRecord, Long> USER_ID = createField(DSL.name("user_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
  ...
  public final TableField<JOauthAccessTokenRecord, String> CLIENT_ID = createField(
      DSL.name("client_id"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
  /**
  ...
  public final TableField<JOauthAccessTokenRecord, byte[]> AUTHENTICATION = createField(
      DSL.name("authentication"), org.jooq.impl.SQLDataType.BLOB, this, "");
  /**
  ...
  public final TableField<JOauthAccessTokenRecord, String> REFRESH_TOKEN = createField(
      DSL.name("refresh_token"), org.jooq.impl.SQLDataType.VARCHAR(255), this, "");
  ...
  public <O extends Record> JOauthAccessToken(Table<O> child,
      ForeignKey<O, JOauthAccessTokenRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.OAUTH_ACCESS_TOKEN_PKEY, Indexes.OAUTH_AT_USER_IDX,
        Indexes.USERS_ACCESS_TOKEN_UNIQUE);
  }
  ...
  public List<UniqueKey<JOauthAccessTokenRecord>> getKeys() {
    return Arrays.<UniqueKey<JOauthAccessTokenRecord>>asList(Keys.OAUTH_ACCESS_TOKEN_PKEY,
        Keys.USERS_ACCESS_TOKEN_UNIQUE);
  }

  @Override
  public List<ForeignKey<JOauthAccessTokenRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JOauthAccessTokenRecord, ?>>asList(
        Keys.OAUTH_ACCESS_TOKEN__OAUTH_ACCESS_TOKEN_USER_ID_FKEY);
  }
