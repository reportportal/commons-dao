...
public class JOauthAccessToken extends TableImpl<JOauthAccessTokenRecord> {
    ...
    private static final long serialVersionUID = 1230415543;
     ...
     */
    public final TableField<JOauthAccessTokenRecord, JAccessTokenTypeEnum> TOKEN_TYPE = createField("token_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JAccessTokenTypeEnum.class), this, "");
