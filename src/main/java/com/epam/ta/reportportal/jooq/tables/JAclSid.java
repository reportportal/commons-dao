...
public class JAclSid extends TableImpl<JAclSidRecord> {
   ...
   */
  public final TableField<JAclSidRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('acl_sid_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.acl_sid.principal</code>.
   */
  public final TableField<JAclSidRecord, Boolean> PRINCIPAL = createField(DSL.name("principal"),
      org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
  /**
   * The column <code>public.acl_sid.sid</code>.
   */
  public final TableField<JAclSidRecord, String> SID = createField(DSL.name("sid"),
