...
public class JAclSid extends TableImpl<JAclSidRecord> {
	...
	private static final long serialVersionUID = -1795817868;
	 ...
	 */
	public final TableField<JAclSidRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JAclSidRecord, Boolean> PRINCIPAL = createField("principal",
	 ...
	 */
	public final TableField<JAclSidRecord, String> SID = createField("sid",
