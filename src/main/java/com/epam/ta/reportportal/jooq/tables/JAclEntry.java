...
public class JAclEntry extends TableImpl<JAclEntryRecord> {
	 ...
	 */
	public final TableField<JAclEntryRecord, Long> ID = createField(
			"id",
	 ...
	 */
	public final TableField<JAclEntryRecord, Integer> ACE_ORDER = createField(
			"ace_order",
	 ...
	 */
	public final TableField<JAclEntryRecord, Integer> MASK = createField(
			"mask",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false),
			this,
			""
	 ...
	 */
	public final TableField<JAclEntryRecord, Boolean> GRANTING = createField(
			"granting",
