...
public class JAclEntry extends TableImpl<JAclEntryRecord> {
	 ...
	 */
	public final TableField<JAclEntryRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('acl_entry_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)),
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclEntryRecord, Long> ACL_OBJECT_IDENTITY = createField("acl_object_identity",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclEntryRecord, Integer> ACE_ORDER = createField("ace_order",
	 ...
	 */
	public final TableField<JAclEntryRecord, Integer> MASK = createField("mask",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclEntryRecord, Boolean> GRANTING = createField("granting",
	 ...
	 */
	public final TableField<JAclEntryRecord, Boolean> AUDIT_SUCCESS = createField("audit_success",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclEntryRecord, Boolean> AUDIT_FAILURE = createField("audit_failure",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false),
			this,
			""
	);
