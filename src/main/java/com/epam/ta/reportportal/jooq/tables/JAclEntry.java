...
public class JAclEntry extends TableImpl<JAclEntryRecord> {
   ...
   */
  public final TableField<JAclEntryRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('acl_entry_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.acl_entry.acl_object_identity</code>.
   */
  public final TableField<JAclEntryRecord, Long> ACL_OBJECT_IDENTITY = createField(
      DSL.name("acl_object_identity"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
   * The column <code>public.acl_entry.ace_order</code>.
   */
  public final TableField<JAclEntryRecord, Integer> ACE_ORDER = createField(DSL.name("ace_order"),
      org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.acl_entry.sid</code>.
   */
  public final TableField<JAclEntryRecord, Long> SID = createField(DSL.name("sid"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
   * The column <code>public.acl_entry.mask</code>.
   */
  public final TableField<JAclEntryRecord, Integer> MASK = createField(DSL.name("mask"),
      org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  /**
   * The column <code>public.acl_entry.granting</code>.
   */
  public final TableField<JAclEntryRecord, Boolean> GRANTING = createField(DSL.name("granting"),
      org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
  /**
   * The column <code>public.acl_entry.audit_success</code>.
   */
  public final TableField<JAclEntryRecord, Boolean> AUDIT_SUCCESS = createField(
      DSL.name("audit_success"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
  /**
   * The column <code>public.acl_entry.audit_failure</code>.
   */
  public final TableField<JAclEntryRecord, Boolean> AUDIT_FAILURE = createField(
      DSL.name("audit_failure"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
  ...
  public List<ForeignKey<JAclEntryRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JAclEntryRecord, ?>>asList(Keys.ACL_ENTRY__FOREIGN_FK_4,
        Keys.ACL_ENTRY__FOREIGN_FK_5);
  }
