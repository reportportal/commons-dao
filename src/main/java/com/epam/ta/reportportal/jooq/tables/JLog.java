...
public class JLog extends TableImpl<JLogRecord> {
  ...
  public final TableField<JLogRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('log_id_seq'::regclass)",
   ...
   */
  public final TableField<JLogRecord, Timestamp> LOG_TIME = createField(DSL.name("log_time"),
   ...
   */
  public final TableField<JLogRecord, Long> ITEM_ID = createField(DSL.name("item_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.log.launch_id</code>.
   */
  public final TableField<JLogRecord, Long> LAUNCH_ID = createField(DSL.name("launch_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   ...
   */
  public final TableField<JLogRecord, Long> ATTACHMENT_ID = createField(DSL.name("attachment_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   ...
   */
  public final TableField<JLogRecord, Long> CLUSTER_ID = createField(DSL.name("cluster_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.LOG_ATTACH_ID_IDX, Indexes.LOG_CLUSTER_IDX,
        Indexes.LOG_LAUNCH_ID_IDX, Indexes.LOG_MESSAGE_TRGM_IDX, Indexes.LOG_PK,
        Indexes.LOG_PROJECT_ID_LOG_TIME_IDX, Indexes.LOG_PROJECT_IDX, Indexes.LOG_TI_IDX);
  }
  ...
  public List<ForeignKey<JLogRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JLogRecord, ?>>asList(Keys.LOG__LOG_ITEM_ID_FKEY,
        Keys.LOG__LOG_LAUNCH_ID_FKEY, Keys.LOG__LOG_ATTACHMENT_ID_FKEY);
  }
