...
public class JFilterSort extends TableImpl<JFilterSortRecord> {
	...
	private static final long serialVersionUID = 1754375867;
	 ...
	 */
	public final TableField<JFilterSortRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JFilterSortRecord, String> FIELD = createField("field",
	 ...
	 */
	public final TableField<JFilterSortRecord, JSortDirectionEnum> DIRECTION = createField("direction",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("'ASC'::sort_direction_enum", org.jooq.impl.SQLDataType.VARCHAR))
					.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JSortDirectionEnum.class),
			this,
			""
	);
