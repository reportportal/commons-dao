...
public class JFilterSort extends TableImpl<JFilterSortRecord> {
  ...
  public final TableField<JFilterSortRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('filter_sort_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.filter_sort.filter_id</code>.
   */
  public final TableField<JFilterSortRecord, Long> FILTER_ID = createField(DSL.name("filter_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   ...
   */
  public final TableField<JFilterSortRecord, JSortDirectionEnum> DIRECTION = createField(
      DSL.name("direction"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false).defaultValue(
              org.jooq.impl.DSL.field("'ASC'::sort_direction_enum", org.jooq.impl.SQLDataType.VARCHAR))
          .asEnumDataType(com.epam.ta.reportportal.jooq.enums.JSortDirectionEnum.class), this, "");
  ...
  public List<ForeignKey<JFilterSortRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JFilterSortRecord, ?>>asList(
        Keys.FILTER_SORT__FILTER_SORT_FILTER_ID_FKEY);
  }
