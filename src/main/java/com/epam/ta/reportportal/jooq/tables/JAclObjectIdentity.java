...
public class JAclObjectIdentity extends TableImpl<JAclObjectIdentityRecord> {
	...
	private static final long serialVersionUID = -1191178658;
	 ...
	 */
	public final TableField<JAclObjectIdentityRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('acl_object_identity_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JAclObjectIdentityRecord, Long> OBJECT_ID_CLASS = createField("object_id_class",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclObjectIdentityRecord, String> OBJECT_ID_IDENTITY = createField("object_id_identity",
	 ...
	 */
	public final TableField<JAclObjectIdentityRecord, Long> PARENT_OBJECT = createField("parent_object",
			org.jooq.impl.SQLDataType.BIGINT,
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclObjectIdentityRecord, Long> OWNER_SID = createField("owner_sid",
			org.jooq.impl.SQLDataType.BIGINT,
			this,
			""
	);
	 ...
	 */
	public final TableField<JAclObjectIdentityRecord, Boolean> ENTRIES_INHERITING = createField("entries_inheriting",
	...
	public List<ForeignKey<JAclObjectIdentityRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JAclObjectIdentityRecord, ?>>asList(Keys.ACL_OBJECT_IDENTITY__FOREIGN_FK_2,
