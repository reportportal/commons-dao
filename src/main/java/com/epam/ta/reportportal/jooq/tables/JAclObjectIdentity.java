...
public class JAclObjectIdentity extends TableImpl<JAclObjectIdentityRecord> {
   ...
   */
  public final TableField<JAclObjectIdentityRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('acl_object_identity_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.acl_object_identity.object_id_class</code>.
   */
  public final TableField<JAclObjectIdentityRecord, Long> OBJECT_ID_CLASS = createField(
      DSL.name("object_id_class"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
   * The column <code>public.acl_object_identity.object_id_identity</code>.
   */
  public final TableField<JAclObjectIdentityRecord, String> OBJECT_ID_IDENTITY = createField(
      DSL.name("object_id_identity"), org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this,
      "");
  /**
   * The column <code>public.acl_object_identity.parent_object</code>.
   */
  public final TableField<JAclObjectIdentityRecord, Long> PARENT_OBJECT = createField(
      DSL.name("parent_object"), org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.acl_object_identity.owner_sid</code>.
   */
  public final TableField<JAclObjectIdentityRecord, Long> OWNER_SID = createField(
      DSL.name("owner_sid"), org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.acl_object_identity.entries_inheriting</code>.
   */
  public final TableField<JAclObjectIdentityRecord, Boolean> ENTRIES_INHERITING = createField(
      DSL.name("entries_inheriting"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
  ...
  public <O extends Record> JAclObjectIdentity(Table<O> child,
      ForeignKey<O, JAclObjectIdentityRecord> key) {
  ...
  public List<UniqueKey<JAclObjectIdentityRecord>> getKeys() {
    return Arrays.<UniqueKey<JAclObjectIdentityRecord>>asList(Keys.ACL_OBJECT_IDENTITY_PKEY,
        Keys.UNIQUE_UK_3);
  }

  @Override
  public List<ForeignKey<JAclObjectIdentityRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JAclObjectIdentityRecord, ?>>asList(
        Keys.ACL_OBJECT_IDENTITY__FOREIGN_FK_2, Keys.ACL_OBJECT_IDENTITY__FOREIGN_FK_1,
        Keys.ACL_OBJECT_IDENTITY__FOREIGN_FK_3);
  }
  ...
  public com.epam.ta.reportportal.jooq.tables.JAclObjectIdentity aclObjectIdentity() {
    return new com.epam.ta.reportportal.jooq.tables.JAclObjectIdentity(this,
        Keys.ACL_OBJECT_IDENTITY__FOREIGN_FK_1);
  }
