...
public class JSenderCase extends TableImpl<JSenderCaseRecord> {
	 ...
	 */
	public final TableField<JSenderCaseRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JSenderCaseRecord, String> SEND_CASE = createField("send_case",
	 ...
	 */
	public final TableField<JSenderCaseRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('sender_case_project_id_seq'::regclass)",
