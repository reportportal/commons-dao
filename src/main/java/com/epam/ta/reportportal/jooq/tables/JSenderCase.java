...
public class JSenderCase extends TableImpl<JSenderCaseRecord> {
     ...
     */
    public final TableField<JSenderCaseRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('sender_case_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.sender_case.send_case</code>.
     */
    public final TableField<JSenderCaseRecord, String> SEND_CASE = createField("send_case", org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");

    /**
     * The column <code>public.sender_case.project_id</code>.
     */
    public final TableField<JSenderCaseRecord, Long> PROJECT_ID = createField("project_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('sender_case_project_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
