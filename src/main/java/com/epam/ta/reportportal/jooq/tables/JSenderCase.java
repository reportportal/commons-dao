...
public class JSenderCase extends TableImpl<JSenderCaseRecord> {
  ...
  public final TableField<JSenderCaseRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('sender_case_id_seq'::regclass)",
  ...
  public final TableField<JSenderCaseRecord, Long> PROJECT_ID = createField(DSL.name("project_id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('sender_case_project_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
  ...
  public List<ForeignKey<JSenderCaseRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JSenderCaseRecord, ?>>asList(
        Keys.SENDER_CASE__SENDER_CASE_PROJECT_ID_FKEY);
  }
