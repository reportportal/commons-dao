...
public class JSenderCase extends TableImpl<JSenderCaseRecord> {
     ...
     */
    public final TableField<JSenderCaseRecord, Boolean> ENABLED = createField(DSL.name("enabled"), SQLDataType.BOOLEAN.nullable(false).defaultValue(DSL.field("true", SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>public.sender_case.attributes_operator</code>.
     */
    public final TableField<JSenderCaseRecord, JLogicalOperatorEnum> ATTRIBUTES_OPERATOR = createField(DSL.name("attributes_operator"), SQLDataType.VARCHAR.nullable(false).defaultValue(DSL.field("'AND'::logical_operator_enum", SQLDataType.VARCHAR)).asEnumDataType(
        JLogicalOperatorEnum.class), this, "");
     ...
     */
    public final TableField<JSenderCaseRecord, String> RULE_TYPE = createField(DSL.name("rule_type"), SQLDataType.VARCHAR(55).nullable(false).defaultValue(DSL.field("'email'::character varying", SQLDataType.VARCHAR)), this, "");
    ...
    public JProject project() {
        if (_project == null)
            _project = new JProject(this, Keys.SENDER_CASE__SENDER_CASE_PROJECT_ID_FKEY);
