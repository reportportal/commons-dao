...
public class JContentFieldRecord extends UpdatableRecordImpl<JContentFieldRecord> implements Record2<Long, String> {

    private static final long serialVersionUID = -643899123;
