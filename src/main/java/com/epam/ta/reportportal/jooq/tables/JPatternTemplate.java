...
public class JPatternTemplate extends TableImpl<JPatternTemplateRecord> {
  ...
  public final TableField<JPatternTemplateRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('pattern_template_id_seq'::regclass)",
  ...
  public <O extends Record> JPatternTemplate(Table<O> child,
      ForeignKey<O, JPatternTemplateRecord> key) {
  ...
  public List<UniqueKey<JPatternTemplateRecord>> getKeys() {
    return Arrays.<UniqueKey<JPatternTemplateRecord>>asList(Keys.PATTERN_TEMPLATE_PK,
        Keys.UNQ_NAME_PROJECTID);
  }

  @Override
  public List<ForeignKey<JPatternTemplateRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JPatternTemplateRecord, ?>>asList(
