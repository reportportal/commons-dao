...
public class JPatternTemplate extends TableImpl<JPatternTemplateRecord> {
	 ...
	 */
	public final TableField<JPatternTemplateRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('pattern_template_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JPatternTemplateRecord, String> NAME = createField("name",
	 ...
	 */
	public final TableField<JPatternTemplateRecord, String> VALUE = createField("value",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JPatternTemplateRecord, String> TYPE = createField("type",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JPatternTemplateRecord, Boolean> ENABLED = createField("enabled",
	 ...
	 */
	public final TableField<JPatternTemplateRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
