...
public class JUsers extends TableImpl<JUsersRecord> {
	...
	private static final long serialVersionUID = 1795714410;
	 ...
	 */
	public final TableField<JUsersRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('users_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)),
			this,
			""
	);
	 ...
	 */
	public final TableField<JUsersRecord, String> ATTACHMENT_THUMBNAIL = createField("attachment_thumbnail",
	 ...
	 */
	public final TableField<JUsersRecord, Boolean> EXPIRED = createField("expired",
	 ...
	 */
	public final TableField<JUsersRecord, String> FULL_NAME = createField("full_name",
