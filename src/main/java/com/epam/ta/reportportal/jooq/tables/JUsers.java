...
public class JUsers extends TableImpl<JUsersRecord> {
  ...
  public final TableField<JUsersRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('users_id_seq'::regclass)",
   ...
   */
  public final TableField<JUsersRecord, String> PASSWORD = createField(DSL.name("password"),
   ...
   */
  public final TableField<JUsersRecord, String> ATTACHMENT = createField(DSL.name("attachment"),
      org.jooq.impl.SQLDataType.VARCHAR, this, "");
  /**
   * The column <code>public.users.attachment_thumbnail</code>.
   */
  public final TableField<JUsersRecord, String> ATTACHMENT_THUMBNAIL = createField(
      DSL.name("attachment_thumbnail"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
  /**
   ...
   */
  public final TableField<JUsersRecord, String> FULL_NAME = createField(DSL.name("full_name"),
      org.jooq.impl.SQLDataType.VARCHAR, this, "");
  /**
   * The column <code>public.users.metadata</code>.
   */
  public final TableField<JUsersRecord, JSONB> METADATA = createField(DSL.name("metadata"),
