...
public class JFilterCondition extends TableImpl<JFilterConditionRecord> {
	...
	private static final long serialVersionUID = -613939586;
	...
	public final TableField<JFilterConditionRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('filter_condition_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JFilterConditionRecord, JFilterConditionEnum> CONDITION = createField("condition",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false)
					.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JFilterConditionEnum.class),
			this,
			""
	);
	 ...
	 */
	public final TableField<JFilterConditionRecord, String> VALUE = createField("value",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JFilterConditionRecord, String> SEARCH_CRITERIA = createField("search_criteria",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JFilterConditionRecord, Boolean> NEGATIVE = createField("negative",
