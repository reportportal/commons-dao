...
public class JFilterCondition extends TableImpl<JFilterConditionRecord> {
    ...
    private static final long serialVersionUID = 1672230037;
     ...
     */
    public final TableField<JFilterConditionRecord, JFilterConditionEnum> CONDITION = createField("condition", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JFilterConditionEnum.class), this, "");
