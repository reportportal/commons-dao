...
public class JFilterCondition extends TableImpl<JFilterConditionRecord> {
  ...
  public final TableField<JFilterConditionRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('filter_condition_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.filter_condition.filter_id</code>.
   */
  public final TableField<JFilterConditionRecord, Long> FILTER_ID = createField(
      DSL.name("filter_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
  ...
  public final TableField<JFilterConditionRecord, JFilterConditionEnum> CONDITION = createField(
      DSL.name("condition"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false)
          .asEnumDataType(com.epam.ta.reportportal.jooq.enums.JFilterConditionEnum.class), this,
      "");
  /**
  ...
  public final TableField<JFilterConditionRecord, String> SEARCH_CRITERIA = createField(
      DSL.name("search_criteria"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
  /**
  ...
  public final TableField<JFilterConditionRecord, Boolean> NEGATIVE = createField(
      DSL.name("negative"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
  ...
  public <O extends Record> JFilterCondition(Table<O> child,
      ForeignKey<O, JFilterConditionRecord> key) {
  ...
  public List<ForeignKey<JFilterConditionRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JFilterConditionRecord, ?>>asList(
