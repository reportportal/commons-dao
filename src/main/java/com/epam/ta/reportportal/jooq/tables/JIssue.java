...
public class JIssue extends TableImpl<JIssueRecord> {
	...
	private static final long serialVersionUID = -1360275183;
	 ...
	 */
	public final TableField<JIssueRecord, Long> ISSUE_ID = createField("issue_id",
	 ...
	 */
	public final TableField<JIssueRecord, String> ISSUE_DESCRIPTION = createField("issue_description",
	 ...
	 */
	public final TableField<JIssueRecord, Boolean> AUTO_ANALYZED = createField("auto_analyzed",
	 ...
	 */
	public final TableField<JIssueRecord, Boolean> IGNORE_ANALYZER = createField("ignore_analyzer",
			org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)),
			this,
			""
	);
