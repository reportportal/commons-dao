...
public class JIssue extends TableImpl<JIssueRecord> {
   ...
   */
  public final TableField<JIssueRecord, Long> ISSUE_TYPE = createField(DSL.name("issue_type"),
  ...
  public final TableField<JIssueRecord, String> ISSUE_DESCRIPTION = createField(
      DSL.name("issue_description"), org.jooq.impl.SQLDataType.CLOB, this, "");
  /**
   * The column <code>public.issue.auto_analyzed</code>.
   */
  public final TableField<JIssueRecord, Boolean> AUTO_ANALYZED = createField(
      DSL.name("auto_analyzed"), org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(
  ...
  public final TableField<JIssueRecord, Boolean> IGNORE_ANALYZER = createField(
      DSL.name("ignore_analyzer"), org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(
          org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
  ...
  public List<ForeignKey<JIssueRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JIssueRecord, ?>>asList(Keys.ISSUE__ISSUE_ISSUE_ID_FKEY,
