...
public class JWidgetFilter extends TableImpl<JWidgetFilterRecord> {
	 ...
	 */
	public final TableField<JWidgetFilterRecord, Long> WIDGET_ID = createField("widget_id",
	 ...
	 */
	public final TableField<JWidgetFilterRecord, Long> FILTER_ID = createField("filter_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	...
	public List<ForeignKey<JWidgetFilterRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JWidgetFilterRecord, ?>>asList(Keys.WIDGET_FILTER__WIDGET_FILTER_WIDGET_ID_FKEY,
				Keys.WIDGET_FILTER__WIDGET_FILTER_FILTER_ID_FKEY
		);
	}
