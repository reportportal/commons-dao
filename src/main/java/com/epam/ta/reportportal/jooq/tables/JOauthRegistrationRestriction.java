...
public class JOauthRegistrationRestriction extends TableImpl<JOauthRegistrationRestrictionRecord> {
   ...
   */
  public final TableField<JOauthRegistrationRestrictionRecord, Integer> ID = createField(
      DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('oauth_registration_restriction_id_seq'::regclass)",
  ...
  public final TableField<JOauthRegistrationRestrictionRecord, String> OAUTH_REGISTRATION_FK = createField(
      DSL.name("oauth_registration_fk"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
  /**
   * The column <code>public.oauth_registration_restriction.type</code>.
   */
  public final TableField<JOauthRegistrationRestrictionRecord, String> TYPE = createField(
      DSL.name("type"), org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false), this, "");
  /**
   * The column <code>public.oauth_registration_restriction.value</code>.
   */
  public final TableField<JOauthRegistrationRestrictionRecord, String> VALUE = createField(
  ...
  private JOauthRegistrationRestriction(Name alias,
      Table<JOauthRegistrationRestrictionRecord> aliased) {
    this(alias, aliased, null);
  }

  private JOauthRegistrationRestriction(Name alias,
      Table<JOauthRegistrationRestrictionRecord> aliased, Field<?>[] parameters) {
    super(alias, null, aliased, parameters, DSL.comment(""));
  }

  public <O extends Record> JOauthRegistrationRestriction(Table<O> child,
      ForeignKey<O, JOauthRegistrationRestrictionRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.OAUTH_REGISTRATION_RESTRICTION_PK,
        Indexes.OAUTH_REGISTRATION_RESTRICTION_UNIQUE);
  }
  ...
  public List<UniqueKey<JOauthRegistrationRestrictionRecord>> getKeys() {
    return Arrays.<UniqueKey<JOauthRegistrationRestrictionRecord>>asList(
        Keys.OAUTH_REGISTRATION_RESTRICTION_PK, Keys.OAUTH_REGISTRATION_RESTRICTION_UNIQUE);
  }

  @Override
  public List<ForeignKey<JOauthRegistrationRestrictionRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JOauthRegistrationRestrictionRecord, ?>>asList(
  ...
  public JOauthRegistration oauthRegistration() {
    return new JOauthRegistration(this,
        Keys.OAUTH_REGISTRATION_RESTRICTION__OAUTH_REGISTRATION_RESTRICTION_OAUTH_REGISTRATION_FK_FKEY);
  }
