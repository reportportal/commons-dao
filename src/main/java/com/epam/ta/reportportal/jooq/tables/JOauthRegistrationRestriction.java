...
public class JOauthRegistrationRestriction extends TableImpl<JOauthRegistrationRestrictionRecord> {
	...
	private static final long serialVersionUID = -1039274397;
	 ...
	 */
	public final TableField<JOauthRegistrationRestrictionRecord, Integer> ID = createField("id",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('oauth_registration_restriction_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JOauthRegistrationRestrictionRecord, String> OAUTH_REGISTRATION_FK = createField("oauth_registration_fk",
	 ...
	 */
	public final TableField<JOauthRegistrationRestrictionRecord, String> TYPE = createField("type",
	 ...
	 */
	public final TableField<JOauthRegistrationRestrictionRecord, String> VALUE = createField("value",
			org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false),
			this,
			""
	);
	...
	public List<UniqueKey<JOauthRegistrationRestrictionRecord>> getKeys() {
		return Arrays.<UniqueKey<JOauthRegistrationRestrictionRecord>>asList(Keys.OAUTH_REGISTRATION_RESTRICTION_PK,
				Keys.OAUTH_REGISTRATION_RESTRICTION_UNIQUE
		);
	}
