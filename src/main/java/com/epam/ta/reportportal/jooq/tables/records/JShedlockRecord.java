...
public class JShedlockRecord extends UpdatableRecordImpl<JShedlockRecord> implements Record4<String, LocalDateTime, LocalDateTime, String> {
    ...
    @Override
    public JShedlockRecord value2(LocalDateTime value) {
        setLockUntil(value);
        return this;
    }

    @Override
    public JShedlockRecord value3(LocalDateTime value) {
        setLockedAt(value);
        return this;
    }
    ...
    @Override
    public JShedlockRecord values(String value1, LocalDateTime value2, LocalDateTime value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JShedlockRecord(String name, LocalDateTime lockUntil, LocalDateTime lockedAt, String lockedBy) {
        super(JShedlock.SHEDLOCK);
