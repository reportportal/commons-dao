...
public class JProject extends TableImpl<JProjectRecord> {
  ...
  public final TableField<JProjectRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('project_id_seq'::regclass)",
  ...
  public final TableField<JProjectRecord, String> PROJECT_TYPE = createField(
      DSL.name("project_type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
  /**
   * The column <code>public.project.organization</code>.
   */
  public final TableField<JProjectRecord, String> ORGANIZATION = createField(
      DSL.name("organization"), org.jooq.impl.SQLDataType.VARCHAR, this, "");
  /**
   ...
   */
  public final TableField<JProjectRecord, JSONB> METADATA = createField(DSL.name("metadata"),
      org.jooq.impl.SQLDataType.JSONB, this, "");
  /**
   * The column <code>public.project.allocated_storage</code>.
   */
  public final TableField<JProjectRecord, Long> ALLOCATED_STORAGE = createField(
      DSL.name("allocated_storage"), org.jooq.impl.SQLDataType.BIGINT.nullable(false)
