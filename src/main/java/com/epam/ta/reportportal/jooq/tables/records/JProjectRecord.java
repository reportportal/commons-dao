...
public class JProjectRecord extends UpdatableRecordImpl<JProjectRecord> implements Record6<Long, String, String, String, Timestamp, Object> {

    private static final long serialVersionUID = 1232530861;
     ...
     */
    public JProjectRecord(Long id, String name, String additionalInfo, String projectType, Timestamp creationDate, Object metadata) {
        super(JProject.PROJECT);
