...
public class JProjectRecord extends UpdatableRecordImpl<JProjectRecord> implements Record6<Long, String, String, String, Timestamp, JSONB> {
    ...
    @Override
    public Row6<Long, String, String, String, Timestamp, JSONB> fieldsRow() {
        return (Row6) super.fieldsRow();
    }

    @Override
    public Row6<Long, String, String, String, Timestamp, JSONB> valuesRow() {
    ...
    @Override
    public JProjectRecord values(Long value1, String value2, String value3, String value4, Timestamp value5, JSONB value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JProjectRecord(Long id, String name, String projectType, String organization, Timestamp creationDate, JSONB metadata) {
        super(JProject.PROJECT);
