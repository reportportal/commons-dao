...
public class JProjectRecord extends UpdatableRecordImpl<JProjectRecord> implements Record7<Long, String, String, String, Instant, JSONB, Long> {

    private static final long serialVersionUID = -29128502;
    ...
    @Override
    public Row7<Long, String, String, String, Instant, JSONB, Long> valuesRow() {
    ...
    @Override
    public JProjectRecord value5(Instant value) {
    ...
    @Override
    public JProjectRecord values(Long value1, String value2, String value3, String value4, Instant value5, JSONB value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
