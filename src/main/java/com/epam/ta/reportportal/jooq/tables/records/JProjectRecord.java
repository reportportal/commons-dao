...
public class JProjectRecord extends UpdatableRecordImpl<JProjectRecord> implements Record11<Long, String, String, String, Timestamp, JSONB, Long, Long, String, String, Timestamp> {

    private static final long serialVersionUID = 327627751;
    ...
    @Override
    public Row11<Long, String, String, String, Timestamp, JSONB, Long, Long, String, String, Timestamp> valuesRow() {
    ...
    @Override
    public JProjectRecord value11(Timestamp value) {
        setUpdatedAt(value);
        return this;
    }

    @Override
    public JProjectRecord values(Long value1, String value2, String value3, String value4, Timestamp value5, JSONB value6, Long value7, Long value8, String value9, String value10, Timestamp value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JProjectRecord(Long id, String name, String projectType, String organization, Timestamp creationDate, JSONB metadata, Long allocatedStorage, Long organizationId, String slug, String key, Timestamp updatedAt) {
        super(JProject.PROJECT);
