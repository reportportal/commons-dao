...
public class LaunchTagRecord extends UpdatableRecordImpl<LaunchTagRecord> implements Record3<Integer, String, Long> {

    private static final long serialVersionUID = -1608837030;
     ...
     */
    @Override
    public LaunchTagRecord value1(Integer value) {
        setId(value);
        return this;
    }
     ...
     */
    @Override
    public LaunchTagRecord values(Integer value1, String value2, Long value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
     ...
     */
    public LaunchTagRecord(Integer id, String value, Long launchId) {
        super(LaunchTag.LAUNCH_TAG);
