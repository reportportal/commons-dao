...
public class JActivity extends TableImpl<JActivityRecord> {
   ...
   */
  public final TableField<JActivityRecord, Long> USER_ID = createField(DSL.name("user_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.activity.username</code>.
   */
  public final TableField<JActivityRecord, String> USERNAME = createField(DSL.name("username"),
   ...
   */
  public final TableField<JActivityRecord, String> ENTITY = createField(DSL.name("entity"),
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.ACTIVITY_CREATION_DATE_IDX, Indexes.ACTIVITY_OBJECT_IDX,
