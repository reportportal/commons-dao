...
public class JActivity extends TableImpl<JActivityRecord> {
	...
	private static final long serialVersionUID = -1444907194;
	 ...
	 */
	public final TableField<JActivityRecord, Long> ID = createField("id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('activity_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)),
			this,
			""
	);
	 ...
	 */
	public final TableField<JActivityRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JActivityRecord, String> ENTITY = createField("entity",
	 ...
	 */
	public final TableField<JActivityRecord, String> ACTION = createField("action",
			org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JActivityRecord, Object> DETAILS = createField("details",
	 ...
	 */
	public final TableField<JActivityRecord, Timestamp> CREATION_DATE = createField("creation_date",
