...
public class JActivity extends TableImpl<JActivityRecord> {
    ...
    private static final long serialVersionUID = -1199900862;
     ...
     */
    public final TableField<JActivityRecord, JActivityEntityEnum> ENTITY = createField("entity", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JActivityEntityEnum.class), this, "");
