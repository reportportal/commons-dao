...
public class JSenderCaseRecord extends UpdatableRecordImpl<JSenderCaseRecord> implements Record5<Long, String, Long, Boolean, String> {

    private static final long serialVersionUID = -941748892;
    ...
    @Override
    public Row5<Long, String, Long, Boolean, String> valuesRow() {
    ...
    @Override
    public JSenderCaseRecord value5(String value) {
        setRuleName(value);
        return this;
    }

    @Override
    public JSenderCaseRecord values(Long value1, String value2, Long value3, Boolean value4, String value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JSenderCaseRecord(Long id, String sendCase, Long projectId, Boolean enabled, String ruleName) {
        super(JSenderCase.SENDER_CASE);
