...
public class JSenderCaseRecord extends UpdatableRecordImpl<JSenderCaseRecord> implements Record5<Long, String, Long, Boolean, JLogicalOperatorEnum> {
    ...
    @Override
    public Row5<Long, String, Long, Boolean, JLogicalOperatorEnum> valuesRow() {
    ...
    @Override
    public JSenderCaseRecord values(Long value1, String value2, Long value3, Boolean value4, JLogicalOperatorEnum value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JSenderCaseRecord(Long id, String sendCase, Long projectId, Boolean enabled, JLogicalOperatorEnum attributesOperator) {
        super(JSenderCase.SENDER_CASE);
