...
public class JIssueType extends TableImpl<JIssueTypeRecord> {
  ...
  public final TableField<JIssueTypeRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('issue_type_id_seq'::regclass)",
  ...
  public final TableField<JIssueTypeRecord, Short> ISSUE_GROUP_ID = createField(
      DSL.name("issue_group_id"), org.jooq.impl.SQLDataType.SMALLINT, this, "");
  /**
  ...
  public final TableField<JIssueTypeRecord, String> ABBREVIATION = createField(
      DSL.name("abbreviation"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
  /**
  ...
  public final TableField<JIssueTypeRecord, String> HEX_COLOR = createField(DSL.name("hex_color"),
      org.jooq.impl.SQLDataType.VARCHAR(7).nullable(false), this, "");
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.ISSUE_TYPE_GROUP_IDX, Indexes.ISSUE_TYPE_LOCATOR_KEY,
        Indexes.ISSUE_TYPE_PK);
  }
  ...
  public List<UniqueKey<JIssueTypeRecord>> getKeys() {
    return Arrays.<UniqueKey<JIssueTypeRecord>>asList(Keys.ISSUE_TYPE_PK,
        Keys.ISSUE_TYPE_LOCATOR_KEY);
  }

  @Override
  public List<ForeignKey<JIssueTypeRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JIssueTypeRecord, ?>>asList(
