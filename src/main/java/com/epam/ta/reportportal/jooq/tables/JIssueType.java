...
public class JIssueType extends TableImpl<JIssueTypeRecord> {
	 ...
	 */
	public final TableField<JIssueTypeRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JIssueTypeRecord, Short> ISSUE_GROUP_ID = createField("issue_group_id",
	 ...
	 */
	public final TableField<JIssueTypeRecord, String> LOCATOR = createField("locator",
	 ...
	 */
	public final TableField<JIssueTypeRecord, String> ISSUE_NAME = createField("issue_name",
	 ...
	 */
	public final TableField<JIssueTypeRecord, String> ABBREVIATION = createField("abbreviation",
			org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JIssueTypeRecord, String> HEX_COLOR = createField("hex_color",
