...
public class JUserPreference extends TableImpl<JUserPreferenceRecord> {
  ...
  public final TableField<JUserPreferenceRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('user_preference_id_seq'::regclass)",
  ...
  public final TableField<JUserPreferenceRecord, Long> FILTER_ID = createField(
      DSL.name("filter_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  ...
  public <O extends Record> JUserPreference(Table<O> child,
      ForeignKey<O, JUserPreferenceRecord> key) {
  ...
  public List<UniqueKey<JUserPreferenceRecord>> getKeys() {
    return Arrays.<UniqueKey<JUserPreferenceRecord>>asList(Keys.USER_PREFERENCE_PK,
        Keys.USER_PREFERENCE_UQ);
  }
