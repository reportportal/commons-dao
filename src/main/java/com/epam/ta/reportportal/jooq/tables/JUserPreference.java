...
public class JUserPreference extends TableImpl<JUserPreferenceRecord> {
	 ...
	 */
	public final TableField<JUserPreferenceRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JUserPreferenceRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JUserPreferenceRecord, Long> USER_ID = createField("user_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JUserPreferenceRecord, Long> FILTER_ID = createField("filter_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	...
	public List<ForeignKey<JUserPreferenceRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JUserPreferenceRecord, ?>>asList(Keys.USER_PREFERENCE__USER_PREFERENCE_PROJECT_ID_FKEY,
