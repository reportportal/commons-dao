...
public class JTicket extends TableImpl<JTicketRecord> {
	 ...
	 */
	public final TableField<JTicketRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JTicketRecord, String> TICKET_ID = createField("ticket_id",
	 ...
	 */
	public final TableField<JTicketRecord, String> SUBMITTER = createField("submitter",
	 ...
	 */
	public final TableField<JTicketRecord, Timestamp> SUBMIT_DATE = createField("submit_date",
	 ...
	 */
	public final TableField<JTicketRecord, String> BTS_URL = createField("bts_url",
	 ...
	 */
	public final TableField<JTicketRecord, String> BTS_PROJECT = createField("bts_project",
			org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JTicketRecord, String> URL = createField("url",
			org.jooq.impl.SQLDataType.VARCHAR(256).nullable(false),
			this,
			""
	);
