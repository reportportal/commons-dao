...
public class JTicket extends TableImpl<JTicketRecord> {
  ...
  public final TableField<JTicketRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('ticket_id_seq'::regclass)",
  ...
  public final TableField<JTicketRecord, Timestamp> SUBMIT_DATE = createField(
      DSL.name("submit_date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false)
  ...
  public final TableField<JTicketRecord, String> BTS_URL = createField(DSL.name("bts_url"),
      org.jooq.impl.SQLDataType.VARCHAR(1024).nullable(false), this, "");
  /**
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.TICKET_ID_IDX, Indexes.TICKET_PK,
        Indexes.TICKET_SUBMITTER_IDX);
  }
