...
public class JTicket extends TableImpl<JTicketRecord> {
     ...
     */
    public final TableField<JTicketRecord, Instant> SUBMIT_DATE = createField(DSL.name("submit_date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false).defaultValue(org.jooq.impl.DSL.field("now()", org.jooq.impl.SQLDataType.TIMESTAMP)), this, "", new InstantConverter());
