...
public class JDashboardWidgetRecord extends UpdatableRecordImpl<JDashboardWidgetRecord> implements Record7<Integer, Integer, String, Integer, Integer, Integer, Integer> {
    ...
    private static final long serialVersionUID = 1977704234;
     ...
     */
    public JDashboardWidgetRecord(Integer dashboardId, Integer widgetId, String widgetName, Integer widgetWidth, Integer widgetHeight, Integer widgetPositionX, Integer widgetPositionY) {
        super(JDashboardWidget.DASHBOARD_WIDGET);
