...
public class JDashboardWidgetRecord extends UpdatableRecordImpl<JDashboardWidgetRecord> implements
    Record11<Long, Long, String, String, String, Integer, Integer, Integer, Integer, Boolean, Boolean> {
   ...
   */
  public JDashboardWidgetRecord(Long dashboardId, Long widgetId, String widgetName,
      String widgetOwner, String widgetType, Integer widgetWidth, Integer widgetHeight,
      Integer widgetPositionX, Integer widgetPositionY, Boolean isCreatedOn, Boolean share) {
    super(JDashboardWidget.DASHBOARD_WIDGET);
  ...
  @Override
  public JDashboardWidgetRecord values(Long value1, Long value2, String value3, String value4,
      String value5, Integer value6, Integer value7, Integer value8, Integer value9,
