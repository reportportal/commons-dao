...
public class JDashboardWidgetRecord extends UpdatableRecordImpl<JDashboardWidgetRecord> implements Record7<Long, Long, String, Integer, Integer, Integer, Integer> {
     ...
     */
    @Override
    public JDashboardWidgetRecord values(Long value1, Long value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JDashboardWidgetRecord(Long dashboardId, Long widgetId, String widgetName, Integer widgetWidth, Integer widgetHeight, Integer widgetPositionX, Integer widgetPositionY) {
        super(JDashboardWidget.DASHBOARD_WIDGET);
