...
public class JFilter extends TableImpl<JFilterRecord> {
   ...
   */
  public final TableField<JFilterRecord, Long> ID = createField(DSL.name("id"),
   ...
   */
  public final TableField<JFilterRecord, String> DESCRIPTION = createField(DSL.name("description"),
