...
public class JFilter extends TableImpl<JFilterRecord> {
    ...
    private static final long serialVersionUID = -1841141049;
     ...
     */
    public final TableField<JFilterRecord, Long> ID = createField("id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('filter_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");
