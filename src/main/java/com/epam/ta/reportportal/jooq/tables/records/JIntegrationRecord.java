...
public class JIntegrationRecord extends UpdatableRecordImpl<JIntegrationRecord> implements
    Record8<Integer, String, Long, Integer, Boolean, JSONB, String, Timestamp> {
   ...
   */
  public JIntegrationRecord(Integer id, String name, Long projectId, Integer type, Boolean enabled,
      JSONB params, String creator, Timestamp creationDate) {
    super(JIntegration.INTEGRATION);
  ...
  @Override
  public JIntegrationRecord values(Integer value1, String value2, Long value3, Integer value4,
      Boolean value5, JSONB value6, String value7, Timestamp value8) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
