...
public class JIntegrationRecord extends UpdatableRecordImpl<JIntegrationRecord> implements Record7<Integer, String, Long, Integer, Boolean, Object, Timestamp> {

    private static final long serialVersionUID = 23986900;
     ...
     */
    @Override
    public Row7<Integer, String, Long, Integer, Boolean, Object, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<Integer, String, Long, Integer, Boolean, Object, Timestamp> valuesRow() {
     ...
     */
    @Override
    public JIntegrationRecord value7(Timestamp value) {
     ...
     */
    @Override
    public JIntegrationRecord values(Integer value1, String value2, Long value3, Integer value4, Boolean value5, Object value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JIntegrationRecord(Integer id, String name, Long projectId, Integer type, Boolean enabled, Object params, Timestamp creationDate) {
        super(JIntegration.INTEGRATION);
