...
public class JIssueTypeProject extends TableImpl<JIssueTypeProjectRecord> {
   ...
   */
  public final TableField<JIssueTypeProjectRecord, Long> PROJECT_ID = createField(
   ...
   */
  public final TableField<JIssueTypeProjectRecord, Long> ISSUE_TYPE_ID = createField(
      DSL.name("issue_type_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  ...
  public <O extends Record> JIssueTypeProject(Table<O> child,
      ForeignKey<O, JIssueTypeProjectRecord> key) {
  ...
  public List<ForeignKey<JIssueTypeProjectRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JIssueTypeProjectRecord, ?>>asList(
        Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_PROJECT_ID_FKEY,
        Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_ISSUE_TYPE_ID_FKEY);
  }
