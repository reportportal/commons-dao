...
public class JIssueTypeProject extends TableImpl<JIssueTypeProjectRecord> {
    ...
    public List<ForeignKey<JIssueTypeProjectRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_PROJECT_ID_FKEY, Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_ISSUE_TYPE_ID_FKEY);
    }
    ...
    public JProject project() {
        if (_project == null)
            _project = new JProject(this, Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_PROJECT_ID_FKEY);
    ...
    public JIssueType issueType() {
        if (_issueType == null)
            _issueType = new JIssueType(this, Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_ISSUE_TYPE_ID_FKEY);
