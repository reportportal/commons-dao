...
public class JIssueTypeProject extends TableImpl<JIssueTypeProjectRecord> {
	...
	private static final long serialVersionUID = -384673791;
	 ...
	 */
	public final TableField<JIssueTypeProjectRecord, Long> PROJECT_ID = createField("project_id",
	 ...
	 */
	public final TableField<JIssueTypeProjectRecord, Long> ISSUE_TYPE_ID = createField("issue_type_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	...
	public List<ForeignKey<JIssueTypeProjectRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JIssueTypeProjectRecord, ?>>asList(Keys.ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_PROJECT_ID_FKEY,
