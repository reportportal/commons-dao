...
public class JIssueGroup extends TableImpl<JIssueGroupRecord> {
    ...
    private static final long serialVersionUID = 1190808664;
     ...
     */
    public final TableField<JIssueGroupRecord, Short> ISSUE_GROUP_ID = createField("issue_group_id", org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('issue_group_issue_group_id_seq'::regclass)", org.jooq.impl.SQLDataType.SMALLINT)), this, "");

    /**
     * The column <code>public.issue_group.issue_group</code>.
     */
    public final TableField<JIssueGroupRecord, JIssueGroupEnum> ISSUE_GROUP_ = createField("issue_group", org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.epam.ta.reportportal.jooq.enums.JIssueGroupEnum.class), this, "");
