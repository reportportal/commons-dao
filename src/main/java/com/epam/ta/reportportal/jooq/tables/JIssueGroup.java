...
public class JIssueGroup extends TableImpl<JIssueGroupRecord> {
	 ...
	 */
	public final TableField<JIssueGroupRecord, Short> ISSUE_GROUP_ID = createField("issue_group_id",
	 ...
	 */
	public final TableField<JIssueGroupRecord, JIssueGroupEnum> ISSUE_GROUP_ = createField("issue_group",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.epam.ta.reportportal.jooq.enums.JIssueGroupEnum.class),
			this,
			""
	);
