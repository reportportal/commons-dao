...
public class JIssueGroup extends TableImpl<JIssueGroupRecord> {
    ...
    private static final long serialVersionUID = 150896074;
     ...
     */
    public final TableField<JIssueGroupRecord, JIssueGroupEnum> ISSUE_GROUP_ = createField("issue_group", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JIssueGroupEnum.class), this, "");
