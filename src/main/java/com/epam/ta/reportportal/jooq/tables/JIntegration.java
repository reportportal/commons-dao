...
public class JIntegration extends TableImpl<JIntegrationRecord> {
	...
	private static final long serialVersionUID = 461024633;
	 ...
	 */
	public final TableField<JIntegrationRecord, Integer> ID = createField(
			"id",
	 ...
	 */
	public final TableField<JIntegrationRecord, Boolean> ENABLED = createField(
			"enabled",
	 ...
	 */
	public final TableField<JIntegrationRecord, String> CREATOR = createField(
			"creator",
