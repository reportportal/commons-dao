...
public class JIntegration extends TableImpl<JIntegrationRecord> {
	...
	private static final long serialVersionUID = 782284996;
	 ...
	 */
	public final TableField<JIntegrationRecord, Integer> ID = createField("id",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('integration_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)),
			this,
			""
	);
	 ...
	 */
	public final TableField<JIntegrationRecord, String> NAME = createField("name",
	 ...
	 */
	public final TableField<JIntegrationRecord, Boolean> ENABLED = createField("enabled",
	 ...
	 */
	public final TableField<JIntegrationRecord, Object> PARAMS = createField("params",
	 ...
	 */
	public final TableField<JIntegrationRecord, String> CREATOR = createField("creator",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JIntegrationRecord, Timestamp> CREATION_DATE = createField("creation_date",
	...
	public List<Index> getIndexes() {
		return Arrays.<Index>asList(Indexes.INTEGR_PROJECT_IDX,
				Indexes.INTEGRATION_PK,
				Indexes.UNIQUE_GLOBAL_INTEGRATION_NAME,
	...
	public List<ForeignKey<JIntegrationRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JIntegrationRecord, ?>>asList(Keys.INTEGRATION__INTEGRATION_PROJECT_ID_FKEY,
				Keys.INTEGRATION__INTEGRATION_TYPE_FKEY
		);
	}
