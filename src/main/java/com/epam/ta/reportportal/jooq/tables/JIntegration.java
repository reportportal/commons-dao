...
public class JIntegration extends TableImpl<JIntegrationRecord> {
  ...
  public final TableField<JIntegrationRecord, Integer> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('integration_id_seq'::regclass)",
   ...
   */
  public final TableField<JIntegrationRecord, Long> PROJECT_ID = createField(DSL.name("project_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.integration.type</code>.
   */
  public final TableField<JIntegrationRecord, Integer> TYPE = createField(DSL.name("type"),
      org.jooq.impl.SQLDataType.INTEGER, this, "");
  /**
   ...
   */
  public final TableField<JIntegrationRecord, JSONB> PARAMS = createField(DSL.name("params"),
   ...
   */
  public final TableField<JIntegrationRecord, Timestamp> CREATION_DATE = createField(
      DSL.name("creation_date"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false)
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.INTEGR_PROJECT_IDX, Indexes.INTEGRATION_PK,
        Indexes.UNIQUE_GLOBAL_INTEGRATION_NAME, Indexes.UNIQUE_PROJECT_INTEGRATION_NAME);
  }
  ...
  public List<ForeignKey<JIntegrationRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JIntegrationRecord, ?>>asList(
        Keys.INTEGRATION__INTEGRATION_PROJECT_ID_FKEY, Keys.INTEGRATION__INTEGRATION_TYPE_FKEY);
  }
