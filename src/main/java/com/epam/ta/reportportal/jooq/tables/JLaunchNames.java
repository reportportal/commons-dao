...
public class JLaunchNames extends TableImpl<JLaunchNamesRecord> {
    ...
    private static final long serialVersionUID = -111259048;
    ...
    /**
     * The column <code>public.launch_names.email_sender_case_id</code>.
     */
    public final TableField<JLaunchNamesRecord, Long> EMAIL_SENDER_CASE_ID = createField("email_sender_case_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
    ...
    public List<ForeignKey<JLaunchNamesRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<JLaunchNamesRecord, ?>>asList(Keys.LAUNCH_NAMES__LAUNCH_NAMES_EMAIL_SENDER_CASE_ID_FKEY);
    }

    public JEmailSenderCase emailSenderCase() {
        return new JEmailSenderCase(this, Keys.LAUNCH_NAMES__LAUNCH_NAMES_EMAIL_SENDER_CASE_ID_FKEY);
    }
