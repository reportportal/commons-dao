...
public class JLaunchNames extends TableImpl<JLaunchNamesRecord> {
   ...
   */
  public final TableField<JLaunchNamesRecord, Long> SENDER_CASE_ID = createField(
      DSL.name("sender_case_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.launch_names.launch_name</code>.
   */
  public final TableField<JLaunchNamesRecord, String> LAUNCH_NAME = createField(
      DSL.name("launch_name"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  ...
  public List<ForeignKey<JLaunchNamesRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JLaunchNamesRecord, ?>>asList(
        Keys.LAUNCH_NAMES__LAUNCH_NAMES_SENDER_CASE_ID_FKEY);
  }
