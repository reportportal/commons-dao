...
public class JLogRecord extends UpdatableRecordImpl<JLogRecord> implements Record10<Long, String, Timestamp, String, Long, Long, Timestamp, Integer, Long, Long> {

    private static final long serialVersionUID = 1207724867;
    ...
    @Override
    public Row10<Long, String, Timestamp, String, Long, Long, Timestamp, Integer, Long, Long> valuesRow() {
    ...
    @Override
    public JLogRecord values(Long value1, String value2, Timestamp value3, String value4, Long value5, Long value6, Timestamp value7, Integer value8, Long value9, Long value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLogRecord(Long id, String uuid, Timestamp logTime, String logMessage, Long itemId, Long launchId, Timestamp lastModified, Integer logLevel, Long attachmentId, Long projectId) {
        super(JLog.LOG);
