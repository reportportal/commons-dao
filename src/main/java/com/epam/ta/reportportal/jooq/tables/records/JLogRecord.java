...
public class JLogRecord extends UpdatableRecordImpl<JLogRecord> implements Record11<Long, String, Instant, String, Long, Long, Instant, Integer, Long, Long, Long> {

    private static final long serialVersionUID = -537369657;
    ...
    @Override
    public Row11<Long, String, Instant, String, Long, Long, Instant, Integer, Long, Long, Long> valuesRow() {
    ...
    @Override
    public JLogRecord value3(Instant value) {
        setLogTime(value);
        return this;
    }
    ...
    @Override
    public JLogRecord value7(Instant value) {
    ...
    @Override
    public JLogRecord values(Long value1, String value2, Instant value3, String value4, Long value5, Long value6, Instant value7, Integer value8, Long value9, Long value10, Long value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
