...
public class JLogRecord extends UpdatableRecordImpl<JLogRecord> implements Record8<Long, String, Timestamp, String, Long, Timestamp, Integer, Long> {

    private static final long serialVersionUID = 1242105155;
     ...
     */
    @Override
    public Row8<Long, String, Timestamp, String, Long, Timestamp, Integer, Long> fieldsRow() {
     ...
     */
    @Override
    public Row8<Long, String, Timestamp, String, Long, Timestamp, Integer, Long> valuesRow() {
     ...
     */
    @Override
    public JLogRecord values(Long value1, String value2, Timestamp value3, String value4, Long value5, Timestamp value6, Integer value7, Long value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLogRecord(Long id, String uuid, Timestamp logTime, String logMessage, Long itemId, Timestamp lastModified, Integer logLevel, Long attachmentId) {
        super(JLog.LOG);
