...
public class JLogRecord extends UpdatableRecordImpl<JLogRecord> implements Record7<Long, Timestamp, String, Long, Timestamp, Integer, Long> {

    private static final long serialVersionUID = -1492574222;
     ...
     */
    @Override
    public Row7<Long, Timestamp, String, Long, Timestamp, Integer, Long> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Timestamp, String, Long, Timestamp, Integer, Long> valuesRow() {
     ...
     */
    @Override
    public JLogRecord value7(Long value) {
     ...
     */
    @Override
    public JLogRecord values(Long value1, Timestamp value2, String value3, Long value4, Timestamp value5, Integer value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLogRecord(Long id, Timestamp logTime, String logMessage, Long itemId, Timestamp lastModified, Integer logLevel, Long attachmentId) {
        super(JLog.LOG);
