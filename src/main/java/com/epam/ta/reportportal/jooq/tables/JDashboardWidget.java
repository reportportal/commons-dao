...
public class JDashboardWidget extends TableImpl<JDashboardWidgetRecord> {
    ...
    private static final long serialVersionUID = -289558094;
     ...
     */
    public final TableField<JDashboardWidgetRecord, String> WIDGET_TYPE = createField("widget_type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
     ...
     */
    public final TableField<JDashboardWidgetRecord, Boolean> SHARE = createField("share", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false).defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
