...
public class JDashboardWidget extends TableImpl<JDashboardWidgetRecord> {
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Long> DASHBOARD_ID = createField("dashboard_id",
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Long> WIDGET_ID = createField("widget_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, String> WIDGET_NAME = createField("widget_name",
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, String> WIDGET_OWNER = createField("widget_owner",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, String> WIDGET_TYPE = createField("widget_type",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Integer> WIDGET_WIDTH = createField("widget_width",
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Integer> WIDGET_HEIGHT = createField("widget_height",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Integer> WIDGET_POSITION_X = createField("widget_position_x",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Integer> WIDGET_POSITION_Y = createField("widget_position_y",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JDashboardWidgetRecord, Boolean> IS_CREATED_ON = createField("is_created_on",
	...
	public List<ForeignKey<JDashboardWidgetRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JDashboardWidgetRecord, ?>>asList(Keys.DASHBOARD_WIDGET__DASHBOARD_WIDGET_DASHBOARD_ID_FKEY,
