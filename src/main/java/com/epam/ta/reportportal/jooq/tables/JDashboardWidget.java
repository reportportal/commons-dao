...
public class JDashboardWidget extends TableImpl<JDashboardWidgetRecord> {
  ...
  public final TableField<JDashboardWidgetRecord, Long> DASHBOARD_ID = createField(
      DSL.name("dashboard_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, Long> WIDGET_ID = createField(
      DSL.name("widget_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, String> WIDGET_NAME = createField(
      DSL.name("widget_name"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, String> WIDGET_OWNER = createField(
      DSL.name("widget_owner"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, String> WIDGET_TYPE = createField(
      DSL.name("widget_type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, Integer> WIDGET_WIDTH = createField(
      DSL.name("widget_width"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, Integer> WIDGET_HEIGHT = createField(
      DSL.name("widget_height"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, Integer> WIDGET_POSITION_X = createField(
      DSL.name("widget_position_x"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, Integer> WIDGET_POSITION_Y = createField(
      DSL.name("widget_position_y"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  /**
  ...
  public final TableField<JDashboardWidgetRecord, Boolean> IS_CREATED_ON = createField(
      DSL.name("is_created_on"), org.jooq.impl.SQLDataType.BOOLEAN.nullable(false)
   ...
   */
  public final TableField<JDashboardWidgetRecord, Boolean> SHARE = createField(DSL.name("share"),
  ...
  public <O extends Record> JDashboardWidget(Table<O> child,
      ForeignKey<O, JDashboardWidgetRecord> key) {
  ...
  public List<UniqueKey<JDashboardWidgetRecord>> getKeys() {
    return Arrays.<UniqueKey<JDashboardWidgetRecord>>asList(Keys.DASHBOARD_WIDGET_PK,
        Keys.WIDGET_ON_DASHBOARD_UNQ);
  }
