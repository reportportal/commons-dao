...
public class JIssueStatistics extends TableImpl<JIssueStatisticsRecord> {
    ...
    private static final long serialVersionUID = -231713199;
     ...
     */
    public final TableField<JIssueStatisticsRecord, Long> IS_ID = createField("is_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('issue_statistics_is_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.issue_statistics.issue_type_id</code>.
     */
    public final TableField<JIssueStatisticsRecord, Long> ISSUE_TYPE_ID = createField("issue_type_id", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.issue_statistics.is_counter</code>.
     */
    public final TableField<JIssueStatisticsRecord, Integer> IS_COUNTER = createField("is_counter", org.jooq.impl.SQLDataType.INTEGER.defaultValue(org.jooq.impl.DSL.field("0", org.jooq.impl.SQLDataType.INTEGER)), this, "");
    ...
    public List<ForeignKey<JIssueStatisticsRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<JIssueStatisticsRecord, ?>>asList(Keys.ISSUE_STATISTICS__ISSUE_STATISTICS_ISSUE_TYPE_ID_FKEY, Keys.ISSUE_STATISTICS__ISSUE_STATISTICS_ITEM_ID_FKEY, Keys.ISSUE_STATISTICS__ISSUE_STATISTICS_LAUNCH_ID_FKEY);
    }
