...
public class JActivityRecord extends UpdatableRecordImpl<JActivityRecord> implements Record7<Long, Long, JActivityEntityEnum, String, Object, Long, Timestamp> {

    private static final long serialVersionUID = 1516870962;
     ...
     */
    @Override
    public Row7<Long, Long, JActivityEntityEnum, String, Object, Long, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Long, JActivityEntityEnum, String, Object, Long, Timestamp> valuesRow() {
     ...
     */
    @Override
    public JActivityRecord values(Long value1, Long value2, JActivityEntityEnum value3, String value4, Object value5, Long value6, Timestamp value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JActivityRecord(Long id, Long userId, JActivityEntityEnum entity, String action, Object details, Long projectId, Timestamp creationDate) {
        super(JActivity.ACTIVITY);
