...
public class JActivityRecord extends UpdatableRecordImpl<JActivityRecord> implements
    Record9<Long, Long, String, Long, String, String, JSONB, Timestamp, Long> {
   ...
   */
  public JActivityRecord(Long id, Long userId, String username, Long projectId, String entity,
      String action, JSONB details, Timestamp creationDate, Long objectId) {
    super(JActivity.ACTIVITY);
  ...
  @Override
  public JActivityRecord values(Long value1, Long value2, String value3, Long value4, String value5,
      String value6, JSONB value7, Timestamp value8, Long value9) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
