...
public class JActivityRecord extends UpdatableRecordImpl<JActivityRecord> implements Record7<Long, Long, JActivityEntityEnum, String, Object, Timestamp, Long> {

    private static final long serialVersionUID = -1648124898;
     ...
     */
    @Override
    public Row7<Long, Long, JActivityEntityEnum, String, Object, Timestamp, Long> fieldsRow() {
     ...
     */
    @Override
    public Row7<Long, Long, JActivityEntityEnum, String, Object, Timestamp, Long> valuesRow() {
     ...
     */
    @Override
    public JActivityRecord value7(Long value) {
        setProjectId(value);
        return this;
    }
     ...
     */
    @Override
    public JActivityRecord values(Long value1, Long value2, JActivityEntityEnum value3, String value4, Object value5, Timestamp value6, Long value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JActivityRecord(Long id, Long userId, JActivityEntityEnum entity, String action, Object details, Timestamp creationDate, Long projectId) {
        super(JActivity.ACTIVITY);
