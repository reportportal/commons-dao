...
public class JApiKeysRecord extends UpdatableRecordImpl<JApiKeysRecord> implements Record5<Long, String, String, Timestamp, Long> {

    private static final long serialVersionUID = 186305862;
    ...
    @Override
    public JApiKeysRecord values(Long value1, String value2, String value3, Timestamp value4, Long value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
