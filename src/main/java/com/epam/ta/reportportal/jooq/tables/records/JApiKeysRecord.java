...
public class JApiKeysRecord extends UpdatableRecordImpl<JApiKeysRecord> implements Record6<Long, String, String, Timestamp, Long, Date> {
    ...
    @Override
    public JApiKeysRecord values(Long value1, String value2, String value3, Timestamp value4, Long value5, Date value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JApiKeysRecord(Long id, String name, String hash, Timestamp createdAt, Long userId, Date lastUsedAt) {
        super(JApiKeys.API_KEYS);
