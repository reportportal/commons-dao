...
public class JApiKeysRecord extends UpdatableRecordImpl<JApiKeysRecord> implements Record6<Long, String, String, Timestamp, Long, Timestamp> {
     ...
     */
    public void setLastUsedAt(Timestamp value) {
        set(5, value);
    }
    ...
    @Override
    public Row6<Long, String, String, Timestamp, Long, Timestamp> fieldsRow() {
        return (Row6) super.fieldsRow();
    }

    @Override
    public Row6<Long, String, String, Timestamp, Long, Timestamp> valuesRow() {
    ...
    @Override
    public JApiKeysRecord value6(Timestamp value) {
        setLastUsedAt(value);
        return this;
    }

    @Override
    public JApiKeysRecord values(Long value1, String value2, String value3, Timestamp value4, Long value5, Timestamp value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JApiKeysRecord(Long id, String name, String hash, Timestamp createdAt, Long userId, Timestamp lastUsedAt) {
        super(JApiKeys.API_KEYS);
