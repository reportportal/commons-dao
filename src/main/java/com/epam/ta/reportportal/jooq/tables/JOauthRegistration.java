...
public class JOauthRegistration extends TableImpl<JOauthRegistrationRecord> {
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> ID = createField("id",
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> CLIENT_ID = createField("client_id",
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> CLIENT_SECRET = createField("client_secret",
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> CLIENT_AUTH_METHOD = createField("client_auth_method",
			org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> AUTH_GRANT_TYPE = createField("auth_grant_type",
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> REDIRECT_URI_TEMPLATE = createField("redirect_uri_template",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> AUTHORIZATION_URI = createField("authorization_uri",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> TOKEN_URI = createField("token_uri",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> USER_INFO_ENDPOINT_URI = createField("user_info_endpoint_uri",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> USER_INFO_ENDPOINT_NAME_ATTR = createField("user_info_endpoint_name_attr",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> JWK_SET_URI = createField("jwk_set_uri",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JOauthRegistrationRecord, String> CLIENT_NAME = createField("client_name",
