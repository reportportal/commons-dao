...
public class JOauthRegistration extends TableImpl<JOauthRegistrationRecord> {
  ...
  public final TableField<JOauthRegistrationRecord, String> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> CLIENT_ID = createField(
      DSL.name("client_id"), org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> CLIENT_SECRET = createField(
      DSL.name("client_secret"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> CLIENT_AUTH_METHOD = createField(
      DSL.name("client_auth_method"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this,
      "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> AUTH_GRANT_TYPE = createField(
      DSL.name("auth_grant_type"), org.jooq.impl.SQLDataType.VARCHAR(64), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> REDIRECT_URI_TEMPLATE = createField(
      DSL.name("redirect_uri_template"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> AUTHORIZATION_URI = createField(
      DSL.name("authorization_uri"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> TOKEN_URI = createField(
      DSL.name("token_uri"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> USER_INFO_ENDPOINT_URI = createField(
      DSL.name("user_info_endpoint_uri"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> USER_INFO_ENDPOINT_NAME_ATTR = createField(
      DSL.name("user_info_endpoint_name_attr"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> JWK_SET_URI = createField(
      DSL.name("jwk_set_uri"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  /**
  ...
  public final TableField<JOauthRegistrationRecord, String> CLIENT_NAME = createField(
      DSL.name("client_name"), org.jooq.impl.SQLDataType.VARCHAR(128), this, "");
  ...
  public <O extends Record> JOauthRegistration(Table<O> child,
      ForeignKey<O, JOauthRegistrationRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.OAUTH_REGISTRATION_CLIENT_ID_KEY,
        Indexes.OAUTH_REGISTRATION_PKEY);
  }
  ...
  public List<UniqueKey<JOauthRegistrationRecord>> getKeys() {
    return Arrays.<UniqueKey<JOauthRegistrationRecord>>asList(Keys.OAUTH_REGISTRATION_PKEY,
        Keys.OAUTH_REGISTRATION_CLIENT_ID_KEY);
  }
