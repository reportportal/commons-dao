...
public class JOauthAccessTokenRecord extends UpdatableRecordImpl<JOauthAccessTokenRecord> implements
    Record9<Long, String, byte[], String, String, Long, String, byte[], String> {
   ...
   */
  public JOauthAccessTokenRecord(Long id, String tokenId, byte[] token, String authenticationId,
      String username, Long userId, String clientId, byte[] authentication, String refreshToken) {
    super(JOauthAccessToken.OAUTH_ACCESS_TOKEN);
  ...
  @Override
  public JOauthAccessTokenRecord values(Long value1, String value2, byte[] value3, String value4,
      String value5, Long value6, String value7, byte[] value8, String value9) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
