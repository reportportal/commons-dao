...
public class JOrganizationRecord extends UpdatableRecordImpl<JOrganizationRecord> implements Record2<Long, String> {

    private static final long serialVersionUID = 1068958172;
    ...
    @Override
    public JOrganizationRecord values(Long value1, String value2) {
        value1(value1);
        value2(value2);
        return this;
    }
     ...
     */
    public JOrganizationRecord(Long id, String name) {
        super(JOrganization.ORGANIZATION);
