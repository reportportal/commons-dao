...
import com.epam.ta.reportportal.jooq.tables.records.JLogTypeRecord;
...
public class Keys {
    ...
    public static final UniqueKey<JGroupsRecord> GROUPS_SLUG_KEY = Internal.createUniqueKey(JGroups.GROUPS, DSL.name("groups_slug_key"), new TableField[] { JGroups.GROUPS.SLUG }, true);
    ...
    public static final UniqueKey<JOnboardingRecord> ONBOARDING_PK = Internal.createUniqueKey(JOnboarding.ONBOARDING, DSL.name("onboarding_pk"), new TableField[] { JOnboarding.ONBOARDING.ID }, true);
    ...
    public static final UniqueKey<JProjectRecord> PROJECT_NAME_KEY = Internal.createUniqueKey(JProject.PROJECT, DSL.name("project_name_key"), new TableField[] { JProject.PROJECT.NAME }, true);
    ...
    public static final ForeignKey<JTestItemRecord, JUsersRecord> TEST_ITEM__FK_TEST_ITEM_ANALYSIS_OWNER = Internal.createForeignKey(JTestItem.TEST_ITEM, DSL.name("fk_test_item_analysis_owner"), new TableField[] { JTestItem.TEST_ITEM.ANALYSIS_OWNER_ID }, Keys.USERS_PK, new TableField[] { JUsers.USERS.ID }, true);
