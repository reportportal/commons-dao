...
public class Keys {
    ...
    public static final ForeignKey<JLaunchRecord, JOrganizationRecord> LAUNCH__FK_LAUNCH_ORGANIZATION = Internal.createForeignKey(JLaunch.LAUNCH, DSL.name("fk_launch_organization"), new TableField[] { JLaunch.LAUNCH.ORGANIZATION_ID }, Keys.ORGANIZATION_PKEY, new TableField[] { JOrganization.ORGANIZATION.ID }, true);
