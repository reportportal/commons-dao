...
public class Keys {
	...
	public static final UniqueKey<JLogRecord> LOG_UUID_KEY = UniqueKeys0.LOG_UUID_KEY;
	...
	private static class Identities0 {
		...
		public static Identity<JAttachmentRecord, Long> IDENTITY_ATTACHMENT = Internal.createIdentity(JAttachment.ATTACHMENT,
				JAttachment.ATTACHMENT.ID
		);
		...
		public static Identity<JItemAttributeRecord, Long> IDENTITY_ITEM_ATTRIBUTE = Internal.createIdentity(JItemAttribute.ITEM_ATTRIBUTE,
		...
		public static Identity<JLaunchNumberRecord, Long> IDENTITY_LAUNCH_NUMBER = Internal.createIdentity(JLaunchNumber.LAUNCH_NUMBER,
				JLaunchNumber.LAUNCH_NUMBER.ID
		);
		...
		public static Identity<JOauthAccessTokenRecord, Long> IDENTITY_OAUTH_ACCESS_TOKEN = Internal.createIdentity(JOauthAccessToken.OAUTH_ACCESS_TOKEN,
		...
		public static Identity<JPatternTemplateRecord, Long> IDENTITY_PATTERN_TEMPLATE = Internal.createIdentity(JPatternTemplate.PATTERN_TEMPLATE,
		...
		public static Identity<JSamlProviderDetailsRecord, Long> IDENTITY_SAML_PROVIDER_DETAILS = Internal.createIdentity(
				JSamlProviderDetails.SAML_PROVIDER_DETAILS,
				JSamlProviderDetails.SAML_PROVIDER_DETAILS.ID
		);
		public static Identity<JSenderCaseRecord, Long> IDENTITY_SENDER_CASE = Internal.createIdentity(JSenderCase.SENDER_CASE,
				JSenderCase.SENDER_CASE.ID
		);
		...
		public static Identity<JShareableEntityRecord, Long> IDENTITY_SHAREABLE_ENTITY = Internal.createIdentity(JShareableEntity.SHAREABLE_ENTITY,
				JShareableEntity.SHAREABLE_ENTITY.ID
		);
		...
		public static Identity<JUserPreferenceRecord, Long> IDENTITY_USER_PREFERENCE = Internal.createIdentity(JUserPreference.USER_PREFERENCE,
				JUserPreference.USER_PREFERENCE.ID
		);
	...
	private static class UniqueKeys0 {
		...
		public static final UniqueKey<JIntegrationTypeRecord> INTEGRATION_TYPE_NAME_KEY = Internal.createUniqueKey(JIntegrationType.INTEGRATION_TYPE,
		...
		public static final UniqueKey<JItemAttributeRecord> ITEM_ATTRIBUTE_PK = Internal.createUniqueKey(JItemAttribute.ITEM_ATTRIBUTE,
				"item_attribute_pk",
				JItemAttribute.ITEM_ATTRIBUTE.ID
		);
		...
		public static final UniqueKey<JLaunchNumberRecord> LAUNCH_NUMBER_PK = Internal.createUniqueKey(JLaunchNumber.LAUNCH_NUMBER,
				"launch_number_pk",
				JLaunchNumber.LAUNCH_NUMBER.ID
		);
		public static final UniqueKey<JLaunchNumberRecord> UNQ_PROJECT_NAME = Internal.createUniqueKey(JLaunchNumber.LAUNCH_NUMBER,
				"unq_project_name",
				JLaunchNumber.LAUNCH_NUMBER.PROJECT_ID,
		...
		public static final UniqueKey<JLogRecord> LOG_UUID_KEY = Internal.createUniqueKey(JLog.LOG, "log_uuid_key", JLog.LOG.UUID);
		public static final UniqueKey<JOauthAccessTokenRecord> OAUTH_ACCESS_TOKEN_PKEY = Internal.createUniqueKey(JOauthAccessToken.OAUTH_ACCESS_TOKEN,
				"oauth_access_token_pkey",
				JOauthAccessToken.OAUTH_ACCESS_TOKEN.ID
		);
		public static final UniqueKey<JOauthAccessTokenRecord> USERS_ACCESS_TOKEN_UNIQUE = Internal.createUniqueKey(JOauthAccessToken.OAUTH_ACCESS_TOKEN,
		...
		public static final UniqueKey<JPatternTemplateRecord> PATTERN_TEMPLATE_PK = Internal.createUniqueKey(JPatternTemplate.PATTERN_TEMPLATE,
				"pattern_template_pk",
				JPatternTemplate.PATTERN_TEMPLATE.ID
		);
		public static final UniqueKey<JPatternTemplateRecord> UNQ_NAME_PROJECTID = Internal.createUniqueKey(JPatternTemplate.PATTERN_TEMPLATE,
				"unq_name_projectid",
				JPatternTemplate.PATTERN_TEMPLATE.NAME,
				JPatternTemplate.PATTERN_TEMPLATE.PROJECT_ID
		);
		public static final UniqueKey<JPatternTemplateTestItemRecord> PATTERN_ITEM_UNQ = Internal.createUniqueKey(JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM,
				"pattern_item_unq",
		...
		public static final UniqueKey<JSamlProviderDetailsRecord> SAML_PROVIDER_DETAILS_PKEY = Internal.createUniqueKey(JSamlProviderDetails.SAML_PROVIDER_DETAILS,
		...
		public static final UniqueKey<JShareableEntityRecord> SHAREABLE_PK = Internal.createUniqueKey(JShareableEntity.SHAREABLE_ENTITY,
				"shareable_pk",
				JShareableEntity.SHAREABLE_ENTITY.ID
		);
		...
		public static final UniqueKey<JStatisticsFieldRecord> STATISTICS_FIELD_NAME_KEY = Internal.createUniqueKey(JStatisticsField.STATISTICS_FIELD,
		...
		public static final UniqueKey<JUserPreferenceRecord> USER_PREFERENCE_PK = Internal.createUniqueKey(JUserPreference.USER_PREFERENCE,
				"user_preference_pk",
				JUserPreference.USER_PREFERENCE.ID
		);
		public static final UniqueKey<JUserPreferenceRecord> USER_PREFERENCE_UQ = Internal.createUniqueKey(JUserPreference.USER_PREFERENCE,
				"user_preference_uq",
				JUserPreference.USER_PREFERENCE.PROJECT_ID,
				JUserPreference.USER_PREFERENCE.USER_ID,
	...
	private static class ForeignKeys0 {
		...
		public static final ForeignKey<JAclSidRecord, JUsersRecord> ACL_SID__ACL_SID_SID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.USERS_LOGIN_KEY,
				JAclSid.ACL_SID,
				"acl_sid__acl_sid_sid_fkey",
				JAclSid.ACL_SID.SID
		);
		...
		public static final ForeignKey<JContentFieldRecord, JWidgetRecord> CONTENT_FIELD__CONTENT_FIELD_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.WIDGET_PKEY,
				JContentField.CONTENT_FIELD,
				"content_field__content_field_id_fkey",
				JContentField.CONTENT_FIELD.ID
		);
		public static final ForeignKey<JDashboardRecord, JShareableEntityRecord> DASHBOARD__DASHBOARD_ID_FK = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.SHAREABLE_PK,
				JDashboard.DASHBOARD,
				"dashboard__dashboard_id_fk",
				JDashboard.DASHBOARD.ID
		);
		public static final ForeignKey<JDashboardWidgetRecord, JDashboardRecord> DASHBOARD_WIDGET__DASHBOARD_WIDGET_DASHBOARD_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.DASHBOARD_PKEY,
		...
		public static final ForeignKey<JFilterRecord, JShareableEntityRecord> FILTER__FILTER_ID_FK = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.SHAREABLE_PK,
				JFilter.FILTER,
				"filter__filter_id_fk",
				JFilter.FILTER.ID
		);
		public static final ForeignKey<JFilterConditionRecord, JFilterRecord> FILTER_CONDITION__FILTER_CONDITION_FILTER_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.FILTER_PKEY,
		...
		public static final ForeignKey<JLaunchNamesRecord, JSenderCaseRecord> LAUNCH_NAMES__LAUNCH_NAMES_SENDER_CASE_ID_FKEY = Internal.createForeignKey(
				...
				"launch_names__launch_names_sender_case_id_fkey",
				JLaunchNames.LAUNCH_NAMES.SENDER_CASE_ID
		);
		public static final ForeignKey<JLaunchNumberRecord, JProjectRecord> LAUNCH_NUMBER__LAUNCH_NUMBER_PROJECT_ID_FKEY = Internal.createForeignKey(
				...
				"launch_number__launch_number_project_id_fkey",
				JLaunchNumber.LAUNCH_NUMBER.PROJECT_ID
		);
		...
		public static final ForeignKey<JLogRecord, JLaunchRecord> LOG__LOG_LAUNCH_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK,
				JLog.LOG,
				"log__log_launch_id_fkey",
				JLog.LOG.LAUNCH_ID
		);
		public static final ForeignKey<JLogRecord, JAttachmentRecord> LOG__LOG_ATTACHMENT_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.ATTACHMENT_PK,
				JLog.LOG,
				"log__log_attachment_id_fkey",
		...
		public static final ForeignKey<JPatternTemplateRecord, JProjectRecord> PATTERN_TEMPLATE__PATTERN_TEMPLATE_PROJECT_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PROJECT_PK,
						JPatternTemplate.PATTERN_TEMPLATE,
						"pattern_template__pattern_template_project_id_fkey",
						JPatternTemplate.PATTERN_TEMPLATE.PROJECT_ID
				);
		public static final ForeignKey<JPatternTemplateTestItemRecord, JPatternTemplateRecord> PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_PATTERN_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PATTERN_TEMPLATE_PK,
		...
		public static final ForeignKey<JPatternTemplateTestItemRecord, JTestItemRecord> PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_ITEM_ID_FKEY = Internal
		...
		public static final ForeignKey<JRecipientsRecord, JSenderCaseRecord> RECIPIENTS__RECIPIENTS_SENDER_CASE_ID_FKEY = Internal.createForeignKey(
				...
				"recipients__recipients_sender_case_id_fkey",
				JRecipients.RECIPIENTS.SENDER_CASE_ID
		);
		public static final ForeignKey<JSenderCaseRecord, JProjectRecord> SENDER_CASE__SENDER_CASE_PROJECT_ID_FKEY = Internal.createForeignKey(
				...
				"sender_case__sender_case_project_id_fkey",
				JSenderCase.SENDER_CASE.PROJECT_ID
		);
		public static final ForeignKey<JShareableEntityRecord, JUsersRecord> SHAREABLE_ENTITY__SHAREABLE_ENTITY_OWNER_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.USERS_LOGIN_KEY,
				JShareableEntity.SHAREABLE_ENTITY,
				"shareable_entity__shareable_entity_owner_fkey",
				JShareableEntity.SHAREABLE_ENTITY.OWNER
		);
		public static final ForeignKey<JShareableEntityRecord, JProjectRecord> SHAREABLE_ENTITY__SHAREABLE_ENTITY_PROJECT_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PROJECT_PK,
						JShareableEntity.SHAREABLE_ENTITY,
		...
		public static final ForeignKey<JWidgetRecord, JShareableEntityRecord> WIDGET__WIDGET_ID_FK = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.SHAREABLE_PK,
				JWidget.WIDGET,
				"widget__widget_id_fk",
				JWidget.WIDGET.ID
		);
