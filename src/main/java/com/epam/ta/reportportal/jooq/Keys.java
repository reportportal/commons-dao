...
public class Keys {
  ...
  private static class Identities0 {
    ...
    public static Identity<JAclClassRecord, Long> IDENTITY_ACL_CLASS = Internal.createIdentity(
        JAclClass.ACL_CLASS, JAclClass.ACL_CLASS.ID);
    public static Identity<JAclEntryRecord, Long> IDENTITY_ACL_ENTRY = Internal.createIdentity(
        JAclEntry.ACL_ENTRY, JAclEntry.ACL_ENTRY.ID);
    public static Identity<JAclObjectIdentityRecord, Long> IDENTITY_ACL_OBJECT_IDENTITY = Internal.createIdentity(
        JAclObjectIdentity.ACL_OBJECT_IDENTITY, JAclObjectIdentity.ACL_OBJECT_IDENTITY.ID);
    public static Identity<JAclSidRecord, Long> IDENTITY_ACL_SID = Internal.createIdentity(
        JAclSid.ACL_SID, JAclSid.ACL_SID.ID);
    public static Identity<JActivityRecord, Long> IDENTITY_ACTIVITY = Internal.createIdentity(
        JActivity.ACTIVITY, JActivity.ACTIVITY.ID);
    public static Identity<JAttachmentRecord, Long> IDENTITY_ATTACHMENT = Internal.createIdentity(
        JAttachment.ATTACHMENT, JAttachment.ATTACHMENT.ID);
    public static Identity<JAttributeRecord, Long> IDENTITY_ATTRIBUTE = Internal.createIdentity(
        JAttribute.ATTRIBUTE, JAttribute.ATTRIBUTE.ID);
    public static Identity<JClustersRecord, Long> IDENTITY_CLUSTERS = Internal.createIdentity(
        JClusters.CLUSTERS, JClusters.CLUSTERS.ID);
    ...
    public static Identity<JItemAttributeRecord, Long> IDENTITY_ITEM_ATTRIBUTE = Internal.createIdentity(
        JItemAttribute.ITEM_ATTRIBUTE, JItemAttribute.ITEM_ATTRIBUTE.ID);
    public static Identity<JLaunchRecord, Long> IDENTITY_LAUNCH = Internal.createIdentity(
        JLaunch.LAUNCH, JLaunch.LAUNCH.ID);
    public static Identity<JLaunchAttributeRulesRecord, Long> IDENTITY_LAUNCH_ATTRIBUTE_RULES = Internal.createIdentity(
        JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES,
        JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES.ID);
    public static Identity<JLaunchNumberRecord, Long> IDENTITY_LAUNCH_NUMBER = Internal.createIdentity(
        JLaunchNumber.LAUNCH_NUMBER, JLaunchNumber.LAUNCH_NUMBER.ID);
    public static Identity<JLogRecord, Long> IDENTITY_LOG = Internal.createIdentity(JLog.LOG,
        JLog.LOG.ID);
    public static Identity<JOauthAccessTokenRecord, Long> IDENTITY_OAUTH_ACCESS_TOKEN = Internal.createIdentity(
        JOauthAccessToken.OAUTH_ACCESS_TOKEN, JOauthAccessToken.OAUTH_ACCESS_TOKEN.ID);
    ...
    public static Identity<JOnboardingRecord, Short> IDENTITY_ONBOARDING = Internal.createIdentity(
        JOnboarding.ONBOARDING, JOnboarding.ONBOARDING.ID);
    public static Identity<JPatternTemplateRecord, Long> IDENTITY_PATTERN_TEMPLATE = Internal.createIdentity(
        JPatternTemplate.PATTERN_TEMPLATE, JPatternTemplate.PATTERN_TEMPLATE.ID);
    public static Identity<JProjectRecord, Long> IDENTITY_PROJECT = Internal.createIdentity(
        JProject.PROJECT, JProject.PROJECT.ID);
    public static Identity<JProjectAttributeRecord, Long> IDENTITY_PROJECT_ATTRIBUTE = Internal.createIdentity(
        JProjectAttribute.PROJECT_ATTRIBUTE, JProjectAttribute.PROJECT_ATTRIBUTE.ATTRIBUTE_ID);
    public static Identity<JSenderCaseRecord, Long> IDENTITY_SENDER_CASE = Internal.createIdentity(
        JSenderCase.SENDER_CASE, JSenderCase.SENDER_CASE.ID);
    ...
    public static Identity<JShareableEntityRecord, Long> IDENTITY_SHAREABLE_ENTITY = Internal.createIdentity(
        JShareableEntity.SHAREABLE_ENTITY, JShareableEntity.SHAREABLE_ENTITY.ID);
    public static Identity<JStaleMaterializedViewRecord, Long> IDENTITY_STALE_MATERIALIZED_VIEW = Internal.createIdentity(
        JStaleMaterializedView.STALE_MATERIALIZED_VIEW,
        JStaleMaterializedView.STALE_MATERIALIZED_VIEW.ID);
    public static Identity<JStatisticsRecord, Long> IDENTITY_STATISTICS = Internal.createIdentity(
        JStatistics.STATISTICS, JStatistics.STATISTICS.S_ID);
    public static Identity<JStatisticsFieldRecord, Long> IDENTITY_STATISTICS_FIELD = Internal.createIdentity(
        JStatisticsField.STATISTICS_FIELD, JStatisticsField.STATISTICS_FIELD.SF_ID);
    ...
    public static Identity<JTicketRecord, Long> IDENTITY_TICKET = Internal.createIdentity(
        JTicket.TICKET, JTicket.TICKET.ID);
    public static Identity<JUserPreferenceRecord, Long> IDENTITY_USER_PREFERENCE = Internal.createIdentity(
        JUserPreference.USER_PREFERENCE, JUserPreference.USER_PREFERENCE.ID);
    public static Identity<JUsersRecord, Long> IDENTITY_USERS = Internal.createIdentity(
        JUsers.USERS, JUsers.USERS.ID);
  }

  private static class UniqueKeys0 {

    public static final UniqueKey<JAclClassRecord> ACL_CLASS_PKEY = Internal.createUniqueKey(
        JAclClass.ACL_CLASS, "acl_class_pkey", JAclClass.ACL_CLASS.ID);
    public static final UniqueKey<JAclClassRecord> UNIQUE_UK_2 = Internal.createUniqueKey(
        JAclClass.ACL_CLASS, "unique_uk_2", JAclClass.ACL_CLASS.CLASS);
    public static final UniqueKey<JAclEntryRecord> ACL_ENTRY_PKEY = Internal.createUniqueKey(
        JAclEntry.ACL_ENTRY, "acl_entry_pkey", JAclEntry.ACL_ENTRY.ID);
    public static final UniqueKey<JAclEntryRecord> UNIQUE_UK_4 = Internal.createUniqueKey(
        JAclEntry.ACL_ENTRY, "unique_uk_4", JAclEntry.ACL_ENTRY.ACL_OBJECT_IDENTITY,
        JAclEntry.ACL_ENTRY.ACE_ORDER);
    public static final UniqueKey<JAclObjectIdentityRecord> ACL_OBJECT_IDENTITY_PKEY = Internal.createUniqueKey(
        JAclObjectIdentity.ACL_OBJECT_IDENTITY, "acl_object_identity_pkey",
        JAclObjectIdentity.ACL_OBJECT_IDENTITY.ID);
    public static final UniqueKey<JAclObjectIdentityRecord> UNIQUE_UK_3 = Internal.createUniqueKey(
        JAclObjectIdentity.ACL_OBJECT_IDENTITY, "unique_uk_3",
        JAclObjectIdentity.ACL_OBJECT_IDENTITY.OBJECT_ID_CLASS,
        JAclObjectIdentity.ACL_OBJECT_IDENTITY.OBJECT_ID_IDENTITY);
    public static final UniqueKey<JAclSidRecord> ACL_SID_PKEY = Internal.createUniqueKey(
        JAclSid.ACL_SID, "acl_sid_pkey", JAclSid.ACL_SID.ID);
    public static final UniqueKey<JAclSidRecord> UNIQUE_UK_1 = Internal.createUniqueKey(
        JAclSid.ACL_SID, "unique_uk_1", JAclSid.ACL_SID.SID, JAclSid.ACL_SID.PRINCIPAL);
    public static final UniqueKey<JActivityRecord> ACTIVITY_PK = Internal.createUniqueKey(
        JActivity.ACTIVITY, "activity_pk", JActivity.ACTIVITY.ID);
    public static final UniqueKey<JAttachmentRecord> ATTACHMENT_PK = Internal.createUniqueKey(
        JAttachment.ATTACHMENT, "attachment_pk", JAttachment.ATTACHMENT.ID);
    public static final UniqueKey<JAttachmentDeletionRecord> ATTACHMENT_DELETION_PKEY = Internal.createUniqueKey(
        JAttachmentDeletion.ATTACHMENT_DELETION, "attachment_deletion_pkey",
        JAttachmentDeletion.ATTACHMENT_DELETION.ID);
    public static final UniqueKey<JAttributeRecord> ATTRIBUTE_PK = Internal.createUniqueKey(
        JAttribute.ATTRIBUTE, "attribute_pk", JAttribute.ATTRIBUTE.ID);
    public static final UniqueKey<JClustersRecord> CLUSTERS_PK = Internal.createUniqueKey(
        JClusters.CLUSTERS, "clusters_pk", JClusters.CLUSTERS.ID);
    public static final UniqueKey<JClustersRecord> INDEX_ID_LAUNCH_ID_UNQ = Internal.createUniqueKey(
        JClusters.CLUSTERS, "index_id_launch_id_unq", JClusters.CLUSTERS.INDEX_ID,
        JClusters.CLUSTERS.LAUNCH_ID);
    public static final UniqueKey<JClustersTestItemRecord> CLUSTER_ITEM_UNQ = Internal.createUniqueKey(
        JClustersTestItem.CLUSTERS_TEST_ITEM, "cluster_item_unq",
        JClustersTestItem.CLUSTERS_TEST_ITEM.CLUSTER_ID,
        JClustersTestItem.CLUSTERS_TEST_ITEM.ITEM_ID);
    public static final UniqueKey<JDashboardRecord> DASHBOARD_PKEY = Internal.createUniqueKey(
        JDashboard.DASHBOARD, "dashboard_pkey", JDashboard.DASHBOARD.ID);
    public static final UniqueKey<JDashboardWidgetRecord> DASHBOARD_WIDGET_PK = Internal.createUniqueKey(
        JDashboardWidget.DASHBOARD_WIDGET, "dashboard_widget_pk",
    ...
    public static final UniqueKey<JDashboardWidgetRecord> WIDGET_ON_DASHBOARD_UNQ = Internal.createUniqueKey(
        JDashboardWidget.DASHBOARD_WIDGET, "widget_on_dashboard_unq",
        JDashboardWidget.DASHBOARD_WIDGET.DASHBOARD_ID,
    ...
    public static final UniqueKey<JFilterRecord> FILTER_PKEY = Internal.createUniqueKey(
        JFilter.FILTER, "filter_pkey", JFilter.FILTER.ID);
    public static final UniqueKey<JFilterConditionRecord> FILTER_CONDITION_PK = Internal.createUniqueKey(
        JFilterCondition.FILTER_CONDITION, "filter_condition_pk",
    ...
    public static final UniqueKey<JIntegrationTypeRecord> INTEGRATION_TYPE_PK = Internal.createUniqueKey(
        JIntegrationType.INTEGRATION_TYPE, "integration_type_pk",
    ...
    public static final UniqueKey<JIntegrationTypeRecord> INTEGRATION_TYPE_NAME_KEY = Internal.createUniqueKey(
        JIntegrationType.INTEGRATION_TYPE, "integration_type_name_key",
        JIntegrationType.INTEGRATION_TYPE.NAME);
    public static final UniqueKey<JIssueRecord> ISSUE_PK = Internal.createUniqueKey(JIssue.ISSUE,
        "issue_pk", JIssue.ISSUE.ISSUE_ID);
    ...
    public static final UniqueKey<JIssueTicketRecord> ISSUE_TICKET_PK = Internal.createUniqueKey(
        JIssueTicket.ISSUE_TICKET, "issue_ticket_pk", JIssueTicket.ISSUE_TICKET.ISSUE_ID,
    ...
    public static final UniqueKey<JIssueTypeRecord> ISSUE_TYPE_LOCATOR_KEY = Internal.createUniqueKey(
        JIssueType.ISSUE_TYPE, "issue_type_locator_key", JIssueType.ISSUE_TYPE.LOCATOR);
    public static final UniqueKey<JIssueTypeProjectRecord> ISSUE_TYPE_PROJECT_PK = Internal.createUniqueKey(
        JIssueTypeProject.ISSUE_TYPE_PROJECT, "issue_type_project_pk",
    ...
    public static final UniqueKey<JItemAttributeRecord> ITEM_ATTRIBUTE_PK = Internal.createUniqueKey(
        JItemAttribute.ITEM_ATTRIBUTE, "item_attribute_pk", JItemAttribute.ITEM_ATTRIBUTE.ID);
    public static final UniqueKey<JLaunchRecord> LAUNCH_PK = Internal.createUniqueKey(
        JLaunch.LAUNCH, "launch_pk", JLaunch.LAUNCH.ID);
    public static final UniqueKey<JLaunchRecord> LAUNCH_UUID_KEY = Internal.createUniqueKey(
        JLaunch.LAUNCH, "launch_uuid_key", JLaunch.LAUNCH.UUID);
    public static final UniqueKey<JLaunchRecord> UNQ_NAME_NUMBER = Internal.createUniqueKey(
        JLaunch.LAUNCH, "unq_name_number", JLaunch.LAUNCH.NAME, JLaunch.LAUNCH.NUMBER,
    ...
    public static final UniqueKey<JLaunchAttributeRulesRecord> LAUNCH_ATTRIBUTE_RULES_PK = Internal.createUniqueKey(
        JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES, "launch_attribute_rules_pk",
        JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES.ID);
    public static final UniqueKey<JLaunchNumberRecord> LAUNCH_NUMBER_PK = Internal.createUniqueKey(
        JLaunchNumber.LAUNCH_NUMBER, "launch_number_pk", JLaunchNumber.LAUNCH_NUMBER.ID);
    public static final UniqueKey<JLaunchNumberRecord> UNQ_PROJECT_NAME = Internal.createUniqueKey(
        JLaunchNumber.LAUNCH_NUMBER, "unq_project_name", JLaunchNumber.LAUNCH_NUMBER.PROJECT_ID,
        JLaunchNumber.LAUNCH_NUMBER.LAUNCH_NAME);
    public static final UniqueKey<JLogRecord> LOG_PK = Internal.createUniqueKey(JLog.LOG, "log_pk",
        JLog.LOG.ID);
    public static final UniqueKey<JOauthAccessTokenRecord> OAUTH_ACCESS_TOKEN_PKEY = Internal.createUniqueKey(
        JOauthAccessToken.OAUTH_ACCESS_TOKEN, "oauth_access_token_pkey",
        JOauthAccessToken.OAUTH_ACCESS_TOKEN.ID);
    public static final UniqueKey<JOauthAccessTokenRecord> USERS_ACCESS_TOKEN_UNIQUE = Internal.createUniqueKey(
        JOauthAccessToken.OAUTH_ACCESS_TOKEN, "users_access_token_unique",
        JOauthAccessToken.OAUTH_ACCESS_TOKEN.TOKEN_ID,
    ...
    public static final UniqueKey<JOauthRegistrationRecord> OAUTH_REGISTRATION_PKEY = Internal.createUniqueKey(
        JOauthRegistration.OAUTH_REGISTRATION, "oauth_registration_pkey",
    ...
    public static final UniqueKey<JOauthRegistrationRecord> OAUTH_REGISTRATION_CLIENT_ID_KEY = Internal.createUniqueKey(
        JOauthRegistration.OAUTH_REGISTRATION, "oauth_registration_client_id_key",
    ...
    public static final UniqueKey<JOauthRegistrationScopeRecord> OAUTH_REGISTRATION_SCOPE_UNIQUE = Internal.createUniqueKey(
        JOauthRegistrationScope.OAUTH_REGISTRATION_SCOPE, "oauth_registration_scope_unique",
    ...
    public static final UniqueKey<JOnboardingRecord> ONBOARDING_PK = Internal.createUniqueKey(
        JOnboarding.ONBOARDING, "onboarding_pk", JOnboarding.ONBOARDING.ID);
    public static final UniqueKey<JPatternTemplateRecord> PATTERN_TEMPLATE_PK = Internal.createUniqueKey(
        JPatternTemplate.PATTERN_TEMPLATE, "pattern_template_pk",
        JPatternTemplate.PATTERN_TEMPLATE.ID);
    public static final UniqueKey<JPatternTemplateRecord> UNQ_NAME_PROJECTID = Internal.createUniqueKey(
        JPatternTemplate.PATTERN_TEMPLATE, "unq_name_projectid",
        JPatternTemplate.PATTERN_TEMPLATE.NAME, JPatternTemplate.PATTERN_TEMPLATE.PROJECT_ID);
    public static final UniqueKey<JPatternTemplateTestItemRecord> PATTERN_ITEM_UNQ = Internal.createUniqueKey(
        JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM, "pattern_item_unq",
    ...
    public static final UniqueKey<JProjectRecord> PROJECT_NAME_KEY = Internal.createUniqueKey(
        JProject.PROJECT, "project_name_key", JProject.PROJECT.NAME);
    public static final UniqueKey<JProjectAttributeRecord> UNIQUE_ATTRIBUTE_PER_PROJECT = Internal.createUniqueKey(
        JProjectAttribute.PROJECT_ATTRIBUTE, "unique_attribute_per_project",
    ...
    public static final UniqueKey<JProjectUserRecord> USERS_PROJECT_PK = Internal.createUniqueKey(
        JProjectUser.PROJECT_USER, "users_project_pk", JProjectUser.PROJECT_USER.USER_ID,
    ...
    public static final UniqueKey<JRestorePasswordBidRecord> RESTORE_PASSWORD_BID_PK = Internal.createUniqueKey(
        JRestorePasswordBid.RESTORE_PASSWORD_BID, "restore_password_bid_pk",
    ...
    public static final UniqueKey<JRestorePasswordBidRecord> RESTORE_PASSWORD_BID_EMAIL_KEY = Internal.createUniqueKey(
        JRestorePasswordBid.RESTORE_PASSWORD_BID, "restore_password_bid_email_key",
    ...
    public static final UniqueKey<JSenderCaseRecord> SENDER_CASE_PK = Internal.createUniqueKey(
        JSenderCase.SENDER_CASE, "sender_case_pk", JSenderCase.SENDER_CASE.ID);
    ...
    public static final UniqueKey<JServerSettingsRecord> SERVER_SETTINGS_KEY_KEY = Internal.createUniqueKey(
        JServerSettings.SERVER_SETTINGS, "server_settings_key_key",
        JServerSettings.SERVER_SETTINGS.KEY);
    public static final UniqueKey<JShareableEntityRecord> SHAREABLE_PK = Internal.createUniqueKey(
        JShareableEntity.SHAREABLE_ENTITY, "shareable_pk", JShareableEntity.SHAREABLE_ENTITY.ID);
    public static final UniqueKey<JStaleMaterializedViewRecord> STALE_MATERIALIZED_VIEW_PKEY = Internal.createUniqueKey(
        JStaleMaterializedView.STALE_MATERIALIZED_VIEW, "stale_materialized_view_pkey",
        JStaleMaterializedView.STALE_MATERIALIZED_VIEW.ID);
    public static final UniqueKey<JStaleMaterializedViewRecord> STALE_MATERIALIZED_VIEW_NAME_KEY = Internal.createUniqueKey(
        JStaleMaterializedView.STALE_MATERIALIZED_VIEW, "stale_materialized_view_name_key",
        JStaleMaterializedView.STALE_MATERIALIZED_VIEW.NAME);
    public static final UniqueKey<JStatisticsRecord> STATISTICS_PK = Internal.createUniqueKey(
        JStatistics.STATISTICS, "statistics_pk", JStatistics.STATISTICS.S_ID);
    public static final UniqueKey<JStatisticsRecord> UNIQUE_STATS_LAUNCH = Internal.createUniqueKey(
        JStatistics.STATISTICS, "unique_stats_launch", JStatistics.STATISTICS.STATISTICS_FIELD_ID,
    ...
    public static final UniqueKey<JStatisticsRecord> UNIQUE_STATS_ITEM = Internal.createUniqueKey(
        JStatistics.STATISTICS, "unique_stats_item", JStatistics.STATISTICS.STATISTICS_FIELD_ID,
    ...
    public static final UniqueKey<JStatisticsFieldRecord> STATISTICS_FIELD_PK = Internal.createUniqueKey(
        JStatisticsField.STATISTICS_FIELD, "statistics_field_pk",
    ...
    public static final UniqueKey<JStatisticsFieldRecord> STATISTICS_FIELD_NAME_KEY = Internal.createUniqueKey(
        JStatisticsField.STATISTICS_FIELD, "statistics_field_name_key",
        JStatisticsField.STATISTICS_FIELD.NAME);
    ...
    public static final UniqueKey<JTestItemRecord> TEST_ITEM_UUID_KEY = Internal.createUniqueKey(
        JTestItem.TEST_ITEM, "test_item_uuid_key", JTestItem.TEST_ITEM.UUID);
    public static final UniqueKey<JTestItemResultsRecord> TEST_ITEM_RESULTS_PK = Internal.createUniqueKey(
        JTestItemResults.TEST_ITEM_RESULTS, "test_item_results_pk",
        JTestItemResults.TEST_ITEM_RESULTS.RESULT_ID);
    public static final UniqueKey<JTicketRecord> TICKET_PK = Internal.createUniqueKey(
        JTicket.TICKET, "ticket_pk", JTicket.TICKET.ID);
    public static final UniqueKey<JUserCreationBidRecord> USER_CREATION_BID_PK = Internal.createUniqueKey(
        JUserCreationBid.USER_CREATION_BID, "user_creation_bid_pk",
    ...
    public static final UniqueKey<JUserPreferenceRecord> USER_PREFERENCE_PK = Internal.createUniqueKey(
        JUserPreference.USER_PREFERENCE, "user_preference_pk", JUserPreference.USER_PREFERENCE.ID);
    public static final UniqueKey<JUserPreferenceRecord> USER_PREFERENCE_UQ = Internal.createUniqueKey(
        JUserPreference.USER_PREFERENCE, "user_preference_uq",
        JUserPreference.USER_PREFERENCE.PROJECT_ID, JUserPreference.USER_PREFERENCE.USER_ID,
        JUserPreference.USER_PREFERENCE.FILTER_ID);
    public static final UniqueKey<JUsersRecord> USERS_PK = Internal.createUniqueKey(JUsers.USERS,
        "users_pk", JUsers.USERS.ID);
    ...
    public static final UniqueKey<JUsersRecord> USERS_EMAIL_KEY = Internal.createUniqueKey(
        JUsers.USERS, "users_email_key", JUsers.USERS.EMAIL);
    public static final UniqueKey<JWidgetRecord> WIDGET_PKEY = Internal.createUniqueKey(
        JWidget.WIDGET, "widget_pkey", JWidget.WIDGET.ID);
    public static final UniqueKey<JWidgetFilterRecord> WIDGET_FILTER_PK = Internal.createUniqueKey(
        JWidgetFilter.WIDGET_FILTER, "widget_filter_pk", JWidgetFilter.WIDGET_FILTER.WIDGET_ID,
        JWidgetFilter.WIDGET_FILTER.FILTER_ID);
  }

  private static class ForeignKeys0 {

    public static final ForeignKey<JAclEntryRecord, JAclObjectIdentityRecord> ACL_ENTRY__FOREIGN_FK_4 = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ACL_OBJECT_IDENTITY_PKEY, JAclEntry.ACL_ENTRY,
        "acl_entry__foreign_fk_4", JAclEntry.ACL_ENTRY.ACL_OBJECT_IDENTITY);
    public static final ForeignKey<JAclEntryRecord, JAclSidRecord> ACL_ENTRY__FOREIGN_FK_5 = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ACL_SID_PKEY, JAclEntry.ACL_ENTRY,
        "acl_entry__foreign_fk_5", JAclEntry.ACL_ENTRY.SID);
    public static final ForeignKey<JAclObjectIdentityRecord, JAclClassRecord> ACL_OBJECT_IDENTITY__FOREIGN_FK_2 = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ACL_CLASS_PKEY, JAclObjectIdentity.ACL_OBJECT_IDENTITY,
    ...
    public static final ForeignKey<JAclObjectIdentityRecord, JAclObjectIdentityRecord> ACL_OBJECT_IDENTITY__FOREIGN_FK_1 = Internal.createForeignKey(
        ...
        JAclObjectIdentity.ACL_OBJECT_IDENTITY, "acl_object_identity__foreign_fk_1",
    ...
    public static final ForeignKey<JAclObjectIdentityRecord, JAclSidRecord> ACL_OBJECT_IDENTITY__FOREIGN_FK_3 = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ACL_SID_PKEY, JAclObjectIdentity.ACL_OBJECT_IDENTITY,
        "acl_object_identity__foreign_fk_3", JAclObjectIdentity.ACL_OBJECT_IDENTITY.OWNER_SID);
    public static final ForeignKey<JAclSidRecord, JUsersRecord> ACL_SID__ACL_SID_SID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_LOGIN_KEY, JAclSid.ACL_SID,
        "acl_sid__acl_sid_sid_fkey", JAclSid.ACL_SID.SID);
    public static final ForeignKey<JActivityRecord, JUsersRecord> ACTIVITY__ACTIVITY_USER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_PK, JActivity.ACTIVITY,
        "activity__activity_user_id_fkey", JActivity.ACTIVITY.USER_ID);
    public static final ForeignKey<JActivityRecord, JProjectRecord> ACTIVITY__ACTIVITY_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JActivity.ACTIVITY,
        "activity__activity_project_id_fkey", JActivity.ACTIVITY.PROJECT_ID);
    public static final ForeignKey<JContentFieldRecord, JWidgetRecord> CONTENT_FIELD__CONTENT_FIELD_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.WIDGET_PKEY, JContentField.CONTENT_FIELD,
        "content_field__content_field_id_fkey", JContentField.CONTENT_FIELD.ID);
    public static final ForeignKey<JDashboardRecord, JShareableEntityRecord> DASHBOARD__DASHBOARD_ID_FK = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.SHAREABLE_PK, JDashboard.DASHBOARD,
        "dashboard__dashboard_id_fk", JDashboard.DASHBOARD.ID);
    public static final ForeignKey<JDashboardWidgetRecord, JDashboardRecord> DASHBOARD_WIDGET__DASHBOARD_WIDGET_DASHBOARD_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.DASHBOARD_PKEY, JDashboardWidget.DASHBOARD_WIDGET,
    ...
    public static final ForeignKey<JDashboardWidgetRecord, JWidgetRecord> DASHBOARD_WIDGET__DASHBOARD_WIDGET_WIDGET_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.WIDGET_PKEY, JDashboardWidget.DASHBOARD_WIDGET,
        "dashboard_widget__dashboard_widget_widget_id_fkey",
        JDashboardWidget.DASHBOARD_WIDGET.WIDGET_ID);
    public static final ForeignKey<JFilterRecord, JShareableEntityRecord> FILTER__FILTER_ID_FK = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.SHAREABLE_PK, JFilter.FILTER, "filter__filter_id_fk",
        JFilter.FILTER.ID);
    public static final ForeignKey<JFilterConditionRecord, JFilterRecord> FILTER_CONDITION__FILTER_CONDITION_FILTER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.FILTER_PKEY, JFilterCondition.FILTER_CONDITION,
    ...
    public static final ForeignKey<JFilterSortRecord, JFilterRecord> FILTER_SORT__FILTER_SORT_FILTER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.FILTER_PKEY, JFilterSort.FILTER_SORT,
        "filter_sort__filter_sort_filter_id_fkey", JFilterSort.FILTER_SORT.FILTER_ID);
    public static final ForeignKey<JIntegrationRecord, JProjectRecord> INTEGRATION__INTEGRATION_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JIntegration.INTEGRATION,
        "integration__integration_project_id_fkey", JIntegration.INTEGRATION.PROJECT_ID);
    ...
    public static final ForeignKey<JIssueRecord, JTestItemResultsRecord> ISSUE__ISSUE_ISSUE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_RESULTS_PK, JIssue.ISSUE,
        "issue__issue_issue_id_fkey", JIssue.ISSUE.ISSUE_ID);
    public static final ForeignKey<JIssueRecord, JIssueTypeRecord> ISSUE__ISSUE_ISSUE_TYPE_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ISSUE_TYPE_PK, JIssue.ISSUE,
        "issue__issue_issue_type_fkey", JIssue.ISSUE.ISSUE_TYPE);
    public static final ForeignKey<JIssueTicketRecord, JIssueRecord> ISSUE_TICKET__ISSUE_TICKET_ISSUE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ISSUE_PK, JIssueTicket.ISSUE_TICKET,
        "issue_ticket__issue_ticket_issue_id_fkey", JIssueTicket.ISSUE_TICKET.ISSUE_ID);
    public static final ForeignKey<JIssueTicketRecord, JTicketRecord> ISSUE_TICKET__ISSUE_TICKET_TICKET_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TICKET_PK, JIssueTicket.ISSUE_TICKET,
        "issue_ticket__issue_ticket_ticket_id_fkey", JIssueTicket.ISSUE_TICKET.TICKET_ID);
    ...
    public static final ForeignKey<JIssueTypeProjectRecord, JProjectRecord> ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JIssueTypeProject.ISSUE_TYPE_PROJECT,
    ...
    public static final ForeignKey<JIssueTypeProjectRecord, JIssueTypeRecord> ISSUE_TYPE_PROJECT__ISSUE_TYPE_PROJECT_ISSUE_TYPE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ISSUE_TYPE_PK, JIssueTypeProject.ISSUE_TYPE_PROJECT,
    ...
    public static final ForeignKey<JItemAttributeRecord, JTestItemRecord> ITEM_ATTRIBUTE__ITEM_ATTRIBUTE_ITEM_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JItemAttribute.ITEM_ATTRIBUTE,
        "item_attribute__item_attribute_item_id_fkey", JItemAttribute.ITEM_ATTRIBUTE.ITEM_ID);
    public static final ForeignKey<JItemAttributeRecord, JLaunchRecord> ITEM_ATTRIBUTE__ITEM_ATTRIBUTE_LAUNCH_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JItemAttribute.ITEM_ATTRIBUTE,
        "item_attribute__item_attribute_launch_id_fkey", JItemAttribute.ITEM_ATTRIBUTE.LAUNCH_ID);
    public static final ForeignKey<JLaunchRecord, JProjectRecord> LAUNCH__LAUNCH_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JLaunch.LAUNCH,
        "launch__launch_project_id_fkey", JLaunch.LAUNCH.PROJECT_ID);
    public static final ForeignKey<JLaunchRecord, JUsersRecord> LAUNCH__LAUNCH_USER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_PK, JLaunch.LAUNCH, "launch__launch_user_id_fkey",
    ...
    public static final ForeignKey<JLaunchAttributeRulesRecord, JSenderCaseRecord> LAUNCH_ATTRIBUTE_RULES__LAUNCH_ATTRIBUTE_RULES_SENDER_CASE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.SENDER_CASE_PK,
        JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES,
        "launch_attribute_rules__launch_attribute_rules_sender_case_id_fkey",
    ...
    public static final ForeignKey<JLaunchNamesRecord, JSenderCaseRecord> LAUNCH_NAMES__LAUNCH_NAMES_SENDER_CASE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.SENDER_CASE_PK, JLaunchNames.LAUNCH_NAMES,
        "launch_names__launch_names_sender_case_id_fkey", JLaunchNames.LAUNCH_NAMES.SENDER_CASE_ID);
    public static final ForeignKey<JLaunchNumberRecord, JProjectRecord> LAUNCH_NUMBER__LAUNCH_NUMBER_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JLaunchNumber.LAUNCH_NUMBER,
        "launch_number__launch_number_project_id_fkey", JLaunchNumber.LAUNCH_NUMBER.PROJECT_ID);
    public static final ForeignKey<JLogRecord, JTestItemRecord> LOG__LOG_ITEM_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JLog.LOG, "log__log_item_id_fkey",
        JLog.LOG.ITEM_ID);
    public static final ForeignKey<JLogRecord, JLaunchRecord> LOG__LOG_LAUNCH_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JLog.LOG, "log__log_launch_id_fkey",
        JLog.LOG.LAUNCH_ID);
    public static final ForeignKey<JLogRecord, JAttachmentRecord> LOG__LOG_ATTACHMENT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ATTACHMENT_PK, JLog.LOG, "log__log_attachment_id_fkey",
        JLog.LOG.ATTACHMENT_ID);
    public static final ForeignKey<JOauthAccessTokenRecord, JUsersRecord> OAUTH_ACCESS_TOKEN__OAUTH_ACCESS_TOKEN_USER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_PK, JOauthAccessToken.OAUTH_ACCESS_TOKEN,
    ...
    public static final ForeignKey<JOauthRegistrationRestrictionRecord, JOauthRegistrationRecord> OAUTH_REGISTRATION_RESTRICTION__OAUTH_REGISTRATION_RESTRICTION_OAUTH_REGISTRATION_FK_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.OAUTH_REGISTRATION_PKEY,
        JOauthRegistrationRestriction.OAUTH_REGISTRATION_RESTRICTION,
    ...
    public static final ForeignKey<JParameterRecord, JTestItemRecord> PARAMETER__PARAMETER_ITEM_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JParameter.PARAMETER,
        "parameter__parameter_item_id_fkey", JParameter.PARAMETER.ITEM_ID);
    public static final ForeignKey<JPatternTemplateRecord, JProjectRecord> PATTERN_TEMPLATE__PATTERN_TEMPLATE_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JPatternTemplate.PATTERN_TEMPLATE,
        "pattern_template__pattern_template_project_id_fkey",
    ...
    public static final ForeignKey<JPatternTemplateTestItemRecord, JPatternTemplateRecord> PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_PATTERN_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PATTERN_TEMPLATE_PK,
        JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM,
        "pattern_template_test_item__pattern_template_test_item_pattern_id_fkey",
        JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM.PATTERN_ID);
    public static final ForeignKey<JPatternTemplateTestItemRecord, JTestItemRecord> PATTERN_TEMPLATE_TEST_ITEM__PATTERN_TEMPLATE_TEST_ITEM_ITEM_ID_FKEY = Internal.createForeignKey(
        ...
        JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM,
        "pattern_template_test_item__pattern_template_test_item_item_id_fkey",
        JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM.ITEM_ID);
    public static final ForeignKey<JProjectAttributeRecord, JAttributeRecord> PROJECT_ATTRIBUTE__PROJECT_ATTRIBUTE_ATTRIBUTE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.ATTRIBUTE_PK, JProjectAttribute.PROJECT_ATTRIBUTE,
    ...
    public static final ForeignKey<JProjectAttributeRecord, JProjectRecord> PROJECT_ATTRIBUTE__PROJECT_ATTRIBUTE_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JProjectAttribute.PROJECT_ATTRIBUTE,
    ...
    public static final ForeignKey<JProjectUserRecord, JUsersRecord> PROJECT_USER__PROJECT_USER_USER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_PK, JProjectUser.PROJECT_USER,
        "project_user__project_user_user_id_fkey", JProjectUser.PROJECT_USER.USER_ID);
    public static final ForeignKey<JProjectUserRecord, JProjectRecord> PROJECT_USER__PROJECT_USER_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JProjectUser.PROJECT_USER,
    ...
    public static final ForeignKey<JRecipientsRecord, JSenderCaseRecord> RECIPIENTS__RECIPIENTS_SENDER_CASE_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.SENDER_CASE_PK, JRecipients.RECIPIENTS,
        "recipients__recipients_sender_case_id_fkey", JRecipients.RECIPIENTS.SENDER_CASE_ID);
    public static final ForeignKey<JSenderCaseRecord, JProjectRecord> SENDER_CASE__SENDER_CASE_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JSenderCase.SENDER_CASE,
        "sender_case__sender_case_project_id_fkey", JSenderCase.SENDER_CASE.PROJECT_ID);
    public static final ForeignKey<JShareableEntityRecord, JUsersRecord> SHAREABLE_ENTITY__SHAREABLE_ENTITY_OWNER_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_LOGIN_KEY, JShareableEntity.SHAREABLE_ENTITY,
        "shareable_entity__shareable_entity_owner_fkey", JShareableEntity.SHAREABLE_ENTITY.OWNER);
    public static final ForeignKey<JShareableEntityRecord, JProjectRecord> SHAREABLE_ENTITY__SHAREABLE_ENTITY_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JShareableEntity.SHAREABLE_ENTITY,
        "shareable_entity__shareable_entity_project_id_fkey",
        JShareableEntity.SHAREABLE_ENTITY.PROJECT_ID);
    public static final ForeignKey<JStatisticsRecord, JLaunchRecord> STATISTICS__STATISTICS_LAUNCH_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JStatistics.STATISTICS,
        "statistics__statistics_launch_id_fkey", JStatistics.STATISTICS.LAUNCH_ID);
    public static final ForeignKey<JStatisticsRecord, JTestItemRecord> STATISTICS__STATISTICS_ITEM_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JStatistics.STATISTICS,
        "statistics__statistics_item_id_fkey", JStatistics.STATISTICS.ITEM_ID);
    public static final ForeignKey<JStatisticsRecord, JStatisticsFieldRecord> STATISTICS__STATISTICS_STATISTICS_FIELD_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.STATISTICS_FIELD_PK, JStatistics.STATISTICS,
    ...
    public static final ForeignKey<JTestItemRecord, JTestItemRecord> TEST_ITEM__TEST_ITEM_PARENT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JTestItem.TEST_ITEM,
        "test_item__test_item_parent_id_fkey", JTestItem.TEST_ITEM.PARENT_ID);
    public static final ForeignKey<JTestItemRecord, JTestItemRecord> TEST_ITEM__TEST_ITEM_RETRY_OF_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JTestItem.TEST_ITEM,
        "test_item__test_item_retry_of_fkey", JTestItem.TEST_ITEM.RETRY_OF);
    public static final ForeignKey<JTestItemRecord, JLaunchRecord> TEST_ITEM__TEST_ITEM_LAUNCH_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JTestItem.TEST_ITEM,
        "test_item__test_item_launch_id_fkey", JTestItem.TEST_ITEM.LAUNCH_ID);
    public static final ForeignKey<JTestItemResultsRecord, JTestItemRecord> TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_RESULT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_PK, JTestItemResults.TEST_ITEM_RESULTS,
        "test_item_results__test_item_results_result_id_fkey",
        JTestItemResults.TEST_ITEM_RESULTS.RESULT_ID);
    public static final ForeignKey<JUserCreationBidRecord, JProjectRecord> USER_CREATION_BID__USER_CREATION_BID_DEFAULT_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JUserCreationBid.USER_CREATION_BID,
    ...
    public static final ForeignKey<JUserPreferenceRecord, JProjectRecord> USER_PREFERENCE__USER_PREFERENCE_PROJECT_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JUserPreference.USER_PREFERENCE,
    ...
    public static final ForeignKey<JUserPreferenceRecord, JUsersRecord> USER_PREFERENCE__USER_PREFERENCE_USER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.USERS_PK, JUserPreference.USER_PREFERENCE,
        "user_preference__user_preference_user_id_fkey", JUserPreference.USER_PREFERENCE.USER_ID);
    public static final ForeignKey<JUserPreferenceRecord, JFilterRecord> USER_PREFERENCE__USER_PREFERENCE_FILTER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.FILTER_PKEY, JUserPreference.USER_PREFERENCE,
        "user_preference__user_preference_filter_id_fkey",
        JUserPreference.USER_PREFERENCE.FILTER_ID);
    public static final ForeignKey<JWidgetRecord, JShareableEntityRecord> WIDGET__WIDGET_ID_FK = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.SHAREABLE_PK, JWidget.WIDGET, "widget__widget_id_fk",
        JWidget.WIDGET.ID);
    public static final ForeignKey<JWidgetFilterRecord, JWidgetRecord> WIDGET_FILTER__WIDGET_FILTER_WIDGET_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.WIDGET_PKEY, JWidgetFilter.WIDGET_FILTER,
    ...
    public static final ForeignKey<JWidgetFilterRecord, JFilterRecord> WIDGET_FILTER__WIDGET_FILTER_FILTER_ID_FKEY = Internal.createForeignKey(
        com.epam.ta.reportportal.jooq.Keys.FILTER_PKEY, JWidgetFilter.WIDGET_FILTER,
