...
import com.epam.ta.reportportal.jooq.tables.records.JTmsAttributeRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsDatasetDataRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsDatasetRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsEnvironmentDatasetRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsEnvironmentRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsManualScenarioAttributeRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsManualScenarioPreconditionsAttachmentRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsManualScenarioPreconditionsRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsManualScenarioRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsMilestoneRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsProductVersionRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsStepAttachmentRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsStepRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsStepsManualScenarioRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestCaseAttributeRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestCaseExecutionRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestCaseLaunchRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestCaseRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestCaseVersionRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestFolderRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestPlanAttributeRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestPlanRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTestPlanTestCaseRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTextManualScenarioAttachmentRecord;
import com.epam.ta.reportportal.jooq.tables.records.JTmsTextManualScenarioRecord;
...
public class Keys {
    ...
    public static final UniqueKey<JTmsAttributeRecord> TMS_ATTRIBUTE_KEY_KEY = Internal.createUniqueKey(JTmsAttribute.TMS_ATTRIBUTE, DSL.name("tms_attribute_key_key"), new TableField[] { JTmsAttribute.TMS_ATTRIBUTE.KEY }, true);
    ...
    public static final UniqueKey<JTmsTestCaseLaunchRecord> TMS_TEST_CASE_LAUNCH_PKEY = Internal.createUniqueKey(JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH, DSL.name("tms_test_case_launch_pkey"), new TableField[] { JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH.TEST_CASE_ID, JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH.LAUNCH_ID }, true);
    ...
    public static final UniqueKey<JTmsTestPlanRecord> TMS_TEST_PLAN_LAUNCH_ID_KEY = Internal.createUniqueKey(JTmsTestPlan.TMS_TEST_PLAN, DSL.name("tms_test_plan_launch_id_key"), new TableField[] { JTmsTestPlan.TMS_TEST_PLAN.LAUNCH_ID }, true);
    ...
    public static final ForeignKey<JOwnedEntityRecord, JUsersRecord> OWNED_ENTITY__OWNED_ENTITY_OWNER_FKEY = Internal.createForeignKey(JOwnedEntity.OWNED_ENTITY, DSL.name("owned_entity_owner_fkey"), new TableField[] { JOwnedEntity.OWNED_ENTITY.OWNER }, Keys.USERS_LOGIN_KEY, new TableField[] { JUsers.USERS.LOGIN }, true);
    ...
    public static final ForeignKey<JTmsTestCaseLaunchRecord, JLaunchRecord> TMS_TEST_CASE_LAUNCH__TMS_TEST_CASE_LAUNCH_FK_LAUNCH = Internal.createForeignKey(JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH, DSL.name("tms_test_case_launch_fk_launch"), new TableField[] { JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH.LAUNCH_ID }, Keys.LAUNCH_PK, new TableField[] { JLaunch.LAUNCH.ID }, true);
    public static final ForeignKey<JTmsTestCaseLaunchRecord, JTmsTestCaseRecord> TMS_TEST_CASE_LAUNCH__TMS_TEST_CASE_LAUNCH_FK_TEST_CASE = Internal.createForeignKey(JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH, DSL.name("tms_test_case_launch_fk_test_case"), new TableField[] { JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH.TEST_CASE_ID }, Keys.TMS_TEST_CASE_PK, new TableField[] { JTmsTestCase.TMS_TEST_CASE.ID }, true);
    ...
    public static final ForeignKey<JTmsTestPlanRecord, JLaunchRecord> TMS_TEST_PLAN__TMS_TEST_PLAN_FK_LAUNCH = Internal.createForeignKey(JTmsTestPlan.TMS_TEST_PLAN, DSL.name("tms_test_plan_fk_launch"), new TableField[] { JTmsTestPlan.TMS_TEST_PLAN.LAUNCH_ID }, Keys.LAUNCH_PK, new TableField[] { JLaunch.LAUNCH.ID }, true);
