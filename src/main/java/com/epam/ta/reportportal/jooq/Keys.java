...
public class Keys {
    ...
    public static final UniqueKey<JOrganizationRecord> UQ_ORGANIZATION_USER_ID = Internal.createUniqueKey(JOrganization.ORGANIZATION, DSL.name("uq_organization_user_id"), new TableField[] { JOrganization.ORGANIZATION.USER_ID }, true);
    ...
    public static final ForeignKey<JOrganizationRecord, JUsersRecord> ORGANIZATION__FK_ORGANIZATION_USER = Internal.createForeignKey(JOrganization.ORGANIZATION, DSL.name("fk_organization_user"), new TableField[] { JOrganization.ORGANIZATION.USER_ID }, Keys.USERS_PK, new TableField[] { JUsers.USERS.ID }, true);
