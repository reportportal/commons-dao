...
public class Keys {
	...
	private static class Identities0 {
		...
		public static Identity<JDemoDataPostfixRecord, Long> IDENTITY_DEMO_DATA_POSTFIX = Internal.createIdentity(
				JDemoDataPostfix.DEMO_DATA_POSTFIX,
				JDemoDataPostfix.DEMO_DATA_POSTFIX.ID
		);
		public static Identity<JEmailSenderCaseRecord, Long> IDENTITY_EMAIL_SENDER_CASE = Internal.createIdentity(
	...
	private static class UniqueKeys0 {
		...
		public static final UniqueKey<JDemoDataPostfixRecord> DEMO_DATA_POSTFIX_PK = Internal.createUniqueKey(
				JDemoDataPostfix.DEMO_DATA_POSTFIX,
				"demo_data_postfix_pk",
				JDemoDataPostfix.DEMO_DATA_POSTFIX.ID
		);
		public static final UniqueKey<JEmailSenderCaseRecord> EMAIL_SENDER_CASE_PK = Internal.createUniqueKey(
				JEmailSenderCase.EMAIL_SENDER_CASE,
		...
		public static final UniqueKey<JStatisticsRecord> PK_STATISTICS = Internal.createUniqueKey(
				JStatistics.STATISTICS,
				"pk_statistics",
				JStatistics.STATISTICS.S_ID
		);
		public static final UniqueKey<JStatisticsRecord> UNIQUE_STATUS_ITEM = Internal.createUniqueKey(
				JStatistics.STATISTICS,
				"unique_status_item",
				JStatistics.STATISTICS.S_FIELD,
				JStatistics.STATISTICS.ITEM_ID
		);
		public static final UniqueKey<JStatisticsRecord> UNIQUE_STATUS_LAUNCH = Internal.createUniqueKey(
				JStatistics.STATISTICS,
