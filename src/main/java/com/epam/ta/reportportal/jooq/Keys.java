...
public class Keys {
    ...
    public static final ForeignKey<JTmsAttachmentRecord, JTmsStepRecord> TMS_ATTACHMENT__TMS_ATTACHMENT_FK_STEP = Internal.createForeignKey(JTmsAttachment.TMS_ATTACHMENT, DSL.name("tms_attachment_fk_step"), new TableField[] { JTmsAttachment.TMS_ATTACHMENT.STEP_ID }, Keys.TMS_STEP_PK, new TableField[] { JTmsStep.TMS_STEP.ID }, true);
    public static final ForeignKey<JTmsAttachmentRecord, JTmsTextManualScenarioRecord> TMS_ATTACHMENT__TMS_ATTACHMENT_FK_TEXT_MANUAL_SCENARIO = Internal.createForeignKey(JTmsAttachment.TMS_ATTACHMENT, DSL.name("tms_attachment_fk_text_manual_scenario"), new TableField[] { JTmsAttachment.TMS_ATTACHMENT.TEXT_MANUAL_SCENARIO_ID }, Keys.TMS_TEXT_MANUAL_SCENARIO_PK, new TableField[] { JTmsTextManualScenario.TMS_TEXT_MANUAL_SCENARIO.MANUAL_SCENARIO_ID }, true);
