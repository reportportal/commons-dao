...
public class Keys {
    ...
    public static final UniqueKey<JOrganizationRecord> UQ_ORGANIZATION_OWNER_ID = Internal.createUniqueKey(JOrganization.ORGANIZATION, DSL.name("uq_organization_owner_id"), new TableField[] { JOrganization.ORGANIZATION.OWNER_ID }, true);
    ...
    public static final UniqueKey<JPluginMarketplaceRecord> PLUGIN_MARKETPLACE_PKEY = Internal.createUniqueKey(
        JPluginMarketplace.PLUGIN_MARKETPLACE, DSL.name("plugin_marketplace_pkey"), new TableField[] { JPluginMarketplace.PLUGIN_MARKETPLACE.NAME }, true);
    public static final UniqueKey<JPluginMarketplaceRecord> PLUGIN_MARKETPLACE_URI_KEY = Internal.createUniqueKey(
        JPluginMarketplace.PLUGIN_MARKETPLACE, DSL.name("plugin_marketplace_uri_key"), new TableField[] { JPluginMarketplace.PLUGIN_MARKETPLACE.URI }, true);
    ...
    public static final ForeignKey<JOrganizationRecord, JUsersRecord> ORGANIZATION__FK_ORGANIZATION_OWNER = Internal.createForeignKey(JOrganization.ORGANIZATION, DSL.name("fk_organization_owner"), new TableField[] { JOrganization.ORGANIZATION.OWNER_ID }, Keys.USERS_PK, new TableField[] { JUsers.USERS.ID }, true);
