...
import com.epam.ta.reportportal.jooq.tables.records.JIssueStatisticsRecord;
...
public class Keys {
    ...
    public static final Identity<JContentFieldRecord, Long> IDENTITY_CONTENT_FIELD = Identities0.IDENTITY_CONTENT_FIELD;
    ...
    public static final UniqueKey<JContentFieldRecord> CONTENT_FIELD_PK = UniqueKeys0.CONTENT_FIELD_PK;
    ...
    public static final UniqueKey<JProjectConfigurationRecord> PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_KEY = UniqueKeys0.PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_KEY;
    ...
    public static final ForeignKey<JContentFieldRecord, JWidgetRecord> CONTENT_FIELD__CONTENT_FIELD_WIDGET_ID_FKEY = ForeignKeys0.CONTENT_FIELD__CONTENT_FIELD_WIDGET_ID_FKEY;
    public static final ForeignKey<JContentFieldValueRecord, JContentFieldRecord> CONTENT_FIELD_VALUE__CONTENT_FIELD_VALUE_ID_FKEY = ForeignKeys0.CONTENT_FIELD_VALUE__CONTENT_FIELD_VALUE_ID_FKEY;
    ...
    public static final ForeignKey<JEmailSenderCaseRecord, JProjectEmailConfigurationRecord> EMAIL_SENDER_CASE__EMAIL_SENDER_CASE_PROJECT_EMAIL_CONFIG_ID_FKEY = ForeignKeys0.EMAIL_SENDER_CASE__EMAIL_SENDER_CASE_PROJECT_EMAIL_CONFIG_ID_FKEY;
    ...
    public static final ForeignKey<JProjectConfigurationRecord, JProjectAnalyzerConfigurationRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_PROJECT_ANALYZER_CONFIG_ID_FKEY = ForeignKeys0.PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_PROJECT_ANALYZER_CONFIG_ID_FKEY;
    public static final ForeignKey<JProjectConfigurationRecord, JProjectEmailConfigurationRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_FKEY = ForeignKeys0.PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_FKEY;
    ...
    public static final ForeignKey<JStatisticsRecord, JTestItemResultsRecord> STATISTICS__STATISTICS_ITEM_ID_FKEY = ForeignKeys0.STATISTICS__STATISTICS_ITEM_ID_FKEY;
    ...
    public static final ForeignKey<JWidgetRecord, JFilterRecord> WIDGET__WIDGET_FILTER_ID_FKEY = ForeignKeys0.WIDGET__WIDGET_FILTER_ID_FKEY;
    ...
    private static class Identities0 {
        ...
        public static Identity<JContentFieldRecord, Long> IDENTITY_CONTENT_FIELD = Internal.createIdentity(JContentField.CONTENT_FIELD, JContentField.CONTENT_FIELD.ID);
        ...
        public static Identity<JExecutionStatisticsRecord, Long> IDENTITY_EXECUTION_STATISTICS = Internal.createIdentity(JExecutionStatistics.EXECUTION_STATISTICS, JExecutionStatistics.EXECUTION_STATISTICS.ES_ID);
        ...
        public static Identity<JIssueStatisticsRecord, Long> IDENTITY_ISSUE_STATISTICS = Internal.createIdentity(JIssueStatistics.ISSUE_STATISTICS, JIssueStatistics.ISSUE_STATISTICS.IS_ID);
        ...
        public static Identity<JTestItemStructureRecord, Long> IDENTITY_TEST_ITEM_STRUCTURE = Internal.createIdentity(JTestItemStructure.TEST_ITEM_STRUCTURE, JTestItemStructure.TEST_ITEM_STRUCTURE.STRUCTURE_ID);
    ...
    private static class UniqueKeys0 {
        ...
        public static final UniqueKey<JContentFieldRecord> CONTENT_FIELD_PK = Internal.createUniqueKey(JContentField.CONTENT_FIELD, "content_field_pk", JContentField.CONTENT_FIELD.ID);
        ...
        public static final UniqueKey<JExecutionStatisticsRecord> PK_EXECUTION_STATISTICS = Internal.createUniqueKey(JExecutionStatistics.EXECUTION_STATISTICS, "pk_execution_statistics", JExecutionStatistics.EXECUTION_STATISTICS.ES_ID);
        public static final UniqueKey<JExecutionStatisticsRecord> UNIQUE_STATUS_ITEM = Internal.createUniqueKey(JExecutionStatistics.EXECUTION_STATISTICS, "unique_status_item", JExecutionStatistics.EXECUTION_STATISTICS.ES_STATUS, JExecutionStatistics.EXECUTION_STATISTICS.ITEM_ID);
        public static final UniqueKey<JExecutionStatisticsRecord> UNIQUE_STATUS_LAUNCH = Internal.createUniqueKey(JExecutionStatistics.EXECUTION_STATISTICS, "unique_status_launch", JExecutionStatistics.EXECUTION_STATISTICS.ES_STATUS, JExecutionStatistics.EXECUTION_STATISTICS.LAUNCH_ID);
        ...
        public static final UniqueKey<JIssueStatisticsRecord> PK_ISSUE_STATISTICS = Internal.createUniqueKey(JIssueStatistics.ISSUE_STATISTICS, "pk_issue_statistics", JIssueStatistics.ISSUE_STATISTICS.IS_ID);
        public static final UniqueKey<JIssueStatisticsRecord> UNIQUE_ISSUE_ITEM = Internal.createUniqueKey(JIssueStatistics.ISSUE_STATISTICS, "unique_issue_item", JIssueStatistics.ISSUE_STATISTICS.ISSUE_TYPE_ID, JIssueStatistics.ISSUE_STATISTICS.ITEM_ID);
        public static final UniqueKey<JIssueStatisticsRecord> UNIQUE_ISSUE_LAUNCH = Internal.createUniqueKey(JIssueStatistics.ISSUE_STATISTICS, "unique_issue_launch", JIssueStatistics.ISSUE_STATISTICS.ISSUE_TYPE_ID, JIssueStatistics.ISSUE_STATISTICS.LAUNCH_ID);
        ...
        public static final UniqueKey<JProjectConfigurationRecord> PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_KEY = Internal.createUniqueKey(JProjectConfiguration.PROJECT_CONFIGURATION, "project_configuration_project_email_config_id_key", JProjectConfiguration.PROJECT_CONFIGURATION.PROJECT_EMAIL_CONFIG_ID);
        ...
        public static final UniqueKey<JTestItemStructureRecord> TEST_ITEM_STRUCTURE_PK = Internal.createUniqueKey(JTestItemStructure.TEST_ITEM_STRUCTURE, "test_item_structure_pk", JTestItemStructure.TEST_ITEM_STRUCTURE.STRUCTURE_ID);
    ...
    private static class ForeignKeys0 {
        ...
        public static final ForeignKey<JContentFieldRecord, JWidgetRecord> CONTENT_FIELD__CONTENT_FIELD_WIDGET_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.WIDGET_ID, JContentField.CONTENT_FIELD, "content_field__content_field_widget_id_fkey", JContentField.CONTENT_FIELD.WIDGET_ID);
        public static final ForeignKey<JContentFieldValueRecord, JContentFieldRecord> CONTENT_FIELD_VALUE__CONTENT_FIELD_VALUE_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.CONTENT_FIELD_PK, JContentFieldValue.CONTENT_FIELD_VALUE, "content_field_value__content_field_value_id_fkey", JContentFieldValue.CONTENT_FIELD_VALUE.ID);
        ...
        public static final ForeignKey<JEmailSenderCaseRecord, JProjectEmailConfigurationRecord> EMAIL_SENDER_CASE__EMAIL_SENDER_CASE_PROJECT_EMAIL_CONFIG_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PROJECT_EMAIL_CONFIGURATION_PK, JEmailSenderCase.EMAIL_SENDER_CASE, "email_sender_case__email_sender_case_project_email_config_id_fkey", JEmailSenderCase.EMAIL_SENDER_CASE.PROJECT_EMAIL_CONFIG_ID);
        public static final ForeignKey<JExecutionStatisticsRecord, JTestItemResultsRecord> EXECUTION_STATISTICS__EXECUTION_STATISTICS_ITEM_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_RESULTS_PK, JExecutionStatistics.EXECUTION_STATISTICS, "execution_statistics__execution_statistics_item_id_fkey", JExecutionStatistics.EXECUTION_STATISTICS.ITEM_ID);
        public static final ForeignKey<JExecutionStatisticsRecord, JLaunchRecord> EXECUTION_STATISTICS__EXECUTION_STATISTICS_LAUNCH_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JExecutionStatistics.EXECUTION_STATISTICS, "execution_statistics__execution_statistics_launch_id_fkey", JExecutionStatistics.EXECUTION_STATISTICS.LAUNCH_ID);
        ...
        public static final ForeignKey<JIssueStatisticsRecord, JIssueTypeRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_ISSUE_TYPE_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.ISSUE_TYPE_PK, JIssueStatistics.ISSUE_STATISTICS, "issue_statistics__issue_statistics_issue_type_id_fkey", JIssueStatistics.ISSUE_STATISTICS.ISSUE_TYPE_ID);
        public static final ForeignKey<JIssueStatisticsRecord, JTestItemResultsRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_ITEM_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_RESULTS_PK, JIssueStatistics.ISSUE_STATISTICS, "issue_statistics__issue_statistics_item_id_fkey", JIssueStatistics.ISSUE_STATISTICS.ITEM_ID);
        public static final ForeignKey<JIssueStatisticsRecord, JLaunchRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_LAUNCH_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JIssueStatistics.ISSUE_STATISTICS, "issue_statistics__issue_statistics_launch_id_fkey", JIssueStatistics.ISSUE_STATISTICS.LAUNCH_ID);
        ...
        public static final ForeignKey<JProjectConfigurationRecord, JProjectAnalyzerConfigurationRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_PROJECT_ANALYZER_CONFIG_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PROJECT_ANALYZER_CONFIGURATION_PK, JProjectConfiguration.PROJECT_CONFIGURATION, "project_configuration__project_configuration_project_analyzer_config_id_fkey", JProjectConfiguration.PROJECT_CONFIGURATION.PROJECT_ANALYZER_CONFIG_ID);
        public static final ForeignKey<JProjectConfigurationRecord, JProjectEmailConfigurationRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PROJECT_EMAIL_CONFIGURATION_PK, JProjectConfiguration.PROJECT_CONFIGURATION, "project_configuration__project_configuration_project_email_config_id_fkey", JProjectConfiguration.PROJECT_CONFIGURATION.PROJECT_EMAIL_CONFIG_ID);
        ...
        public static final ForeignKey<JStatisticsRecord, JTestItemResultsRecord> STATISTICS__STATISTICS_ITEM_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_RESULTS_PK, JStatistics.STATISTICS, "statistics__statistics_item_id_fkey", JStatistics.STATISTICS.ITEM_ID);
        ...
        public static final ForeignKey<JTestItemRecord, JTestItemStructureRecord> TEST_ITEM__TEST_ITEM_ITEM_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_STRUCTURE_PK, JTestItem.TEST_ITEM, "test_item__test_item_item_id_fkey", JTestItem.TEST_ITEM.ITEM_ID);
        public static final ForeignKey<JTestItemResultsRecord, JTestItemStructureRecord> TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_RESULT_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_STRUCTURE_PK, JTestItemResults.TEST_ITEM_RESULTS, "test_item_results__test_item_results_result_id_fkey", JTestItemResults.TEST_ITEM_RESULTS.RESULT_ID);
        public static final ForeignKey<JTestItemStructureRecord, JTestItemStructureRecord> TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_PARENT_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_STRUCTURE_PK, JTestItemStructure.TEST_ITEM_STRUCTURE, "test_item_structure__test_item_structure_parent_id_fkey", JTestItemStructure.TEST_ITEM_STRUCTURE.PARENT_ID);
        ...
        public static final ForeignKey<JTestItemStructureRecord, JLaunchRecord> TEST_ITEM_STRUCTURE__TEST_ITEM_STRUCTURE_LAUNCH_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JTestItemStructure.TEST_ITEM_STRUCTURE, "test_item_structure__test_item_structure_launch_id_fkey", JTestItemStructure.TEST_ITEM_STRUCTURE.LAUNCH_ID);
        ...
        public static final ForeignKey<JWidgetRecord, JFilterRecord> WIDGET__WIDGET_FILTER_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.FILTER_PK, JWidget.WIDGET, "widget__widget_filter_id_fkey", JWidget.WIDGET.FILTER_ID);
