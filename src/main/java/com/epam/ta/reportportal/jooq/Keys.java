...
public class Keys {
	...
	public static final ForeignKey<JLaunchAttributesRecord, JSenderCaseRecord> LAUNCH_ATTRIBUTES__LAUNCH_ATTRIBUTES_SENDER_CASE_ID_FKEY = ForeignKeys0.LAUNCH_ATTRIBUTES__LAUNCH_ATTRIBUTES_SENDER_CASE_ID_FKEY;
    ...
    private static class ForeignKeys0 {
		...
		public static final ForeignKey<JLaunchAttributesRecord, JSenderCaseRecord> LAUNCH_ATTRIBUTES__LAUNCH_ATTRIBUTES_SENDER_CASE_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.SENDER_CASE_PK,
						JLaunchAttributes.LAUNCH_ATTRIBUTES,
						"launch_attributes__launch_attributes_sender_case_id_fkey",
						JLaunchAttributes.LAUNCH_ATTRIBUTES.SENDER_CASE_ID
				);
