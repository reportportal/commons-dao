...
public class Keys {
    ...
    public static final UniqueKey<JTmsTestPlanLaunchRecord> TMS_TEST_PLAN_LAUNCH_PKEY = Internal.createUniqueKey(JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH, DSL.name("tms_test_plan_launch_pkey"), new TableField[] { JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH.TEST_PLAN_ID, JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH.LAUNCH_ID }, true);
    ...
    public static final ForeignKey<JTmsTestPlanLaunchRecord, JLaunchRecord> TMS_TEST_PLAN_LAUNCH__TMS_TEST_PLAN_LAUNCH_FK_LAUNCH = Internal.createForeignKey(JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH, DSL.name("tms_test_plan_launch_fk_launch"), new TableField[] { JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH.LAUNCH_ID }, Keys.LAUNCH_PK, new TableField[] { JLaunch.LAUNCH.ID }, true);
    public static final ForeignKey<JTmsTestPlanLaunchRecord, JTmsTestPlanRecord> TMS_TEST_PLAN_LAUNCH__TMS_TEST_PLAN_LAUNCH_FK_TEST_PLAN = Internal.createForeignKey(JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH, DSL.name("tms_test_plan_launch_fk_test_plan"), new TableField[] { JTmsTestPlanLaunch.TMS_TEST_PLAN_LAUNCH.TEST_PLAN_ID }, Keys.TMS_TEST_PLAN_PK, new TableField[] { JTmsTestPlan.TMS_TEST_PLAN.ID }, true);
