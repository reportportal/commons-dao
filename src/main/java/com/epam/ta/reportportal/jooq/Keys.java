...
public class Keys {
    ...
    private static class ForeignKeys0 {
		...
		public static final ForeignKey<JContentFieldRecord, JWidgetRecord> CONTENT_FIELD__CONTENT_FIELD_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.WIDGET_ID, JContentField.CONTENT_FIELD, "content_field__content_field_id_fkey",
		...
		public static final ForeignKey<JDashboardRecord, JProjectRecord> DASHBOARD__DASHBOARD_PROJECT_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JDashboard.DASHBOARD, "dashboard__dashboard_project_id_fkey",
		...
		public static final ForeignKey<JDefectFormFieldRecord, JBugTrackingSystemRecord> DEFECT_FORM_FIELD__DEFECT_FORM_FIELD_BUG_TRACKING_SYSTEM_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.BUG_TRACKING_SYSTEM_PK, JDefectFormField.DEFECT_FORM_FIELD,
		...
		public static final ForeignKey<JDefectFormFieldValueRecord, JDefectFormFieldRecord> DEFECT_FORM_FIELD_VALUE__DEFECT_FORM_FIELD_VALUE_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.DEFECT_FORM_FIELD_PK, JDefectFormFieldValue.DEFECT_FORM_FIELD_VALUE,
						"defect_form_field_value__defect_form_field_value_id_fkey", JDefectFormFieldValue.DEFECT_FORM_FIELD_VALUE.ID
				);
		public static final ForeignKey<JExecutionStatisticsRecord, JTestItemResultsRecord> EXECUTION_STATISTICS__EXECUTION_STATISTICS_ITEM_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_RESULTS_PK, JExecutionStatistics.EXECUTION_STATISTICS,
		...
		public static final ForeignKey<JExecutionStatisticsRecord, JLaunchRecord> EXECUTION_STATISTICS__EXECUTION_STATISTICS_LAUNCH_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JExecutionStatistics.EXECUTION_STATISTICS,
		...
		public static final ForeignKey<JFilterSortRecord, JUserFilterRecord> FILTER_SORT__FILTER_SORT_FILTER_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.USER_FILTER_PK, JFilterSort.FILTER_SORT, "filter_sort__filter_sort_filter_id_fkey",
		...
		public static final ForeignKey<JIntegrationRecord, JProjectRecord> INTEGRATION__INTEGRATION_PROJECT_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JIntegration.INTEGRATION, "integration__integration_project_id_fkey",
		...
		public static final ForeignKey<JIssueRecord, JIssueTypeRecord> ISSUE__ISSUE_ISSUE_TYPE_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.ISSUE_TYPE_PK, JIssue.ISSUE, "issue__issue_issue_type_fkey", JIssue.ISSUE.ISSUE_TYPE);
		...
		public static final ForeignKey<JIssueStatisticsRecord, JTestItemResultsRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_ITEM_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_RESULTS_PK, JIssueStatistics.ISSUE_STATISTICS,
		...
		public static final ForeignKey<JIssueStatisticsRecord, JLaunchRecord> ISSUE_STATISTICS__ISSUE_STATISTICS_LAUNCH_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.LAUNCH_PK, JIssueStatistics.ISSUE_STATISTICS,
		...
		public static final ForeignKey<JIssueTicketRecord, JIssueRecord> ISSUE_TICKET__ISSUE_TICKET_ISSUE_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.ISSUE_PK, JIssueTicket.ISSUE_TICKET, "issue_ticket__issue_ticket_issue_id_fkey",
		...
		public static final ForeignKey<JIssueTicketRecord, JTicketRecord> ISSUE_TICKET__ISSUE_TICKET_TICKET_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.TICKET_PK, JIssueTicket.ISSUE_TICKET, "issue_ticket__issue_ticket_ticket_id_fkey",
		...
		public static final ForeignKey<JLaunchRecord, JProjectRecord> LAUNCH__LAUNCH_PROJECT_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JLaunch.LAUNCH, "launch__launch_project_id_fkey", JLaunch.LAUNCH.PROJECT_ID);
		public static final ForeignKey<JLaunchRecord, JUsersRecord> LAUNCH__LAUNCH_USER_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.USERS_PK, JLaunch.LAUNCH, "launch__launch_user_id_fkey", JLaunch.LAUNCH.USER_ID);
        ...
        public static final ForeignKey<JProjectConfigurationRecord, JProjectEmailConfigurationRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_EMAIL_CONFIGURATION_ID_FKEY = Internal.createForeignKey(com.epam.ta.reportportal.jooq.Keys.PROJECT_EMAIL_CONFIGURATION_PK, JProjectConfiguration.PROJECT_CONFIGURATION, "project_configuration__project_configuration_email_configuration_id_fkey", JProjectConfiguration.PROJECT_CONFIGURATION.EMAIL_CONFIGURATION_ID);
		...
		public static final ForeignKey<JTestItemRecord, JTestItemStructureRecord> TEST_ITEM__TEST_ITEM_ITEM_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_STRUCTURE_PK, JTestItem.TEST_ITEM, "test_item__test_item_item_id_fkey",
		...
		public static final ForeignKey<JTestItemResultsRecord, JTestItemStructureRecord> TEST_ITEM_RESULTS__TEST_ITEM_RESULTS_RESULT_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.jooq.Keys.TEST_ITEM_STRUCTURE_PK, JTestItemResults.TEST_ITEM_RESULTS,
		...
		public static final ForeignKey<JUsersRecord, JProjectRecord> USERS__USERS_DEFAULT_PROJECT_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.jooq.Keys.PROJECT_PK, JUsers.USERS, "users__users_default_project_id_fkey",
