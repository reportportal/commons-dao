...
public class Keys {
    ...
    public static final UniqueKey<JPlaginMarketplaceRecord> PLAGIN_MARKETPLACE_PKEY = Internal.createUniqueKey(JPlaginMarketplace.PLAGIN_MARKETPLACE, DSL.name("plagin_marketplace_pkey"), new TableField[] { JPlaginMarketplace.PLAGIN_MARKETPLACE.NAME }, true);
    public static final UniqueKey<JPlaginMarketplaceRecord> PLAGIN_MARKETPLACE_URI_KEY = Internal.createUniqueKey(JPlaginMarketplace.PLAGIN_MARKETPLACE, DSL.name("plagin_marketplace_uri_key"), new TableField[] { JPlaginMarketplace.PLAGIN_MARKETPLACE.URI }, true);
