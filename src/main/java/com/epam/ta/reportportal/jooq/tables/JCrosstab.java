...
<<<<<<<HEAD
	...
	public JCrosstab call(String __1) {
		return new JCrosstab(DSL.name(getName()), null, new Field[] { DSL.val(__1, org.jooq.impl.SQLDataType.CLOB) == == == =
		public JCrosstab call (String __1, String __2){
			return new JCrosstab(
					DSL.name(getName()),
					null,
					new Field[] { DSL.val(__1, org.jooq.impl.SQLDataType.CLOB), DSL.val(__2, org.jooq.impl.SQLDataType.CLOB) >>> >>> > 9
					c6515a7c2cfa88bd1503e11364810bbc3828e80
        });
		}
		 ...
		 * Call this table-valued function
		 */
<<<<<<<HEAD public JCrosstab call (Field < String > __1) {
=======
			public JCrosstab call (Field < String > __1, Field < String > __2){
>>>>>>>9 c6515a7c2cfa88bd1503e11364810bbc3828e80 return new JCrosstab(DSL.name(getName()), null, new Field[] { __1 });
			}
}
