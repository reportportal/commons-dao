...
public class JActiveDirectoryConfig extends TableImpl<JActiveDirectoryConfigRecord> {
    ...
    private static final long serialVersionUID = -242388934;
     ...
     */
    public final TableField<JActiveDirectoryConfigRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.active_directory_config.url</code>.
     */
    public final TableField<JActiveDirectoryConfigRecord, String> URL = createField(DSL.name("url"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.active_directory_config.base_dn</code>.
     */
    public final TableField<JActiveDirectoryConfigRecord, String> BASE_DN = createField(DSL.name("base_dn"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.active_directory_config.sync_attributes_id</code>.
     */
    public final TableField<JActiveDirectoryConfigRecord, Long> SYNC_ATTRIBUTES_ID = createField(DSL.name("sync_attributes_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.active_directory_config.domain</code>.
     */
    public final TableField<JActiveDirectoryConfigRecord, String> DOMAIN = createField(DSL.name("domain"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
