...
public class JActiveDirectoryConfig extends TableImpl<JActiveDirectoryConfigRecord> {
	 ...
	 */
	public final TableField<JActiveDirectoryConfigRecord, Long> ID = createField(
			"id",
	 ...
	 */
	public final TableField<JActiveDirectoryConfigRecord, String> URL = createField(
			"url",
	 ...
	 */
	public final TableField<JActiveDirectoryConfigRecord, String> BASE_DN = createField(
			"base_dn",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	 ...
	 */
	public final TableField<JActiveDirectoryConfigRecord, Long> SYNC_ATTRIBUTES_ID = createField(
			"sync_attributes_id",
	 ...
	 */
	public final TableField<JActiveDirectoryConfigRecord, String> DOMAIN = createField(
			"domain",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	...
	public List<ForeignKey<JActiveDirectoryConfigRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JActiveDirectoryConfigRecord, ?>>asList(
				Keys.ACTIVE_DIRECTORY_CONFIG__ACTIVE_DIRECTORY_CONFIG_ID_FKEY,
