...
public class JLdapConfig extends TableImpl<JLdapConfigRecord> {
    ...
    private static final long serialVersionUID = 44075215;
     ...
     */
    public final TableField<JLdapConfigRecord, Long> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>public.ldap_config.url</code>.
     */
    public final TableField<JLdapConfigRecord, String> URL = createField(DSL.name("url"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.base_dn</code>.
     */
    public final TableField<JLdapConfigRecord, String> BASE_DN = createField(DSL.name("base_dn"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.sync_attributes_id</code>.
     */
    public final TableField<JLdapConfigRecord, Long> SYNC_ATTRIBUTES_ID = createField(DSL.name("sync_attributes_id"), org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>public.ldap_config.user_dn_pattern</code>.
     */
    public final TableField<JLdapConfigRecord, String> USER_DN_PATTERN = createField(DSL.name("user_dn_pattern"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.user_search_filter</code>.
     */
    public final TableField<JLdapConfigRecord, String> USER_SEARCH_FILTER = createField(DSL.name("user_search_filter"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.group_search_base</code>.
     */
    public final TableField<JLdapConfigRecord, String> GROUP_SEARCH_BASE = createField(DSL.name("group_search_base"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.group_search_filter</code>.
     */
    public final TableField<JLdapConfigRecord, String> GROUP_SEARCH_FILTER = createField(DSL.name("group_search_filter"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.password_attributes</code>.
     */
    public final TableField<JLdapConfigRecord, String> PASSWORD_ATTRIBUTES = createField(DSL.name("password_attributes"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.manager_dn</code>.
     */
    public final TableField<JLdapConfigRecord, String> MANAGER_DN = createField(DSL.name("manager_dn"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.manager_password</code>.
     */
    public final TableField<JLdapConfigRecord, String> MANAGER_PASSWORD = createField(DSL.name("manager_password"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");

    /**
     * The column <code>public.ldap_config.passwordencodertype</code>.
     */
    public final TableField<JLdapConfigRecord, JPasswordEncoderType> PASSWORDENCODERTYPE = createField(DSL.name("passwordencodertype"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JPasswordEncoderType.class), this, "");
