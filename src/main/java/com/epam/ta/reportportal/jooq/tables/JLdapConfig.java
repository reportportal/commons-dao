...
public class JLdapConfig extends TableImpl<JLdapConfigRecord> {
	...
	private static final long serialVersionUID = 1969821329;
	 ...
	 */
	public final TableField<JLdapConfigRecord, Long> SYNC_ATTRIBUTES_ID = createField("sync_attributes_id",
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> USER_DN_PATTERN = createField("user_dn_pattern",
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> USER_SEARCH_FILTER = createField("user_search_filter",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> GROUP_SEARCH_BASE = createField("group_search_base",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> GROUP_SEARCH_FILTER = createField("group_search_filter",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> PASSWORD_ATTRIBUTES = createField("password_attributes",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> MANAGER_DN = createField("manager_dn",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLdapConfigRecord, String> MANAGER_PASSWORD = createField("manager_password",
			org.jooq.impl.SQLDataType.VARCHAR(256),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLdapConfigRecord, JPasswordEncoderType> PASSWORDENCODERTYPE = createField("passwordencodertype",
			org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JPasswordEncoderType.class),
			this,
			""
	);
	...
	public List<ForeignKey<JLdapConfigRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JLdapConfigRecord, ?>>asList(Keys.LDAP_CONFIG__LDAP_CONFIG_ID_FKEY,
				Keys.LDAP_CONFIG__LDAP_CONFIG_SYNC_ATTRIBUTES_ID_FKEY
		);
	}
