...
public class JLdapConfig extends TableImpl<JLdapConfigRecord> {
    ...
    private static final long serialVersionUID = 1248546888;
     ...
     */
    public final TableField<JLdapConfigRecord, JPasswordEncoderType> PASSWORDENCODERTYPE = createField("passwordencodertype", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JPasswordEncoderType.class), this, "");
