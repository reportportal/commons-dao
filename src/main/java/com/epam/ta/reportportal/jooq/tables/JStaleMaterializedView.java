...
public class JStaleMaterializedView extends TableImpl<JStaleMaterializedViewRecord> {
  ...
  public final TableField<JStaleMaterializedViewRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('stale_materialized_view_id_seq'::regclass)",
   ...
   */
  public final TableField<JStaleMaterializedViewRecord, Timestamp> CREATION_DATE = createField(
  ...
  public <O extends Record> JStaleMaterializedView(Table<O> child,
      ForeignKey<O, JStaleMaterializedViewRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.STALE_MATERIALIZED_VIEW_NAME_KEY,
        Indexes.STALE_MATERIALIZED_VIEW_PKEY, Indexes.STALE_MV_CREATION_DATE_IDX);
  }
  ...
  public List<UniqueKey<JStaleMaterializedViewRecord>> getKeys() {
    return Arrays.<UniqueKey<JStaleMaterializedViewRecord>>asList(Keys.STALE_MATERIALIZED_VIEW_PKEY,
        Keys.STALE_MATERIALIZED_VIEW_NAME_KEY);
  }
