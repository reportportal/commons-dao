...
public class JStaleMaterializedView extends TableImpl<JStaleMaterializedViewRecord> {
     ...
     */
    public final TableField<JStaleMaterializedViewRecord, LocalDateTime> CREATION_DATE = createField(DSL.name("creation_date"), SQLDataType.LOCALDATETIME(6).nullable(false), this, "");
