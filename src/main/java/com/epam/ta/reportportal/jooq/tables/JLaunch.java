...
public class JLaunch extends TableImpl<JLaunchRecord> {
     ...
     */
    public final TableField<JLaunchRecord, String> UUID = createField("uuid", org.jooq.impl.SQLDataType.VARCHAR(36).nullable(false), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.LAUNCH_PK, Indexes.LAUNCH_PROJECT_IDX, Indexes.LAUNCH_USER_IDX, Indexes.LAUNCH_UUID_IDX, Indexes.LAUNCH_UUID_KEY, Indexes.UNQ_NAME_NUMBER);
    }
