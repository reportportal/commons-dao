...
public class JLaunch extends TableImpl<JLaunchRecord> {
     ...
     */
    public final TableField<JLaunchRecord, JLaunchModeEnum> MODE = createField("mode", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JLaunchModeEnum.class), this, "");
