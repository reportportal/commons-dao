...
public class JLaunch extends TableImpl<JLaunchRecord> {
	 ...
	 */
	public final TableField<JLaunchRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JLaunchRecord, String> UUID = createField("uuid",
	 ...
	 */
	public final TableField<JLaunchRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLaunchRecord, String> NAME = createField("name",
	 ...
	 */
	public final TableField<JLaunchRecord, Timestamp> START_TIME = createField("start_time",
	 ...
	 */
	public final TableField<JLaunchRecord, Integer> NUMBER = createField("number",
	 ...
	 */
	public final TableField<JLaunchRecord, Timestamp> LAST_MODIFIED = createField("last_modified",
			org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false)
	 ...
	 */
	public final TableField<JLaunchRecord, JLaunchModeEnum> MODE = createField("mode",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.epam.ta.reportportal.jooq.enums.JLaunchModeEnum.class),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLaunchRecord, JStatusEnum> STATUS = createField("status",
			org.jooq.impl.SQLDataType.VARCHAR.nullable(false).asEnumDataType(com.epam.ta.reportportal.jooq.enums.JStatusEnum.class),
			this,
			""
	);
	 ...
	 */
	public final TableField<JLaunchRecord, Boolean> RERUN = createField("rerun",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)),
			this,
			""
	 ...
	 */
	public final TableField<JLaunchRecord, Double> APPROXIMATE_DURATION = createField("approximate_duration",
			org.jooq.impl.SQLDataType.DOUBLE.defaultValue(org.jooq.impl.DSL.field("0.0", org.jooq.impl.SQLDataType.DOUBLE)),
			this,
			""
	);
	...
	public List<Index> getIndexes() {
		return Arrays.<Index>asList(Indexes.LAUNCH_PK,
