...
public class JLaunch extends TableImpl<JLaunchRecord> {
	 ...
	 */
	public final TableField<JLaunchRecord, String> UUID = createField(
			"uuid",
	 ...
	 */
	public final TableField<JLaunchRecord, Boolean> HAS_RETRIES = createField(
			"has_retries",
	 ...
	 */
	public final TableField<JLaunchRecord, Boolean> RERUN = createField(
			"rerun",
			org.jooq.impl.SQLDataType.BOOLEAN.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)),
			this,
