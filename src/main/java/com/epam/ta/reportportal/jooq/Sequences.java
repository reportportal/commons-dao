...
public class Sequences {
     ...
     */
    public static final Sequence<Long> TEST_ITEM_ID_SEQ = new SequenceImpl<Long>("test_item_id_seq", Public.PUBLIC, org.jooq.impl.SQLDataType.BIGINT.nullable(false));

    /**
     * The sequence <code>public.test_item_results_id_seq</code>
     */
    public static final Sequence<Long> TEST_ITEM_RESULTS_ID_SEQ = new SequenceImpl<Long>("test_item_results_id_seq", Public.PUBLIC, org.jooq.impl.SQLDataType.BIGINT.nullable(false));

    /**
     * The sequence <code>public.test_item_structure_id_seq</code>
     */
    public static final Sequence<Long> TEST_ITEM_STRUCTURE_ID_SEQ = new SequenceImpl<Long>("test_item_structure_id_seq", Public.PUBLIC, org.jooq.impl.SQLDataType.BIGINT.nullable(false));
