...
public class JOauthRegistrationScope extends TableImpl<JOauthRegistrationScopeRecord> {
	...
	private static final long serialVersionUID = -1554753451;
	 ...
	 */
	public final TableField<JOauthRegistrationScopeRecord, Integer> ID = createField("id",
	 ...
	 */
	public final TableField<JOauthRegistrationScopeRecord, String> OAUTH_REGISTRATION_FK = createField("oauth_registration_fk",
	 ...
	 */
	public final TableField<JOauthRegistrationScopeRecord, String> SCOPE = createField("scope",
