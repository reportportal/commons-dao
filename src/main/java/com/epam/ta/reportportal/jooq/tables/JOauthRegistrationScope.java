...
public class JOauthRegistrationScope extends TableImpl<JOauthRegistrationScopeRecord> {
  ...
  public final TableField<JOauthRegistrationScopeRecord, Integer> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('oauth_registration_scope_id_seq'::regclass)",
  ...
  public final TableField<JOauthRegistrationScopeRecord, String> SCOPE = createField(
      DSL.name("scope"), org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
  ...
  public <O extends Record> JOauthRegistrationScope(Table<O> child,
      ForeignKey<O, JOauthRegistrationScopeRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.OAUTH_REGISTRATION_SCOPE_PK,
        Indexes.OAUTH_REGISTRATION_SCOPE_UNIQUE);
  }
  ...
  public List<UniqueKey<JOauthRegistrationScopeRecord>> getKeys() {
    return Arrays.<UniqueKey<JOauthRegistrationScopeRecord>>asList(Keys.OAUTH_REGISTRATION_SCOPE_PK,
        Keys.OAUTH_REGISTRATION_SCOPE_UNIQUE);
  }
