...
public class JStatisticsField extends TableImpl<JStatisticsFieldRecord> {
  ...
  public final TableField<JStatisticsFieldRecord, Long> SF_ID = createField(DSL.name("sf_id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('statistics_field_sf_id_seq'::regclass)",
  ...
  public <O extends Record> JStatisticsField(Table<O> child,
      ForeignKey<O, JStatisticsFieldRecord> key) {
  ...
  public List<UniqueKey<JStatisticsFieldRecord>> getKeys() {
    return Arrays.<UniqueKey<JStatisticsFieldRecord>>asList(Keys.STATISTICS_FIELD_PK,
        Keys.STATISTICS_FIELD_NAME_KEY);
  }
