...
public class JStatisticsField extends TableImpl<JStatisticsFieldRecord> {
	...
	private static final long serialVersionUID = 1321619345;
	 ...
	 */
	public final TableField<JStatisticsFieldRecord, Long> SF_ID = createField("sf_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('statistics_field_sf_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JStatisticsFieldRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(256), this, "");
	...
	public List<Index> getIndexes() {
		return Arrays.<Index>asList(Indexes.STATISTICS_FIELD_PK);
	}
	...
	public List<UniqueKey<JStatisticsFieldRecord>> getKeys() {
		return Arrays.<UniqueKey<JStatisticsFieldRecord>>asList(Keys.STATISTICS_FIELD_PK);
	}
