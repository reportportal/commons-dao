...
public class JStatisticsField extends TableImpl<JStatisticsFieldRecord> {
	 ...
	 */
	public final TableField<JStatisticsFieldRecord, Long> SF_ID = createField(
			"sf_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field(
							"nextval('statistics_field_sf_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JStatisticsFieldRecord, String> NAME = createField(
			"name",
