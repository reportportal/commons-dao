...
public class JIntegrationType extends TableImpl<JIntegrationTypeRecord> {
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, Integer> ID = createField("id",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('integration_type_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, String> NAME = createField("name",
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, JIntegrationAuthFlowEnum> AUTH_FLOW = createField("auth_flow",
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, Timestamp> CREATION_DATE = createField("creation_date",
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, JIntegrationGroupEnum> GROUP_TYPE = createField("group_type",
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, Boolean> ENABLED = createField("enabled",
	 ...
	 */
	public final TableField<JIntegrationTypeRecord, Object> DETAILS = createField("details",
