...
public class JIntegrationType extends TableImpl<JIntegrationTypeRecord> {
  ...
  public final TableField<JIntegrationTypeRecord, Integer> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('integration_type_id_seq'::regclass)",
  ...
  public final TableField<JIntegrationTypeRecord, JIntegrationAuthFlowEnum> AUTH_FLOW = createField(
      DSL.name("auth_flow"), org.jooq.impl.SQLDataType.VARCHAR.asEnumDataType(
          com.epam.ta.reportportal.jooq.enums.JIntegrationAuthFlowEnum.class), this, "");
  /**
  ...
  public final TableField<JIntegrationTypeRecord, JIntegrationGroupEnum> GROUP_TYPE = createField(
      DSL.name("group_type"), org.jooq.impl.SQLDataType.VARCHAR.nullable(false)
          .asEnumDataType(com.epam.ta.reportportal.jooq.enums.JIntegrationGroupEnum.class), this,
      "");
  /**
   ...
   */
  public final TableField<JIntegrationTypeRecord, JSONB> DETAILS = createField(DSL.name("details"),
  ...
  public <O extends Record> JIntegrationType(Table<O> child,
      ForeignKey<O, JIntegrationTypeRecord> key) {
  ...
  public List<UniqueKey<JIntegrationTypeRecord>> getKeys() {
    return Arrays.<UniqueKey<JIntegrationTypeRecord>>asList(Keys.INTEGRATION_TYPE_PK,
        Keys.INTEGRATION_TYPE_NAME_KEY);
  }
