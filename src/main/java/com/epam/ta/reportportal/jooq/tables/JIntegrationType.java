...
public class JIntegrationType extends TableImpl<JIntegrationTypeRecord> {
     ...
     */
    public final TableField<JIntegrationTypeRecord, JIntegrationAuthFlowEnum> AUTH_FLOW = createField("auth_flow", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JIntegrationAuthFlowEnum.class), this, "");
     ...
     */
    public final TableField<JIntegrationTypeRecord, JIntegrationGroupEnum> GROUP_TYPE = createField("group_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(com.epam.ta.reportportal.jooq.enums.JIntegrationGroupEnum.class), this, "");
