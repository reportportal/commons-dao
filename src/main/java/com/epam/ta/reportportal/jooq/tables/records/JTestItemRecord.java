...
public class JTestItemRecord extends UpdatableRecordImpl<JTestItemRecord> implements
    Record18<Long, String, String, String, JTestItemTypeEnum, Timestamp, String, Timestamp, Object, String, String, Boolean, Boolean, Boolean, Long, Long, Long, Integer> {
   ...
   */
  public JTestItemRecord(Long itemId, String uuid, String name, String codeRef,
      JTestItemTypeEnum type, Timestamp startTime, String description, Timestamp lastModified,
      Object path, String uniqueId, String testCaseId, Boolean hasChildren, Boolean hasRetries,
      Boolean hasStats, Long parentId, Long retryOf, Long launchId, Integer testCaseHash) {
    super(JTestItem.TEST_ITEM);
  ...
  @Override
  public JTestItemRecord values(Long value1, String value2, String value3, String value4,
      JTestItemTypeEnum value5, Timestamp value6, String value7, Timestamp value8, Object value9,
      String value10, String value11, Boolean value12, Boolean value13, Boolean value14,
      Long value15, Long value16, Long value17, Integer value18) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
