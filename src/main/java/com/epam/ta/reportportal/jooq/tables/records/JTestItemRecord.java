...
public class JTestItemRecord extends UpdatableRecordImpl<JTestItemRecord> implements Record7<Long, String, JTestItemTypeEnum, Timestamp, String, Timestamp, String> {

    private static final long serialVersionUID = -921636293;
     ...
     */
    @Override
    public JTestItemRecord values(Long value1, String value2, JTestItemTypeEnum value3, Timestamp value4, String value5, Timestamp value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JTestItemRecord(Long itemId, String name, JTestItemTypeEnum type, Timestamp startTime, String description, Timestamp lastModified, String uniqueId) {
        super(JTestItem.TEST_ITEM);
