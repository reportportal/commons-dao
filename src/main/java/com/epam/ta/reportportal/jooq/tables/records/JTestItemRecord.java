...
public class JTestItemRecord extends UpdatableRecordImpl<JTestItemRecord> implements Record12<Long, String, JTestItemTypeEnum, Timestamp, String, Timestamp, Object, String, Boolean, Long, Long, Long> {
	...
	public JTestItemRecord values(Long value1, String value2, JTestItemTypeEnum value3, Timestamp value4, String value5, Timestamp value6,
			Object value7, String value8, Boolean value9, Long value10, Long value11, Long value12) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	...
	public JTestItemRecord(Long itemId, String name, JTestItemTypeEnum type, Timestamp startTime, String description,
			Timestamp lastModified, Object path, String uniqueId, Boolean hasChildren, Long parentId, Long retryOf, Long launchId) {
		super(JTestItem.TEST_ITEM);
