...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record13<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Long> {

    private static final long serialVersionUID = 1711966947;
    ...
    /**
     * Setter for <code>public.launch.email_sender_case_id</code>.
     */
    ...
    /**
     * Getter for <code>public.launch.email_sender_case_id</code>.
     */
    ...
    public Field<Long> field13() {
        return JLaunch.LAUNCH.EMAIL_SENDER_CASE_ID;
    }
     ...
     */
    @Override
    public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, Timestamp value7, Timestamp value8, Integer value9, Timestamp value10, JLaunchModeEnum value11, JStatusEnum value12, Long value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLaunchRecord(Long id, String uuid, Long projectId, Long userId, String name, String description, Timestamp startTime, Timestamp endTime, Integer number, Timestamp lastModified, JLaunchModeEnum mode, JStatusEnum status, Long emailSenderCaseId) {
        super(JLaunch.LAUNCH);
