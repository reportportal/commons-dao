...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record16<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, JRetentionPolicyEnum> {

    private static final long serialVersionUID = -317780030;
    ...
    @Override
    public Row16<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, JRetentionPolicyEnum> valuesRow() {
    ...
    @Override
    public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, Timestamp value7, Timestamp value8, Integer value9, Timestamp value10, JLaunchModeEnum value11, JStatusEnum value12, Boolean value13, Boolean value14, Double value15, JRetentionPolicyEnum value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
