...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record16<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, Boolean> {

    private static final long serialVersionUID = -2020975018;
    ...
    /**
     * Setter for <code>public.launch.important</code>.
     */
    ...
    /**
     * Getter for <code>public.launch.important</code>.
     */
    ...
    @Override
    public Row16<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, Boolean> valuesRow() {
    ...
    public Field<Boolean> field16() {
        return JLaunch.LAUNCH.IMPORTANT;
    }
    ...
    @Override
    public JLaunchRecord value16(Boolean value) {
        setImportant(value);
        return this;
    }

    @Override
    public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, Timestamp value7, Timestamp value8, Integer value9, Timestamp value10, JLaunchModeEnum value11, JStatusEnum value12, Boolean value13, Boolean value14, Double value15, Boolean value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLaunchRecord(Long id, String uuid, Long projectId, Long userId, String name, String description, Timestamp startTime, Timestamp endTime, Integer number, Timestamp lastModified, JLaunchModeEnum mode, JStatusEnum status, Boolean hasRetries, Boolean rerun, Double approximateDuration, Boolean important) {
        super(JLaunch.LAUNCH);
