...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record16<Long, String, Long, Long, String, String, Instant, Instant, Integer, Instant, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, JRetentionPolicyEnum> {

    private static final long serialVersionUID = 1810115370;
    ...
    @Override
    public Row16<Long, String, Long, Long, String, String, Instant, Instant, Integer, Instant, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, JRetentionPolicyEnum> valuesRow() {
    ...
    @Override
    public JLaunchRecord value7(Instant value) {
        setStartTime(value);
        return this;
    }

    @Override
    public JLaunchRecord value8(Instant value) {
        setEndTime(value);
        return this;
    }
    ...
    @Override
    public JLaunchRecord value10(Instant value) {
    ...
    @Override
    public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, Instant value7, Instant value8, Integer value9, Instant value10, JLaunchModeEnum value11, JStatusEnum value12, Boolean value13, Boolean value14, Double value15, JRetentionPolicyEnum value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
