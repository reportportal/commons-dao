...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements
																	  Record15<Long, String, Long, String, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double> {

	private static final long serialVersionUID = -1389377139;
	...
	/**
	 * Setter for <code>public.launch.owner</code>.
	 */
	...
	/**
	 * Getter for <code>public.launch.owner</code>.
	 */
	 ...
	 */
	@Override
	public Row15<Long, String, Long, String, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double> fieldsRow() {
	 ...
	 */
	@Override
	public Row15<Long, String, Long, String, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double> valuesRow() {
	 ...
	 */
	@Override
	public JLaunchRecord values(Long value1, String value2, Long value3, String value4, String value5, String value6, Timestamp value7,
			Timestamp value8, Integer value9, Timestamp value10, JLaunchModeEnum value11, JStatusEnum value12, Boolean value13,
			Boolean value14, Double value15) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	 ...
	 */
	public JLaunchRecord(Long id, String uuid, Long projectId, String owner, String name, String description, Timestamp startTime,
