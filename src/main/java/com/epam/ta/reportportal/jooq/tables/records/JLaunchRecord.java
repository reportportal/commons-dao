...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements Record16<Long, String, Long, Long, String, String, LocalDateTime, LocalDateTime, Integer, LocalDateTime, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, JRetentionPolicyEnum> {
    ...
    @Override
    public Row16<Long, String, Long, Long, String, String, LocalDateTime, LocalDateTime, Integer, LocalDateTime, JLaunchModeEnum, JStatusEnum, Boolean, Boolean, Double, JRetentionPolicyEnum> valuesRow() {
    ...
    @Override
    public Field<JRetentionPolicyEnum> field16() {
        return JLaunch.LAUNCH.RETENTION_POLICY;
    }
    ...
    @Override
    public JRetentionPolicyEnum component16() {
    ...
    @Override
    public JRetentionPolicyEnum value16() {
        return getRetentionPolicy();
    }
    ...
    @Override
    public JLaunchRecord value7(LocalDateTime value) {
        setStartTime(value);
        return this;
    }

    @Override
    public JLaunchRecord value8(LocalDateTime value) {
        setEndTime(value);
        return this;
    }
    ...
    @Override
    public JLaunchRecord value10(LocalDateTime value) {
    ...
    @Override
    public JLaunchRecord value16(JRetentionPolicyEnum value) {
        setRetentionPolicy(value);
        return this;
    }

    @Override
    public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, LocalDateTime value7, LocalDateTime value8, Integer value9, LocalDateTime value10, JLaunchModeEnum value11, JStatusEnum value12, Boolean value13, Boolean value14, Double value15, JRetentionPolicyEnum value16) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JLaunchRecord(Long id, String uuid, Long projectId, Long userId, String name, String description, LocalDateTime startTime, LocalDateTime endTime, Integer number, LocalDateTime lastModified, JLaunchModeEnum mode, JStatusEnum status, Boolean hasRetries, Boolean rerun, Double approximateDuration, JRetentionPolicyEnum retentionPolicy) {
        super(JLaunch.LAUNCH);
