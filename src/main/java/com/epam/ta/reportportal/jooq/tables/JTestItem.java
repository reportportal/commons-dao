...
public class JTestItem extends TableImpl<JTestItemRecord> {
  ...
  public final TableField<JTestItemRecord, Long> ITEM_ID = createField(DSL.name("item_id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('test_item_item_id_seq'::regclass)",
   ...
   */
  public final TableField<JTestItemRecord, String> NAME = createField(DSL.name("name"),
      org.jooq.impl.SQLDataType.VARCHAR(1024), this, "");
  /**
   * The column <code>public.test_item.code_ref</code>.
   */
  public final TableField<JTestItemRecord, String> CODE_REF = createField(DSL.name("code_ref"),
  ...
  public final TableField<JTestItemRecord, JTestItemTypeEnum> TYPE = createField(DSL.name("type"),
      org.jooq.impl.SQLDataType.VARCHAR.nullable(false)
          .asEnumDataType(com.epam.ta.reportportal.jooq.enums.JTestItemTypeEnum.class), this, "");
  /**
   * The column <code>public.test_item.start_time</code>.
   */
  public final TableField<JTestItemRecord, Timestamp> START_TIME = createField(
      DSL.name("start_time"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
  /**
   * The column <code>public.test_item.description</code>.
   */
  public final TableField<JTestItemRecord, String> DESCRIPTION = createField(
      DSL.name("description"), org.jooq.impl.SQLDataType.CLOB, this, "");
  /**
  ...
  public final TableField<JTestItemRecord, Timestamp> LAST_MODIFIED = createField(
      DSL.name("last_modified"), org.jooq.impl.SQLDataType.TIMESTAMP.nullable(false), this, "");
  /**
   * The column <code>public.test_item.path</code>.
   */
  public final TableField<JTestItemRecord, Object> PATH = createField(DSL.name("path"),
      org.jooq.impl.DefaultDataType.getDefaultDataType("\"public\".\"ltree\""), this, "");
  /**
   ...
   */
  public final TableField<JTestItemRecord, String> TEST_CASE_ID = createField(
      DSL.name("test_case_id"), org.jooq.impl.SQLDataType.VARCHAR(1024), this, "");
  /**
  ...
  public final TableField<JTestItemRecord, Boolean> HAS_CHILDREN = createField(
      DSL.name("has_children"), org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(
          org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
  /**
   * The column <code>public.test_item.has_retries</code>.
   */
  public final TableField<JTestItemRecord, Boolean> HAS_RETRIES = createField(
      DSL.name("has_retries"), org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(
          org.jooq.impl.DSL.field("false", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
  /**
  ...
  public final TableField<JTestItemRecord, Boolean> HAS_STATS = createField(DSL.name("has_stats"),
      org.jooq.impl.SQLDataType.BOOLEAN.defaultValue(
          org.jooq.impl.DSL.field("true", org.jooq.impl.SQLDataType.BOOLEAN)), this, "");
  /**
   * The column <code>public.test_item.parent_id</code>.
   */
  public final TableField<JTestItemRecord, Long> PARENT_ID = createField(DSL.name("parent_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.test_item.retry_of</code>.
   */
  public final TableField<JTestItemRecord, Long> RETRY_OF = createField(DSL.name("retry_of"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.test_item.launch_id</code>.
   */
  public final TableField<JTestItemRecord, Long> LAUNCH_ID = createField(DSL.name("launch_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
   * The column <code>public.test_item.test_case_hash</code>.
   */
  public final TableField<JTestItemRecord, Integer> TEST_CASE_HASH = createField(
      DSL.name("test_case_hash"), org.jooq.impl.SQLDataType.INTEGER.nullable(false), this, "");
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.ITEM_TEST_CASE_ID_LAUNCH_ID_IDX, Indexes.PATH_GIST_IDX,
        Indexes.PATH_IDX, Indexes.TEST_CASE_HASH_LAUNCH_ID_IDX, Indexes.TEST_ITEM_PK,
        Indexes.TEST_ITEM_UNIQUE_ID_LAUNCH_ID_IDX, Indexes.TEST_ITEM_UUID_KEY,
        Indexes.TI_LAUNCH_IDX, Indexes.TI_PARENT_IDX, Indexes.TI_RETRY_OF_IDX);
  }
  ...
  public List<ForeignKey<JTestItemRecord, ?>> getReferences() {
    return Arrays.<ForeignKey<JTestItemRecord, ?>>asList(Keys.TEST_ITEM__TEST_ITEM_PARENT_ID_FKEY,
        Keys.TEST_ITEM__TEST_ITEM_RETRY_OF_FKEY, Keys.TEST_ITEM__TEST_ITEM_LAUNCH_ID_FKEY);
  }

  public com.epam.ta.reportportal.jooq.tables.JTestItem testItem_TestItemParentIdFkey() {
    return new com.epam.ta.reportportal.jooq.tables.JTestItem(this,
