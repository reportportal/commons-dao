...
public class JServerSettings extends TableImpl<JServerSettingsRecord> {
  ...
  public final TableField<JServerSettingsRecord, Short> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.SMALLINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('server_settings_id_seq'::regclass)",
   ...
   */
  public final TableField<JServerSettingsRecord, String> VALUE = createField(DSL.name("value"),
  ...
  public <O extends Record> JServerSettings(Table<O> child,
      ForeignKey<O, JServerSettingsRecord> key) {
