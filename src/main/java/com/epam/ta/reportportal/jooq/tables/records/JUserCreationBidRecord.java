...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record9<String, Timestamp, String, JProjectRoleEnum, Long, String, JSONB, Long, JOrganizationRoleEnum> {
    ...
    @Override
    public Row9<String, Timestamp, String, JProjectRoleEnum, Long, String, JSONB, Long, JOrganizationRoleEnum> valuesRow() {
    ...
    @Override
    public JUserCreationBidRecord values(String value1, Timestamp value2, String value3, JProjectRoleEnum value4, Long value5, String value6, JSONB value7, Long value8, JOrganizationRoleEnum value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
