...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record5<String, Instant, String, String, Long, JSONB> {
    ...
    @Override
    public Row5<String, Instant, String, String, Long, JSONB> valuesRow() {
     ...
     */
    public JUserCreationBidRecord(String uuid, Instant lastModified, String email, String role, Long invitingUserId, JSONB metadata) {
        super(JUserCreationBid.USER_CREATION_BID);
