...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record7<String, Instant, String, Long, String, JSONB, String> {

    private static final long serialVersionUID = -1051909294;
    ...
    @Override
    public Row7<String, Instant, String, Long, String, JSONB, String> valuesRow() {
    ...
    @Override
    public JUserCreationBidRecord values(String value1, Instant value2, String value3, Long value4, String value5, JSONB value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
