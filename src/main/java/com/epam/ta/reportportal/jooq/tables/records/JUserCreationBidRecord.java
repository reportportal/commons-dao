...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record7<String, Timestamp, String, Long, String, JSONB, String> {

    private static final long serialVersionUID = -1403163142;
    ...
    @Override
    public Row7<String, Timestamp, String, Long, String, JSONB, String> valuesRow() {
    ...
    @Override
    public JUserCreationBidRecord values(String value1, Timestamp value2, String value3, Long value4, String value5, JSONB value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JUserCreationBidRecord(String uuid, Timestamp lastModified, String email, Long invitingUserId, String projectName, JSONB metadata, String role) {
        super(JUserCreationBid.USER_CREATION_BID);
