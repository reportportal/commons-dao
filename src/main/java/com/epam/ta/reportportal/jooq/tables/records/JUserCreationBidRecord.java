...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record6<String, Timestamp, String, Long, String, JSONB> {

    private static final long serialVersionUID = 265702348;
    ...
    @Override
    public Row6<String, Timestamp, String, Long, String, JSONB> valuesRow() {
    ...
    @Override
    public JUserCreationBidRecord values(String value1, Timestamp value2, String value3, Long value4, String value5, JSONB value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JUserCreationBidRecord(String uuid, Timestamp lastModified, String email, Long invitingUserId, String projectName, JSONB metadata) {
        super(JUserCreationBid.USER_CREATION_BID);
