...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record9<String, Timestamp, String, Long, String, JSONB, JProjectRoleEnum, JOrganizationRoleEnum, Long> {

    private static final long serialVersionUID = -1168332984;
    ...
    public JOrganizationRoleEnum getOrganizationRole() {
        return (JOrganizationRoleEnum) get(7);
    }
    ...
    @Override
    public Row9<String, Timestamp, String, Long, String, JSONB, JProjectRoleEnum, JOrganizationRoleEnum, Long> fieldsRow() {
        return (Row9) super.fieldsRow();
    }

    @Override
    public Row9<String, Timestamp, String, Long, String, JSONB, JProjectRoleEnum, JOrganizationRoleEnum, Long> valuesRow() {
    ...
    @Override
    public Field<JOrganizationRoleEnum> field8() {
    ...
    @Override
    public JOrganizationRoleEnum component8() {
    ...
    @Override
    public JOrganizationRoleEnum value8() {
        return getOrganizationRole();
    }
    ...
    @Override
    public JUserCreationBidRecord value8(JOrganizationRoleEnum value) {
        setOrganizationRole(value);
        return this;
    }

    @Override
    public JUserCreationBidRecord value9(Long value) {
        setOrganizationId(value);
        return this;
    }

    @Override
    public JUserCreationBidRecord values(String value1, Timestamp value2, String value3, Long value4, String value5, JSONB value6, JProjectRoleEnum value7, JOrganizationRoleEnum value8, Long value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JUserCreationBidRecord(String uuid, Timestamp lastModified, String email, Long invitingUserId, String projectName, JSONB metadata, JProjectRoleEnum role, JOrganizationRoleEnum organizationRole, Long organizationId) {
        super(JUserCreationBid.USER_CREATION_BID);
