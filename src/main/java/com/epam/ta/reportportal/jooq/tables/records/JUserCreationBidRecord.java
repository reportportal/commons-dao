...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements Record9<String, Instant, String, JProjectRoleEnum, Long, String, JSONB, Long, JOrganizationRoleEnum> {

    private static final long serialVersionUID = -849559566;
    ...
    @Override
    public Row9<String, Instant, String, JProjectRoleEnum, Long, String, JSONB, Long, JOrganizationRoleEnum> valuesRow() {
    ...
    @Override
    public Field<JProjectRoleEnum> field4() {
    ...
    @Override
    public JProjectRoleEnum component4() {
        return getRole();
    }
    ...
    @Override
    public JProjectRoleEnum value4() {
        return getRole();
    }
    ...
    @Override
    public JUserCreationBidRecord value4(JProjectRoleEnum value) {
        setRole(value);
        return this;
    }
    ...
    @Override
    public JUserCreationBidRecord values(String value1, Instant value2, String value3, JProjectRoleEnum value4, Long value5, String value6, JSONB value7, Long value8, JOrganizationRoleEnum value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JUserCreationBidRecord(String uuid, Instant lastModified, String email, JProjectRoleEnum role, Long invitingUserId, String projectKey, JSONB metadata, Long organizationId, JOrganizationRoleEnum organizationRole) {
        super(JUserCreationBid.USER_CREATION_BID);
