...
public class JUserCreationBidRecord extends UpdatableRecordImpl<JUserCreationBidRecord> implements
    Record5<String, Timestamp, String, Long, String> {
  ...
  public JUserCreationBidRecord(String uuid, Timestamp lastModified, String email,
      Long defaultProjectId, String role) {
    super(JUserCreationBid.USER_CREATION_BID);
  ...
  @Override
  public JUserCreationBidRecord values(String value1, Timestamp value2, String value3, Long value4,
      String value5) {
    value1(value1);
    value2(value2);
    value3(value3);
