...
<<<<<<<HEAD
	...
	private static class Indexes0 {
		...
		public static Index BUG_TRACKING_SYSTEM_PK = Internal.createIndex("bug_tracking_system_pk",
				JBugTrackingSystem.BUG_TRACKING_SYSTEM,
				new OrderField[] { JBugTrackingSystem.BUG_TRACKING_SYSTEM.ID },
				true
		);
		public static Index UNIQUE_BTS = Internal.createIndex("unique_bts",
				JBugTrackingSystem.BUG_TRACKING_SYSTEM,
				new OrderField[] { JBugTrackingSystem.BUG_TRACKING_SYSTEM.URL, JBugTrackingSystem.BUG_TRACKING_SYSTEM.TYPE,
						JBugTrackingSystem.BUG_TRACKING_SYSTEM.BTS_PROJECT, JBugTrackingSystem.BUG_TRACKING_SYSTEM.PROJECT_ID },
				true
		);
		public static Index DASHBOARD_PK = Internal.createIndex("dashboard_pk",
				JDashboard.DASHBOARD,
				new OrderField[] { JDashboard.DASHBOARD.ID },
				true
		);
		public static Index UNQ_NAME_PROJECT = Internal.createIndex("unq_name_project",
				JDashboard.DASHBOARD,
		...
		public static Index DEFECT_FIELD_ALLOWED_VALUE_PK = Internal.createIndex("defect_field_allowed_value_pk",
				JDefectFieldAllowedValue.DEFECT_FIELD_ALLOWED_VALUE,
				new OrderField[] { JDefectFieldAllowedValue.DEFECT_FIELD_ALLOWED_VALUE.ID },
				true
		);
		public static Index DEFECT_FORM_FIELD_PK = Internal.createIndex("defect_form_field_pk",
				JDefectFormField.DEFECT_FORM_FIELD,
				new OrderField[] { JDefectFormField.DEFECT_FORM_FIELD.ID },
				true
		);
		public static Index DEMO_DATA_POSTFIX_PK = Internal.createIndex("demo_data_postfix_pk",
				JDemoDataPostfix.DEMO_DATA_POSTFIX,
				new OrderField[] { JDemoDataPostfix.DEMO_DATA_POSTFIX.ID },
				true
		);
		public static Index EMAIL_SENDER_CASE_PK = Internal.createIndex("email_sender_case_pk",
				JEmailSenderCase.EMAIL_SENDER_CASE,
				new OrderField[] { JEmailSenderCase.EMAIL_SENDER_CASE.ID },
				true
		);
		...
		public static Index ITEM_TAG_PK = Internal.createIndex("item_tag_pk",
				JItemTag.ITEM_TAG,
		...
		public static Index LAUNCH_TAG_PK = Internal.createIndex("launch_tag_pk",
		...
		public static Index LDAP_SYNCHRONIZATION_ATTRIBUTES_EMAIL_KEY = Internal.createIndex("ldap_synchronization_attributes_email_key",
				JLdapSynchronizationAttributes.LDAP_SYNCHRONIZATION_ATTRIBUTES,
				new OrderField[] { JLdapSynchronizationAttributes.LDAP_SYNCHRONIZATION_ATTRIBUTES.EMAIL },
				true
		);
		...
		public static Index ACCESS_TOKENS_PK = Internal.createIndex("access_tokens_pk",
		...
		public static Index SERVER_EMAIL_DETAILS_PK = Internal.createIndex("server_email_details_pk",
				JServerEmailDetails.SERVER_EMAIL_DETAILS,
				new OrderField[] { JServerEmailDetails.SERVER_EMAIL_DETAILS.ID },
				true
		);
		...
		public static Index PK_STATISTICS = Internal.createIndex("pk_statistics",
				JStatistics.STATISTICS,
				new OrderField[] { JStatistics.STATISTICS.S_ID },
				true
		);
		public static Index UNIQUE_STATUS_ITEM = Internal.createIndex("unique_status_item",
				JStatistics.STATISTICS,
				new OrderField[] { JStatistics.STATISTICS.S_FIELD, JStatistics.STATISTICS.ITEM_ID },
				true
		);
		public static Index UNIQUE_STATUS_LAUNCH = Internal.createIndex("unique_status_launch",
				JStatistics.STATISTICS,
				new OrderField[] { JStatistics.STATISTICS.S_FIELD, JStatistics.STATISTICS.LAUNCH_ID },
				true
		);
		...
		public static Index TICKET_TICKET_ID_KEY = Internal.createIndex("ticket_ticket_id_key",
				JTicket.TICKET,
				new OrderField[] { JTicket.TICKET.TICKET_ID },
				true
		);
		public static Index USER_CREATION_BID_EMAIL_KEY = Internal.createIndex("user_creation_bid_email_key",
				JUserCreationBid.USER_CREATION_BID,
				new OrderField[] { JUserCreationBid.USER_CREATION_BID.EMAIL },
				true
		);
		...
		public static Index USER_FILTER_PK = Internal.createIndex("user_filter_pk",
				JUserFilter.USER_FILTER,
				new OrderField[] { JUserFilter.USER_FILTER.ID },
				true
		);
		...
		public static Index WIDGET_OPTION_PK = Internal.createIndex("widget_option_pk",
				JWidgetOption.WIDGET_OPTION,
				new OrderField[] { JWidgetOption.WIDGET_OPTION.ID },
				true
		);
	}
=======
