...
public class Indexes {
    ...
    public static final Index IDX_TMS_TEST_CASE_LAUNCH_LAUNCH_ID = Internal.createIndex(DSL.name("idx_tms_test_case_launch_launch_id"), JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH, new OrderField[] { JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH.LAUNCH_ID }, false);
    public static final Index IDX_TMS_TEST_CASE_LAUNCH_TEST_CASE_ID = Internal.createIndex(DSL.name("idx_tms_test_case_launch_test_case_id"), JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH, new OrderField[] { JTmsTestCaseLaunch.TMS_TEST_CASE_LAUNCH.TEST_CASE_ID }, false);
