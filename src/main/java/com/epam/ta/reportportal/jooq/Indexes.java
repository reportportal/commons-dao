...
public class Indexes {
    ...
    public static final Index IDX_LAUNCH_ORGANIZATION_ID = Internal.createIndex(DSL.name("idx_launch_organization_id"), JLaunch.LAUNCH, new OrderField[] { JLaunch.LAUNCH.ORGANIZATION_ID }, false);
    ...
    public static final Index LAUNCH_STATUS_IDX = Internal.createIndex(DSL.name("launch_status_idx"), JLaunch.LAUNCH, new OrderField[] { JLaunch.LAUNCH.STATUS }, false);
