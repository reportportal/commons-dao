...
public class Indexes {
	...
	private static class Indexes0 {
		public static Index ACL_CLASS_PKEY = Internal.createIndex(
				"acl_class_pkey",
				JAclClass.ACL_CLASS,
				new OrderField[] { JAclClass.ACL_CLASS.ID },
				true
		);
		public static Index UNIQUE_UK_2 = Internal.createIndex(
				"unique_uk_2",
				JAclClass.ACL_CLASS,
				new OrderField[] { JAclClass.ACL_CLASS.CLASS },
				true
		);
		public static Index ACL_ENTRY_PKEY = Internal.createIndex(
				"acl_entry_pkey",
				JAclEntry.ACL_ENTRY,
				new OrderField[] { JAclEntry.ACL_ENTRY.ID },
				true
		);
		public static Index UNIQUE_UK_4 = Internal.createIndex(
				"unique_uk_4",
				JAclEntry.ACL_ENTRY,
				new OrderField[] { JAclEntry.ACL_ENTRY.ACL_OBJECT_IDENTITY, JAclEntry.ACL_ENTRY.ACE_ORDER },
				true
		);
		public static Index ACL_OBJECT_IDENTITY_PKEY = Internal.createIndex(
				"acl_object_identity_pkey",
				JAclObjectIdentity.ACL_OBJECT_IDENTITY,
				new OrderField[] { JAclObjectIdentity.ACL_OBJECT_IDENTITY.ID },
				true
		);
		public static Index UNIQUE_UK_3 = Internal.createIndex(
				"unique_uk_3",
				JAclObjectIdentity.ACL_OBJECT_IDENTITY,
		...
		public static Index ACL_SID_IDX = Internal.createIndex(
				"acl_sid_idx",
				JAclSid.ACL_SID,
				new OrderField[] { JAclSid.ACL_SID.SID },
				false
		);
		public static Index ACL_SID_PKEY = Internal.createIndex(
				"acl_sid_pkey",
				JAclSid.ACL_SID,
				new OrderField[] { JAclSid.ACL_SID.ID },
				true
		);
		public static Index UNIQUE_UK_1 = Internal.createIndex(
				"unique_uk_1",
				JAclSid.ACL_SID,
				new OrderField[] { JAclSid.ACL_SID.SID, JAclSid.ACL_SID.PRINCIPAL },
				true
		);
		public static Index ACTIVE_DIRECTORY_CONFIG_PK = Internal.createIndex(
		...
		public static Index ACTIVITY_PK = Internal.createIndex(
				"activity_pk",
				JActivity.ACTIVITY,
		...
		public static Index ATT_ITEM_IDX = Internal.createIndex(
				"att_item_idx",
				JAttachment.ATTACHMENT,
				new OrderField[] { JAttachment.ATTACHMENT.ITEM_ID },
				false
		);
		public static Index ATT_LAUNCH_IDX = Internal.createIndex(
				"att_launch_idx",
				JAttachment.ATTACHMENT,
				new OrderField[] { JAttachment.ATTACHMENT.LAUNCH_ID },
				false
		);
		public static Index ATT_PROJECT_IDX = Internal.createIndex(
				"att_project_idx",
				JAttachment.ATTACHMENT,
				new OrderField[] { JAttachment.ATTACHMENT.PROJECT_ID },
				false
		);
		public static Index ATTACHMENT_PK = Internal.createIndex(
				"attachment_pk",
				JAttachment.ATTACHMENT,
				new OrderField[] { JAttachment.ATTACHMENT.ID },
				true
		);
		public static Index ATTRIBUTE_PK = Internal.createIndex(
				"attribute_pk",
				JAttribute.ATTRIBUTE,
				new OrderField[] { JAttribute.ATTRIBUTE.ID },
				true
		);
		public static Index AUTH_CONFIG_PK = Internal.createIndex(
				"auth_config_pk",
				JAuthConfig.AUTH_CONFIG,
				new OrderField[] { JAuthConfig.AUTH_CONFIG.ID },
				true
		);
		public static Index CONTENT_FIELD_WIDGET_IDX = Internal.createIndex(
				"content_field_widget_idx",
				JContentField.CONTENT_FIELD,
				new OrderField[] { JContentField.CONTENT_FIELD.ID },
				false
		);
		public static Index DASHBOARD_PKEY = Internal.createIndex(
				"dashboard_pkey",
		...
		public static Index FILTER_COND_FILTER_IDX = Internal.createIndex(
				"filter_cond_filter_idx",
		...
		public static Index FILTER_SORT_FILTER_IDX = Internal.createIndex(
				"filter_sort_filter_idx",
		...
		public static Index INTEGR_PROJECT_IDX = Internal.createIndex(
				"integr_project_idx",
		...
		public static Index ISSUE_IT_IDX = Internal.createIndex(
				"issue_it_idx",
				JIssue.ISSUE,
		...
		public static Index ISSUE_TYPE_GROUP_IDX = Internal.createIndex(
				"issue_type_group_idx",
				JIssueType.ISSUE_TYPE,
				new OrderField[] { JIssueType.ISSUE_TYPE.ISSUE_GROUP_ID },
				false
		);
		public static Index ISSUE_TYPE_LOCATOR_KEY = Internal.createIndex(
		...
		public static Index ISSUE_TYPE_PROJECT_PK = Internal.createIndex(
		...
		public static Index ITEM_ATTR_LAUNCH_IDX = Internal.createIndex(
				"item_attr_launch_idx",
				JItemAttribute.ITEM_ATTRIBUTE,
				new OrderField[] { JItemAttribute.ITEM_ATTRIBUTE.LAUNCH_ID },
				false
		);
		public static Index ITEM_ATTR_TI_IDX = Internal.createIndex(
				"item_attr_ti_idx",
				JItemAttribute.ITEM_ATTRIBUTE,
		...
		public static Index LAUNCH_PROJECT_IDX = Internal.createIndex(
				"launch_project_idx",
				JLaunch.LAUNCH,
		...
		public static Index LAUNCH_UUID_KEY = Internal.createIndex(
				"launch_uuid_key",
				JLaunch.LAUNCH,
				new OrderField[] { JLaunch.LAUNCH.UUID },
				true
		...
		public static Index LAUNCH_ATTRIBUTE_RULES_PK = Internal.createIndex(
				"launch_attribute_rules_pk",
				JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES,
				new OrderField[] { JLaunchAttributeRules.LAUNCH_ATTRIBUTE_RULES.ID },
				true
		);
		public static Index LN_SEND_CASE_IDX = Internal.createIndex(
				"ln_send_case_idx",
				JLaunchNames.LAUNCH_NAMES,
				new OrderField[] { JLaunchNames.LAUNCH_NAMES.SENDER_CASE_ID },
				false
		);
		public static Index LDAP_CONFIG_PK = Internal.createIndex(
				"ldap_config_pk",
				JLdapConfig.LDAP_CONFIG,
				new OrderField[] { JLdapConfig.LDAP_CONFIG.ID },
				true
		);
		public static Index LDAP_SYNCHRONIZATION_ATTRIBUTES_PK = Internal.createIndex(
		...
		public static Index LOG_MESSAGE_TRGM_IDX = Internal.createIndex(
				"log_message_trgm_idx",
				JLog.LOG,
		...
		public static Index OAUTH_ACCESS_TOKEN_PKEY = Internal.createIndex(
				"oauth_access_token_pkey",
				JOauthAccessToken.OAUTH_ACCESS_TOKEN,
				new OrderField[] { JOauthAccessToken.OAUTH_ACCESS_TOKEN.ID },
				true
		);
		public static Index OAUTH_AT_USER_IDX = Internal.createIndex(
				"oauth_at_user_idx",
				JOauthAccessToken.OAUTH_ACCESS_TOKEN,
		...
		public static Index PARAMETER_TI_IDX = Internal.createIndex(
				"parameter_ti_idx",
				JParameter.PARAMETER,
				new OrderField[] { JParameter.PARAMETER.ITEM_ID },
				false
		);
		public static Index PATTERN_TEMPLATE_PK = Internal.createIndex(
				"pattern_template_pk",
				JPatternTemplate.PATTERN_TEMPLATE,
				new OrderField[] { JPatternTemplate.PATTERN_TEMPLATE.ID },
				true
		);
		public static Index UNQ_NAME_PROJECTID = Internal.createIndex(
				"unq_name_projectid",
				JPatternTemplate.PATTERN_TEMPLATE,
				new OrderField[] { JPatternTemplate.PATTERN_TEMPLATE.NAME, JPatternTemplate.PATTERN_TEMPLATE.PROJECT_ID },
				true
		);
		public static Index PATTERN_ITEM_ITEM_ID_IDX = Internal.createIndex(
				"pattern_item_item_id_idx",
		...
		public static Index PATTERN_ITEM_PATTERN_ID_IDX = Internal.createIndex(
				"pattern_item_pattern_id_idx",
				JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM,
				new OrderField[] { JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM.PATTERN_ID },
				false
		);
		public static Index PATTERN_ITEM_UNQ = Internal.createIndex(
				"pattern_item_unq",
				JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM,
				new OrderField[] { JPatternTemplateTestItem.PATTERN_TEMPLATE_TEST_ITEM.PATTERN_ID,
		...
		public static Index PROJECT_NAME_KEY = Internal.createIndex(
				"project_name_key",
				JProject.PROJECT,
		...
		public static Index RCPNT_SEND_CASE_IDX = Internal.createIndex(
				"rcpnt_send_case_idx",
		...
		public static Index RESTORE_PASSWORD_BID_PK = Internal.createIndex(
				"restore_password_bid_pk",
				JRestorePasswordBid.RESTORE_PASSWORD_BID,
				new OrderField[] { JRestorePasswordBid.RESTORE_PASSWORD_BID.UUID },
				true
		);
		public static Index SAML_PROVIDER_DETAILS_PKEY = Internal.createIndex(
				"saml_provider_details_pkey",
				JSamlProviderDetails.SAML_PROVIDER_DETAILS,
				new OrderField[] { JSamlProviderDetails.SAML_PROVIDER_DETAILS.ID },
				true
		);
		public static Index SCHEMA_MIGRATIONS_PKEY = Internal.createIndex(
				"schema_migrations_pkey",
				JSchemaMigrations.SCHEMA_MIGRATIONS,
				new OrderField[] { JSchemaMigrations.SCHEMA_MIGRATIONS.VERSION },
				true
		);
		...
		public static Index SENDER_CASE_PROJECT_IDX = Internal.createIndex(
				"sender_case_project_idx",
				JSenderCase.SENDER_CASE,
		...
		public static Index STATISTICS_FIELD_NAME_KEY = Internal.createIndex(
				"statistics_field_name_key",
				JStatisticsField.STATISTICS_FIELD,
				new OrderField[] { JStatisticsField.STATISTICS_FIELD.NAME },
				true
		);
		public static Index STATISTICS_FIELD_PK = Internal.createIndex(
				"statistics_field_pk",
				JStatisticsField.STATISTICS_FIELD,
				new OrderField[] { JStatisticsField.STATISTICS_FIELD.SF_ID },
				true
		);
		public static Index PATH_GIST_IDX = Internal.createIndex(
				"path_gist_idx",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.PATH },
				false
		);
		public static Index PATH_IDX = Internal.createIndex(
				"path_idx",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.PATH },
				false
		...
		public static Index TEST_ITEM_UUID_KEY = Internal.createIndex(
				"test_item_uuid_key",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.UUID },
				true
		);
		public static Index TI_LAUNCH_IDX = Internal.createIndex(
				"ti_launch_idx",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.LAUNCH_ID },
				false
		);
		public static Index TI_PARENT_IDX = Internal.createIndex(
				"ti_parent_idx",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.PARENT_ID },
				false
		);
		public static Index TI_RETRY_OF_IDX = Internal.createIndex(
				"ti_retry_of_idx",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.RETRY_OF },
				false
		);
		public static Index TI_UUID_IDX = Internal.createIndex(
				"ti_uuid_idx",
				JTestItem.TEST_ITEM,
				new OrderField[] { JTestItem.TEST_ITEM.UUID },
				false
		...
		public static Index TICKET_SUBMITTER_IDX = Internal.createIndex(
				"ticket_submitter_idx",
				JTicket.TICKET,
		...
		public static Index USER_BID_PROJECT_IDX = Internal.createIndex(
				"user_bid_project_idx",
				JUserCreationBid.USER_CREATION_BID,
				new OrderField[] { JUserCreationBid.USER_CREATION_BID.DEFAULT_PROJECT_ID },
				false
		);
		public static Index USER_CREATION_BID_PK = Internal.createIndex(
				"user_creation_bid_pk",
				JUserCreationBid.USER_CREATION_BID,
				new OrderField[] { JUserCreationBid.USER_CREATION_BID.UUID },
				true
		);
		public static Index USER_PREFERENCE_PK = Internal.createIndex(
				"user_preference_pk",
				JUserPreference.USER_PREFERENCE,
				new OrderField[] { JUserPreference.USER_PREFERENCE.ID },
				true
		);
		public static Index USER_PREFERENCE_UQ = Internal.createIndex(
				"user_preference_uq",
				JUserPreference.USER_PREFERENCE,
		...
		public static Index WIDGET_FILTER_PK = Internal.createIndex(
				"widget_filter_pk",
