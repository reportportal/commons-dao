...
public class Indexes {
    ...
    public static final Index CONTENT_FIELD_PK = Indexes0.CONTENT_FIELD_PK;
    ...
    public static final Index PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_KEY = Indexes0.PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_KEY;
    ...
    private static class Indexes0 {
        ...
        public static Index CONTENT_FIELD_PK = Internal.createIndex("content_field_pk", JContentField.CONTENT_FIELD, new OrderField[] { JContentField.CONTENT_FIELD.ID }, true);
        ...
        public static Index PK_EXECUTION_STATISTICS = Internal.createIndex("pk_execution_statistics", JExecutionStatistics.EXECUTION_STATISTICS, new OrderField[] { JExecutionStatistics.EXECUTION_STATISTICS.ES_ID }, true);
        public static Index UNIQUE_STATUS_ITEM = Internal.createIndex("unique_status_item", JExecutionStatistics.EXECUTION_STATISTICS, new OrderField[] { JExecutionStatistics.EXECUTION_STATISTICS.ES_STATUS, JExecutionStatistics.EXECUTION_STATISTICS.ITEM_ID }, true);
        public static Index UNIQUE_STATUS_LAUNCH = Internal.createIndex("unique_status_launch", JExecutionStatistics.EXECUTION_STATISTICS, new OrderField[] { JExecutionStatistics.EXECUTION_STATISTICS.ES_STATUS, JExecutionStatistics.EXECUTION_STATISTICS.LAUNCH_ID }, true);
        ...
        public static Index PK_ISSUE_STATISTICS = Internal.createIndex("pk_issue_statistics", JIssueStatistics.ISSUE_STATISTICS, new OrderField[] { JIssueStatistics.ISSUE_STATISTICS.IS_ID }, true);
        public static Index UNIQUE_ISSUE_ITEM = Internal.createIndex("unique_issue_item", JIssueStatistics.ISSUE_STATISTICS, new OrderField[] { JIssueStatistics.ISSUE_STATISTICS.ISSUE_TYPE_ID, JIssueStatistics.ISSUE_STATISTICS.ITEM_ID }, true);
        public static Index UNIQUE_ISSUE_LAUNCH = Internal.createIndex("unique_issue_launch", JIssueStatistics.ISSUE_STATISTICS, new OrderField[] { JIssueStatistics.ISSUE_STATISTICS.ISSUE_TYPE_ID, JIssueStatistics.ISSUE_STATISTICS.LAUNCH_ID }, true);
        ...
        public static Index PROJECT_CONFIGURATION_PROJECT_EMAIL_CONFIG_ID_KEY = Internal.createIndex("project_configuration_project_email_config_id_key", JProjectConfiguration.PROJECT_CONFIGURATION, new OrderField[] { JProjectConfiguration.PROJECT_CONFIGURATION.PROJECT_EMAIL_CONFIG_ID }, true);
