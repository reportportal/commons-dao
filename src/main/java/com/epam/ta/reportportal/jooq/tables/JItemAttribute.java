...
public class JItemAttribute extends TableImpl<JItemAttributeRecord> {
	 ...
	 */
	public final TableField<JItemAttributeRecord, Long> ID = createField("id",
	 ...
	 */
	public final TableField<JItemAttributeRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.VARCHAR, this, "");
	 ...
	 */
	public final TableField<JItemAttributeRecord, Boolean> SYSTEM = createField("system",
	...
	public List<ForeignKey<JItemAttributeRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JItemAttributeRecord, ?>>asList(Keys.ITEM_ATTRIBUTE__ITEM_ATTRIBUTE_ITEM_ID_FKEY,
