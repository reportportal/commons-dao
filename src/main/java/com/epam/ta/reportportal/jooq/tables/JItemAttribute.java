...
public class JItemAttribute extends TableImpl<JItemAttributeRecord> {
  ...
  public final TableField<JItemAttributeRecord, Long> ID = createField(DSL.name("id"),
      org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('item_attribute_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  /**
   * The column <code>public.item_attribute.key</code>.
   */
  public final TableField<JItemAttributeRecord, String> KEY = createField(DSL.name("key"),
   ...
   */
  public final TableField<JItemAttributeRecord, Long> LAUNCH_ID = createField(DSL.name("launch_id"),
      org.jooq.impl.SQLDataType.BIGINT, this, "");
  /**
  ...
  public <O extends Record> JItemAttribute(Table<O> child,
      ForeignKey<O, JItemAttributeRecord> key) {
  ...
  public List<Index> getIndexes() {
    return Arrays.<Index>asList(Indexes.ITEM_ATTR_LAUNCH_IDX, Indexes.ITEM_ATTR_TI_IDX,
        Indexes.ITEM_ATTRIBUTE_PK);
  }
