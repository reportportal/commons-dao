...
public class JItemAttribute extends TableImpl<JItemAttributeRecord> {
	...
	private static final long serialVersionUID = 515470130;
	 ...
	 */
	public final TableField<JItemAttributeRecord, Integer> ID = createField(
			"id",
			org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('item_attribute_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)),
			this,
			""
	);
	 ...
	 */
	public final TableField<JItemAttributeRecord, String> KEY = createField("key", org.jooq.impl.SQLDataType.CLOB, this, "");

	/**
	 * The column <code>public.item_attribute.value</code>.
	 */
	public final TableField<JItemAttributeRecord, String> VALUE = createField("value", org.jooq.impl.SQLDataType.CLOB, this, "");
