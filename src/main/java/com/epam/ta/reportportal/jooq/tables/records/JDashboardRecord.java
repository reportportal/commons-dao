...
public class JDashboardRecord extends UpdatableRecordImpl<JDashboardRecord> implements Record5<Long, String, String, Integer, Timestamp> {

    private static final long serialVersionUID = -1290027972;
     ...
     */
    @Override
    public JDashboardRecord values(Long value1, String value2, String value3, Integer value4, Timestamp value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public JDashboardRecord(Long id, String name, String description, Integer projectId, Timestamp creationDate) {
        super(JDashboard.DASHBOARD);
