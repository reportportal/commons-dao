...
public class JDashboardRecord extends UpdatableRecordImpl<JDashboardRecord> implements Record5<Integer, String, String, Integer, Timestamp> {

    private static final long serialVersionUID = -1009051580;
