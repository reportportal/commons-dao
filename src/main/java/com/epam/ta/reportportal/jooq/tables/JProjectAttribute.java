...
public class JProjectAttribute extends TableImpl<JProjectAttributeRecord> {
	 ...
	 */
	public final TableField<JProjectAttributeRecord, Long> ATTRIBUTE_ID = createField("attribute_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('project_attribute_attribute_id_seq'::regclass)",
	 ...
	 */
	public final TableField<JProjectAttributeRecord, String> VALUE = createField("value",
	 ...
	 */
	public final TableField<JProjectAttributeRecord, Long> PROJECT_ID = createField("project_id",
			org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('project_attribute_project_id_seq'::regclass)",
							org.jooq.impl.SQLDataType.BIGINT
					)),
			this,
			""
	...
	public List<ForeignKey<JProjectAttributeRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JProjectAttributeRecord, ?>>asList(Keys.PROJECT_ATTRIBUTE__PROJECT_ATTRIBUTE_ATTRIBUTE_ID_FKEY,
