...
public class JProjectAttribute extends TableImpl<JProjectAttributeRecord> {
  ...
  public final TableField<JProjectAttributeRecord, Long> ATTRIBUTE_ID = createField(
      DSL.name("attribute_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('project_attribute_attribute_id_seq'::regclass)",
  ...
  public final TableField<JProjectAttributeRecord, Long> PROJECT_ID = createField(
      DSL.name("project_id"), org.jooq.impl.SQLDataType.BIGINT.nullable(false).defaultValue(
          org.jooq.impl.DSL.field("nextval('project_attribute_project_id_seq'::regclass)",
              org.jooq.impl.SQLDataType.BIGINT)), this, "");
  ...
  public <O extends Record> JProjectAttribute(Table<O> child,
      ForeignKey<O, JProjectAttributeRecord> key) {
