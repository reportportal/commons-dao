...
public class UserMetadata   {
  ...
  public UserMetadata uuid(UUID uuid) {
    this.uuid = uuid;
    return this;
  }
  ...
  public UserMetadata authProvider(AuthProviderEnum authProvider) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, userMetadata.id) &&
        ...
        Objects.equals(this.authProvider, userMetadata.authProvider);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, uuid, createdAt, updatedAt, lastLoginAt, authProvider);
  }
