...
public class JIssueTypeProjectConfiguration extends TableImpl<JIssueTypeProjectConfigurationRecord> {
	 ...
	 */
	public final TableField<JIssueTypeProjectConfigurationRecord, Long> CONFIGURATION_ID = createField(
			"configuration_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
