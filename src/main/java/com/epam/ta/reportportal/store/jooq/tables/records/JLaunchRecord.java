...
public class JLaunchRecord extends UpdatableRecordImpl<JLaunchRecord> implements
																	  Record12<Long, String, Long, Long, String, String, Timestamp, Timestamp, Integer, Timestamp, JLaunchModeEnum, JStatusEnum> {
	...
	public JLaunchRecord values(Long value1, String value2, Long value3, Long value4, String value5, String value6, Timestamp value7,
			Timestamp value8, Integer value9, Timestamp value10, JLaunchModeEnum value11, JStatusEnum value12) {
		value1(value1);
		value2(value2);
		value3(value3);
		value4(value4);
	...
	public JLaunchRecord(Long id, String uuid, Long projectId, Long userId, String name, String description, Timestamp startTime,
			Timestamp endTime, Integer number, Timestamp lastModified, JLaunchModeEnum mode, JStatusEnum status) {
		super(JLaunch.LAUNCH);
