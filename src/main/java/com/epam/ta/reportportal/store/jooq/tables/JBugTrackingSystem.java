...
public class JBugTrackingSystem extends TableImpl<JBugTrackingSystemRecord> {
	 ...
	 */
	public final TableField<JBugTrackingSystemRecord, Long> ID = createField(
			"id", org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(
							org.jooq.impl.DSL.field("nextval('bug_tracking_system_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)),
			this, ""
	);
	 ...
	 */
	public final TableField<JBugTrackingSystemRecord, String> TYPE = createField(
			"type", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

	/**
	 * The column <code>public.bug_tracking_system.bts_project</code>.
	 */
	public final TableField<JBugTrackingSystemRecord, String> BTS_PROJECT = createField(
			"bts_project", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");

	/**
	 * The column <code>public.bug_tracking_system.project_id</code>.
	 */
	public final TableField<JBugTrackingSystemRecord, Long> PROJECT_ID = createField(
