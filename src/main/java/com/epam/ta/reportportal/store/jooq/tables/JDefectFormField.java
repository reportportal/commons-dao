...
public class JDefectFormField extends TableImpl<JDefectFormFieldRecord> {
	 ...
	 */
	public final TableField<JDefectFormFieldRecord, Long> ID = createField(
			"id", org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(
							org.jooq.impl.DSL.field("nextval('defect_form_field_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)),
			this, ""
	);
	 ...
	 */
	public final TableField<JDefectFormFieldRecord, Long> BUG_TRACKING_SYSTEM_ID = createField(
			"bug_tracking_system_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
