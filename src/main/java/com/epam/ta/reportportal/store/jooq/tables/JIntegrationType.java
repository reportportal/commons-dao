...
public class JIntegrationType extends TableImpl<JIntegrationTypeRecord> {
	...
	public final TableField<JIntegrationTypeRecord, Integer> ID = createField(
			"id", org.jooq.impl.SQLDataType.INTEGER.nullable(false)
					.defaultValue(
							org.jooq.impl.DSL.field("nextval('integration_type_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)),
			this, ""
	);
	...
	public final TableField<JIntegrationTypeRecord, String> NAME = createField(
			"name", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");
	...
	public final TableField<JIntegrationTypeRecord, JIntegrationAuthFlowEnum> AUTH_FLOW = createField(
			"auth_flow", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(
					com.epam.ta.reportportal.store.jooq.enums.JIntegrationAuthFlowEnum.class), this, "");
	...
	public final TableField<JIntegrationTypeRecord, JIntegrationGroupEnum> GROUP_TYPE = createField(
			"group_type", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(
					com.epam.ta.reportportal.store.jooq.enums.JIntegrationGroupEnum.class), this, "");
