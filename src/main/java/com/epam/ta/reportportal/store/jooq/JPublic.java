...
public class JPublic extends SchemaImpl {
	...
	private static final long serialVersionUID = 51137442;
	...
	private final List<Table<?>> getTables0() {
		return Arrays.<Table<?>>asList(JActivity.ACTIVITY, JBugTrackingSystem.BUG_TRACKING_SYSTEM, JContentField.CONTENT_FIELD,
				...
				JLog.LOG, JOauthAccessToken.OAUTH_ACCESS_TOKEN, JOauthRegistration.OAUTH_REGISTRATION,
				JOauthRegistrationScope.OAUTH_REGISTRATION_SCOPE, JParameter.PARAMETER, JProject.PROJECT,
