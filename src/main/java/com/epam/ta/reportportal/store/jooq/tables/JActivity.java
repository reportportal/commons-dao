...
public class JActivity extends TableImpl<JActivityRecord> {
	 ...
	 */
	public final TableField<JActivityRecord, Long> ID = createField(
			"id", org.jooq.impl.SQLDataType.BIGINT.nullable(false)
					.defaultValue(org.jooq.impl.DSL.field("nextval('activity_id_seq'::regclass)", org.jooq.impl.SQLDataType.BIGINT)), this,
			""
	);
	 ...
	 */
	public final TableField<JActivityRecord, Long> USER_ID = createField(
			"user_id", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

	/**
	 * The column <code>public.activity.entity</code>.
	 */
	public final TableField<JActivityRecord, JActivityEntityEnum> ENTITY = createField(
			"entity", org.jooq.util.postgres.PostgresDataType.VARCHAR.asEnumDataType(
					com.epam.ta.reportportal.store.jooq.enums.JActivityEntityEnum.class), this, "");

	/**
	 * The column <code>public.activity.action</code>.
	 */
	public final TableField<JActivityRecord, String> ACTION = createField(
			"action", org.jooq.impl.SQLDataType.VARCHAR(128).nullable(false), this, "");
	 ...
	 */
	public final TableField<JActivityRecord, Timestamp> CREATION_DATE = createField(
