...
public class JProjectConfiguration extends TableImpl<JProjectConfigurationRecord> {
	 ...
	 */
	public final TableField<JProjectConfigurationRecord, Long> ID = createField(
	 ...
	 */
	public final TableField<JProjectConfigurationRecord, Long> EMAIL_CONFIGURATION_ID = createField(
			"email_configuration_id", org.jooq.impl.SQLDataType.BIGINT, this, "");
	...
	public List<ForeignKey<JProjectConfigurationRecord, ?>> getReferences() {
		return Arrays.<ForeignKey<JProjectConfigurationRecord, ?>>asList(
				Keys.PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_ID_FKEY,
