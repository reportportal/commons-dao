...
public class JServerSettings extends TableImpl<JServerSettingsRecord> {
	...
	public final TableField<JServerSettingsRecord, Short> ID = createField(
			"id", org.jooq.impl.SQLDataType.SMALLINT.nullable(false)
					.defaultValue(
							org.jooq.impl.DSL.field("nextval('server_settings_id_seq'::regclass)", org.jooq.impl.SQLDataType.SMALLINT)),
			this, ""
	);
	...
	public final TableField<JServerSettingsRecord, String> KEY = createField(
			"key", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
