...
public class Keys {
	...
	private static class UniqueKeys0 {
		...
		public static final UniqueKey<JBugTrackingSystemRecord> UNIQUE_BTS = Internal.createUniqueKey(
				JBugTrackingSystem.BUG_TRACKING_SYSTEM, "unique_bts", JBugTrackingSystem.BUG_TRACKING_SYSTEM.URL,
				JBugTrackingSystem.BUG_TRACKING_SYSTEM.TYPE, JBugTrackingSystem.BUG_TRACKING_SYSTEM.BTS_PROJECT,
		...
		public static final UniqueKey<JServerSettingsRecord> SERVER_SETTINGS_KEY_KEY = Internal.createUniqueKey(
				JServerSettings.SERVER_SETTINGS, "server_settings_key_key", JServerSettings.SERVER_SETTINGS.KEY);
	...
	private static class ForeignKeys0 {
		public static final ForeignKey<JActivityRecord, JUsersRecord> ACTIVITY__ACTIVITY_USER_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.store.jooq.Keys.USERS_PK, JActivity.ACTIVITY, "activity__activity_user_id_fkey",
		...
		public static final ForeignKey<JBugTrackingSystemRecord, JProjectRecord> BUG_TRACKING_SYSTEM__BUG_TRACKING_SYSTEM_PROJECT_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PROJECT_PK, JBugTrackingSystem.BUG_TRACKING_SYSTEM,
						"bug_tracking_system__bug_tracking_system_project_id_fkey", JBugTrackingSystem.BUG_TRACKING_SYSTEM.PROJECT_ID
				);
		...
		public static final ForeignKey<JDefectFormFieldValueRecord, JDefectFormFieldRecord> DEFECT_FORM_FIELD_VALUE__DEFECT_FORM_FIELD_VALUE_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.DEFECT_FORM_FIELD_PK,
						JDefectFormFieldValue.DEFECT_FORM_FIELD_VALUE, "defect_form_field_value__defect_form_field_value_id_fkey",
		...
		public static final ForeignKey<JParameterRecord, JTestItemRecord> PARAMETER__PARAMETER_ITEM_ID_FKEY = Internal.createForeignKey(
				com.epam.ta.reportportal.store.jooq.Keys.TEST_ITEM_PK, JParameter.PARAMETER, "parameter__parameter_item_id_fkey",
				JParameter.PARAMETER.ITEM_ID
		);
		public static final ForeignKey<JProjectConfigurationRecord, JProjectRecord> PROJECT_CONFIGURATION__PROJECT_CONFIGURATION_ID_FKEY = Internal
				.createForeignKey(com.epam.ta.reportportal.store.jooq.Keys.PROJECT_PK, JProjectConfiguration.PROJECT_CONFIGURATION,
						"project_configuration__project_configuration_id_fkey", JProjectConfiguration.PROJECT_CONFIGURATION.ID
				);
