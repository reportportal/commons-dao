...
public class Indexes {
	...
	private static class Indexes0 {
		public static Index ACTIVITY_PK = Internal.createIndex(
				"activity_pk", JActivity.ACTIVITY, new OrderField[] { JActivity.ACTIVITY.ID }, true);
		...
		public static Index UNIQUE_BTS = Internal.createIndex(
				"unique_bts", JBugTrackingSystem.BUG_TRACKING_SYSTEM,
				new OrderField[] { JBugTrackingSystem.BUG_TRACKING_SYSTEM.URL, JBugTrackingSystem.BUG_TRACKING_SYSTEM.TYPE,
						JBugTrackingSystem.BUG_TRACKING_SYSTEM.BTS_PROJECT, JBugTrackingSystem.BUG_TRACKING_SYSTEM.PROJECT_ID }, true
		);
		...
		public static Index PK_EXECUTION_STATISTICS = Internal.createIndex(
				...
				new OrderField[] { JExecutionStatistics.EXECUTION_STATISTICS.ES_ID }, true
		);
		public static Index UNIQUE_STATUS_ITEM = Internal.createIndex(
				"unique_status_item", JExecutionStatistics.EXECUTION_STATISTICS,
				new OrderField[] { JExecutionStatistics.EXECUTION_STATISTICS.ES_STATUS, JExecutionStatistics.EXECUTION_STATISTICS.ITEM_ID },
				true
		);
		public static Index UNIQUE_STATUS_LAUNCH = Internal.createIndex(
				...
				new OrderField[] { JExecutionStatistics.EXECUTION_STATISTICS.ES_STATUS,
						JExecutionStatistics.EXECUTION_STATISTICS.LAUNCH_ID }, true
		);
		...
		public static Index SERVER_SETTINGS_KEY_KEY = Internal.createIndex(
				"server_settings_key_key", JServerSettings.SERVER_SETTINGS, new OrderField[] { JServerSettings.SERVER_SETTINGS.KEY }, true);
