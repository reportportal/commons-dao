...
BEGIN
  ...
  VALUES ('han_solo', '3531f6f9b0538fd347f4c95bd2af9d01', 'han_solo@domain.com', 'ADMINISTRATOR', 'INTERNAL', falcon, 'Han Solo', FALSE, '{"metadata": {"last_login": "2018-12-27T10:31:15.573"}}');
  ...
  VALUES ('chubaka', '601c4731aeff3b84f76672ad024bb2a0', 'chybaka@domain.com', 'USER', 'INTERNAL', falcon, 'Chubaka', FALSE);
  ...
  INSERT INTO users (login, password, email, role, type, default_project_id, full_name, expired)
  VALUES ('fake_chubaka', '601c4731aeff3b84f76672ad024bb2a0', 'chybakafake@domain.com', 'USER', 'INTERNAL', falcon, 'Chubaka Fake', FALSE);
...
SELECT test_project_init();

DROP FUNCTION IF EXISTS test_project_init();