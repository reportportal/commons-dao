...
INSERT INTO public.launch (id, uuid, project_id, number, owner, name, start_time, end_time, last_modified, mode, status)
VALUES (100, 'uuid', 2, 4999, 'default', 'finished launch', now(), now(), now(), 'DEFAULT', 'FAILED');
...
INSERT INTO public.launch (id, uuid, project_id, number, owner, name, start_time, end_time, last_modified, mode, status)
VALUES (200, 'uuid3', 2, 5000, 'default', 'finished launch', now(), now(), now(), 'DEFAULT', 'FAILED');
...
INSERT INTO public.launch (id, uuid, project_id, number, owner, name, start_time, end_time, last_modified, mode, status)
VALUES (300, 'uuid5', 2, 5001, 'default', 'finished launch', now(), now(), now(), 'DEFAULT', 'FAILED');