...
VALUES ('0647cf8f-02e3-4acd-ba3e-f74ec9d2c5cb', now(), 'superadminemail@domain.com', 1, 'MANAGER', '{
  "metadata": {
    "type": "internal"
  }
}', 1),

       ('6cb0ce2a-e974-44d8-ae78-d86baa38c356', now() - interval '30 day', 'defaultemail@domain.com', 2, 'MANAGER', '{
         "metadata": {
           "type": "internal"
         }
       }', 1),
