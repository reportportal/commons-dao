...
INSERT INTO public.content_field(id, field)
VALUES (6, 'statistics$product_bug$pb001');
...
VALUES (13, 5, 'activity stream12', 'superadmin', 'activityStream', 5, 5, 0, 0),
       (13, 7, 'INVESTIGATED PERCENTAGE OF LAUNCHES', 'superadmin', 'investigatedTrend', 6, 3, 0,
        0),
...
INSERT INTO public.user_preference(project_id, user_id, filter_id)
VALUES (1, 1, 1),
       (1, 1, 2),
       (1, 3, 2),
       (2, 2, 3);