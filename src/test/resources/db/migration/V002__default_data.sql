...
DO
  $$
    ...
    BEGIN
      ...
      --       VALUES (true, 'test integration type', 'LDAP', now(), 'AUTH');
      ...
      INSERT INTO project (name, project_type, creation_date, metadata)
      VALUES ('superadmin_personal', 'PERSONAL', now(), '{"metadata": {"additional_info": ""}}');
      ...
      INSERT INTO project (name, project_type, creation_date, metadata)
      VALUES ('default_personal', 'PERSONAL', now(), '{"metadata": {"additional_info": ""}}');
      ...
      --       INSERT INTO integration (project_id, type, enabled, creation_date)
      --       VALUES (superadminProject, rally, FALSE, now()),
      --              (defaultProject, rally, FALSE, now());
      --       INSERT INTO integration (project_id, type, enabled, creation_date)
      --       VALUES (superadminProject, jira, FALSE, now()),
      --              (defaultProject, jira, FALSE, now());
      ...
      VALUES (2, '3 months', defaultproject),
             (2, '3 months', superadminproject);
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (3, '2 weeks', defaultproject),
             (3, '2 weeks', superadminproject);
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (4, '2 weeks', defaultproject),
             (4, '2 weeks', superadminproject);
      ...
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (11, 'LAUNCH_NAME', defaultproject),
             (11, 'LAUNCH_NAME', superadminproject);
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (12, 'true', defaultproject),
             (12, 'reportportal@example.com', superadminproject);
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (13, 'true', defaultproject),
             (13, 'reportportal@example.com', superadminproject);
