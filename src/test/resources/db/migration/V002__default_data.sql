...
DO
  $$
    ...
    BEGIN
      ...
      VALUES (2, '3 months', defaultProject), (2, '3 months', superadminProject);
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (3, '2 weeks', defaultProject), (3, '2 weeks', superadminProject);
      INSERT INTO project_attribute (attribute_id, value, project_id)
      VALUES (4, '2 weeks', defaultProject), (4, '2 weeks', superadminProject);
