...
class OrganizationUsersRepositoryCustomTest extends BaseTest {
  ...
  void findOrganizationUsersByFilter() {
    ...
    final List<OrganizationUser> orgUsers = organizationUsersRepositoryCustom.findByFilter(
        filter);
  ...
  void findOrganizationUsersByFilterPageable(int offset, int limit, String sortField) {
    ...
    final Page<OrganizationUser> orgUsers = organizationUsersRepositoryCustom.findByFilter(
        filter, pageRequest);
