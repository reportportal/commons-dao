 ...
 */
public class IntegrationGroupEnumTest {
	...
	public void setUp() throws Exception {
		allowed = Arrays.stream(IntegrationGroupEnum.values()).collect(Collectors.toMap(it -> it, it -> permute(it.name())));
	...
	public void isPresent() {
		allowed.entrySet().stream().flatMap(it -> it.getValue().stream()).forEach(it -> assertTrue(IntegrationGroupEnum.isPresent(it)));
