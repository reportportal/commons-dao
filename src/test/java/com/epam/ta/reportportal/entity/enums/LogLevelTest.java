...
public class LogLevelTest {
	...
	public static final int ALL_INT = 500;
	...
	public void testAll() {
		...
		Assert.assertEquals(ALL_INT, LogLevel.toCustomLogLevel(String.valueOf(ALL_INT)));
		Assert.assertEquals(LogLevel.ALL, LogLevel.toLevel(ALL_INT));
	}
}