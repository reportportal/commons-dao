 ...
 */
public class ProjectAttributeEnumTest {
	...
	public void setUp() throws Exception {
		allowed = Arrays.stream(ProjectAttributeEnum.values()).collect(Collectors.toMap(it -> it, it -> permute(it.getAttribute())));
		disallowed = Arrays.asList("noSuchAttribute", "", " ", null);
	}

	@Test
	public void findByAttributeName() {
