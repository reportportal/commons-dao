...
public class CompositeFilterTest {
	...
	void test() {
		...
		CompositeFilterCondition firstCompositeCondition = new CompositeFilterCondition(Lists.newArrayList(condition, condition1),
				Operator.OR
		);
		...
		Filter filter = Filter.builder().withTarget(Launch.class).withCondition(filterCondition).build();
